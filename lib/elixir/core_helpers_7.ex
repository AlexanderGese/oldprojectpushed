defmodule Core_Helpers_7 do
  @moduledoc """
  Module: core_helpers_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_7"),
...
defmodule Core_Helpers_7Store do
  use GenServer
...
defmodule Core_Helpers_7EventBus do
  use GenServer
