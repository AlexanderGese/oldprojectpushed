defmodule New_Application_41 do
  @moduledoc """
  Module: new_application_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_41"),
...
defmodule New_Application_41Store do
  use GenServer
...
defmodule New_Application_41EventBus do
  use GenServer
