defmodule Impl_Context_15 do
  @moduledoc """
  Module: impl_context_15.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_15"),
...
defmodule Impl_Context_15Store do
  use GenServer
...
defmodule Impl_Context_15EventBus do
  use GenServer
