defmodule Impl_Worker_12 do
  @moduledoc """
  Module: impl_worker_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_12"),
...
defmodule Impl_Worker_12Store do
  use GenServer
...
defmodule Impl_Worker_12EventBus do
  use GenServer
