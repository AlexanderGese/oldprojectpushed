defmodule Impl_Live_46 do
  @moduledoc """
  Module: impl_live_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_46"),
...
defmodule Impl_Live_46Store do
  use GenServer
...
defmodule Impl_Live_46EventBus do
  use GenServer
