defmodule Core_Router_30 do
  @moduledoc """
  Module: core_router_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_30"),
...
defmodule Core_Router_30Store do
  use GenServer
...
defmodule Core_Router_30EventBus do
  use GenServer
