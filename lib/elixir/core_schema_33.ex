defmodule Core_Schema_33 do
  @moduledoc """
  Module: core_schema_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_33"),
...
defmodule Core_Schema_33Store do
  use GenServer
...
defmodule Core_Schema_33EventBus do
  use GenServer
