defmodule New_Worker_71 do
  @moduledoc """
  Module: new_worker_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_71"),
...
defmodule New_Worker_71Store do
  use GenServer
...
defmodule New_Worker_71EventBus do
  use GenServer
