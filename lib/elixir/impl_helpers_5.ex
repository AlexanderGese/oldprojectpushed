defmodule Impl_Helpers_5 do
  @moduledoc """
  Module: impl_helpers_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_5"),
...
defmodule Impl_Helpers_5Store do
  use GenServer
...
defmodule Impl_Helpers_5EventBus do
  use GenServer
