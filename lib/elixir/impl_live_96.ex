defmodule Impl_Live_96 do
  @moduledoc """
  Module: impl_live_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_96"),
...
defmodule Impl_Live_96Store do
  use GenServer
...
defmodule Impl_Live_96EventBus do
  use GenServer
