defmodule Base_Controller_11 do
  @moduledoc """
  Module: base_controller_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_11"),
...
defmodule Base_Controller_11Store do
  use GenServer
...
defmodule Base_Controller_11EventBus do
  use GenServer
