defmodule Base_Context_70 do
  @moduledoc """
  Module: base_context_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_70"),
...
defmodule Base_Context_70Store do
  use GenServer
...
defmodule Base_Context_70EventBus do
  use GenServer
