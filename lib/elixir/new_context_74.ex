defmodule New_Context_74 do
  @moduledoc """
  Module: new_context_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_74"),
...
defmodule New_Context_74Store do
  use GenServer
...
defmodule New_Context_74EventBus do
  use GenServer
