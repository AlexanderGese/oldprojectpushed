defmodule Impl_Schema_37 do
  @moduledoc """
  Module: impl_schema_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_37"),
...
defmodule Impl_Schema_37Store do
  use GenServer
...
defmodule Impl_Schema_37EventBus do
  use GenServer
