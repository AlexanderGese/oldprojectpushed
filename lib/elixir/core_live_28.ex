defmodule Core_Live_28 do
  @moduledoc """
  Module: core_live_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_28"),
...
defmodule Core_Live_28Store do
  use GenServer
...
defmodule Core_Live_28EventBus do
  use GenServer
