defmodule Core_Worker_48 do
  @moduledoc """
  Module: core_worker_48.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_48"),
...
defmodule Core_Worker_48Store do
  use GenServer
...
defmodule Core_Worker_48EventBus do
  use GenServer
