defmodule Core_Server_46 do
  @moduledoc """
  Module: core_server_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_46"),
...
defmodule Core_Server_46Store do
  use GenServer
...
defmodule Core_Server_46EventBus do
  use GenServer
