defmodule Impl_Helpers_66 do
  @moduledoc """
  Module: impl_helpers_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_66"),
...
defmodule Impl_Helpers_66Store do
  use GenServer
...
defmodule Impl_Helpers_66EventBus do
  use GenServer
