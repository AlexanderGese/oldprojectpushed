defmodule Base_Helpers_93 do
  @moduledoc """
  Module: base_helpers_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_93"),
...
defmodule Base_Helpers_93Store do
  use GenServer
...
defmodule Base_Helpers_93EventBus do
  use GenServer
