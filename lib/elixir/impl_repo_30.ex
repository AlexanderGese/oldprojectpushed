defmodule Impl_Repo_30 do
  @moduledoc """
  Module: impl_repo_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_30"),
...
defmodule Impl_Repo_30Store do
  use GenServer
...
defmodule Impl_Repo_30EventBus do
  use GenServer
