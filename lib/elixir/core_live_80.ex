defmodule Core_Live_80 do
  @moduledoc """
  Module: core_live_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_80"),
...
defmodule Core_Live_80Store do
  use GenServer
...
defmodule Core_Live_80EventBus do
  use GenServer
