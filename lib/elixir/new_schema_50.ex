defmodule New_Schema_50 do
  @moduledoc """
  Module: new_schema_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_50"),
...
defmodule New_Schema_50Store do
  use GenServer
...
defmodule New_Schema_50EventBus do
  use GenServer
