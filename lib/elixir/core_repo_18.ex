defmodule Core_Repo_18 do
  @moduledoc """
  Module: core_repo_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_18"),
...
defmodule Core_Repo_18Store do
  use GenServer
...
defmodule Core_Repo_18EventBus do
  use GenServer
