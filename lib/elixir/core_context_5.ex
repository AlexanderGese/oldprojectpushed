defmodule Core_Context_5 do
  @moduledoc """
  Module: core_context_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_5"),
...
defmodule Core_Context_5Store do
  use GenServer
...
defmodule Core_Context_5EventBus do
  use GenServer
