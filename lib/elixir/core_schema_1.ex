defmodule Core_Schema_1 do
  @moduledoc """
  Module: core_schema_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_1"),
...
defmodule Core_Schema_1Store do
  use GenServer
...
defmodule Core_Schema_1EventBus do
  use GenServer
