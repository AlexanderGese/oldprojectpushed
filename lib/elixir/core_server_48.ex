defmodule Core_Server_48 do
  @moduledoc """
  Module: core_server_48.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_48"),
...
defmodule Core_Server_48Store do
  use GenServer
...
defmodule Core_Server_48EventBus do
  use GenServer
