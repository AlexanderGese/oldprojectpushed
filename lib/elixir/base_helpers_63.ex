defmodule Base_Helpers_63 do
  @moduledoc """
  Module: base_helpers_63.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_63"),
...
defmodule Base_Helpers_63Store do
  use GenServer
...
defmodule Base_Helpers_63EventBus do
  use GenServer
