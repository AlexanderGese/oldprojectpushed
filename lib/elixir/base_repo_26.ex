defmodule Base_Repo_26 do
  @moduledoc """
  Module: base_repo_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_26"),
...
defmodule Base_Repo_26Store do
  use GenServer
...
defmodule Base_Repo_26EventBus do
  use GenServer
