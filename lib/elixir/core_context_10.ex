defmodule Core_Context_10 do
  @moduledoc """
  Module: core_context_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_10"),
...
defmodule Core_Context_10Store do
  use GenServer
...
defmodule Core_Context_10EventBus do
  use GenServer
