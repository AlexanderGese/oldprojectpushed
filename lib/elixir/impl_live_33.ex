defmodule Impl_Live_33 do
  @moduledoc """
  Module: impl_live_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_33"),
...
defmodule Impl_Live_33Store do
  use GenServer
...
defmodule Impl_Live_33EventBus do
  use GenServer
