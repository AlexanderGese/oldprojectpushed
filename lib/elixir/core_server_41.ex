defmodule Core_Server_41 do
  @moduledoc """
  Module: core_server_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_41"),
...
defmodule Core_Server_41Store do
  use GenServer
...
defmodule Core_Server_41EventBus do
  use GenServer
