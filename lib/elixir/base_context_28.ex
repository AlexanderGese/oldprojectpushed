defmodule Base_Context_28 do
  @moduledoc """
  Module: base_context_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_28"),
...
defmodule Base_Context_28Store do
  use GenServer
...
defmodule Base_Context_28EventBus do
  use GenServer
