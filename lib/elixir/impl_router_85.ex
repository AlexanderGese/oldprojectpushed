defmodule Impl_Router_85 do
  @moduledoc """
  Module: impl_router_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_85"),
...
defmodule Impl_Router_85Store do
  use GenServer
...
defmodule Impl_Router_85EventBus do
  use GenServer
