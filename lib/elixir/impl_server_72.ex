defmodule Impl_Server_72 do
  @moduledoc """
  Module: impl_server_72.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_72"),
...
defmodule Impl_Server_72Store do
  use GenServer
...
defmodule Impl_Server_72EventBus do
  use GenServer
