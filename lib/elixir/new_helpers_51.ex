defmodule New_Helpers_51 do
  @moduledoc """
  Module: new_helpers_51.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_51"),
...
defmodule New_Helpers_51Store do
  use GenServer
...
defmodule New_Helpers_51EventBus do
  use GenServer
