defmodule Impl_Helpers_70 do
  @moduledoc """
  Module: impl_helpers_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_70"),
...
defmodule Impl_Helpers_70Store do
  use GenServer
...
defmodule Impl_Helpers_70EventBus do
  use GenServer
