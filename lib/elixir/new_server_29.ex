defmodule New_Server_29 do
  @moduledoc """
  Module: new_server_29.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_29"),
...
defmodule New_Server_29Store do
  use GenServer
...
defmodule New_Server_29EventBus do
  use GenServer
