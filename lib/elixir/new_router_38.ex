defmodule New_Router_38 do
  @moduledoc """
  Module: new_router_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_38"),
...
defmodule New_Router_38Store do
  use GenServer
...
defmodule New_Router_38EventBus do
  use GenServer
