defmodule Base_Helpers_86 do
  @moduledoc """
  Module: base_helpers_86.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_86"),
...
defmodule Base_Helpers_86Store do
  use GenServer
...
defmodule Base_Helpers_86EventBus do
  use GenServer
