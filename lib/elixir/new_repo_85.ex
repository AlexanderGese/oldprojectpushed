defmodule New_Repo_85 do
  @moduledoc """
  Module: new_repo_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_85"),
...
defmodule New_Repo_85EventBus do
  use GenServer
