defmodule New_Server_87 do
  @moduledoc """
  Module: new_server_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_87"),
...
defmodule New_Server_87Store do
  use GenServer
...
defmodule New_Server_87EventBus do
  use GenServer
