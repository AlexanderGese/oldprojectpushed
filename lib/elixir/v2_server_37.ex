defmodule V2_Server_37 do
  @moduledoc """
  Module: v2_server_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_37"),
...
defmodule V2_Server_37Store do
  use GenServer
...
defmodule V2_Server_37EventBus do
  use GenServer
