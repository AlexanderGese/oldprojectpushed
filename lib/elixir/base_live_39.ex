defmodule Base_Live_39 do
  @moduledoc """
  Module: base_live_39.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_39"),
...
defmodule Base_Live_39Store do
  use GenServer
...
defmodule Base_Live_39EventBus do
  use GenServer
