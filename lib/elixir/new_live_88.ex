defmodule New_Live_88 do
  @moduledoc """
  Module: new_live_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_88"),
...
defmodule New_Live_88EventBus do
  use GenServer
