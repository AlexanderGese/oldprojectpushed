defmodule Base_Controller_60 do
  @moduledoc """
  Module: base_controller_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_60"),
...
defmodule Base_Controller_60Store do
  use GenServer
...
defmodule Base_Controller_60EventBus do
  use GenServer
