defmodule Core_Live_83 do
  @moduledoc """
  Module: core_live_83.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_83"),
...
defmodule Core_Live_83Store do
  use GenServer
...
defmodule Core_Live_83EventBus do
  use GenServer
