defmodule Core_Helpers_33 do
  @moduledoc """
  Module: core_helpers_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_33"),
...
defmodule Core_Helpers_33Store do
  use GenServer
...
defmodule Core_Helpers_33EventBus do
  use GenServer
