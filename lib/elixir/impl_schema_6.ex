defmodule Impl_Schema_6 do
  @moduledoc """
  Module: impl_schema_6.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_6"),
...
defmodule Impl_Schema_6Store do
  use GenServer
...
defmodule Impl_Schema_6EventBus do
  use GenServer
