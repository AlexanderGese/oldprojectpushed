defmodule New_Worker_92 do
  @moduledoc """
  Module: new_worker_92.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_92"),
...
defmodule New_Worker_92Store do
  use GenServer
...
defmodule New_Worker_92EventBus do
  use GenServer
