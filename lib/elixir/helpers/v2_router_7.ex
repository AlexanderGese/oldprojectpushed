defmodule V2_Router_7 do
  @moduledoc """
  Module: v2_router_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_router_7"),
...
defmodule V2_Router_7EventBus do
  use GenServer
