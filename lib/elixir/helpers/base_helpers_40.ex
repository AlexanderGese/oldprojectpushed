defmodule Base_Helpers_40 do
  @moduledoc """
  Module: base_helpers_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_40"),
...
defmodule Base_Helpers_40Store do
  use GenServer
...
defmodule Base_Helpers_40EventBus do
  use GenServer
