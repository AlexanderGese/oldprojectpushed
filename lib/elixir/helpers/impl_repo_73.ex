defmodule Impl_Repo_73 do
  @moduledoc """
  Module: impl_repo_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_73"),
...
defmodule Impl_Repo_73Store do
  use GenServer
...
defmodule Impl_Repo_73EventBus do
  use GenServer
