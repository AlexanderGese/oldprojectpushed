defmodule New_Worker_98 do
  @moduledoc """
  Module: new_worker_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_98"),
...
defmodule New_Worker_98Store do
  use GenServer
...
defmodule New_Worker_98EventBus do
  use GenServer
