defmodule New_Context_42 do
  @moduledoc """
  Module: new_context_42.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_42"),
...
defmodule New_Context_42Store do
  use GenServer
...
defmodule New_Context_42EventBus do
  use GenServer
