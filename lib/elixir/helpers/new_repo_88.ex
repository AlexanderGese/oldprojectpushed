defmodule New_Repo_88 do
  @moduledoc """
  Module: new_repo_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_88"),
...
defmodule New_Repo_88EventBus do
  use GenServer
