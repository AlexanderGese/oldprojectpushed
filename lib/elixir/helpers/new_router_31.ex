defmodule New_Router_31 do
  @moduledoc """
  Module: new_router_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_31"),
...
defmodule New_Router_31Store do
  use GenServer
...
defmodule New_Router_31EventBus do
  use GenServer
