defmodule Impl_Context_61 do
  @moduledoc """
  Module: impl_context_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_61"),
...
defmodule Impl_Context_61Store do
  use GenServer
...
defmodule Impl_Context_61EventBus do
  use GenServer
