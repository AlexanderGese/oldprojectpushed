defmodule Core_Live_7 do
  @moduledoc """
  Module: core_live_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_7"),
...
defmodule Core_Live_7EventBus do
  use GenServer
