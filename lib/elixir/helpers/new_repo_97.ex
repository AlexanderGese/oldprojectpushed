defmodule New_Repo_97 do
  @moduledoc """
  Module: new_repo_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_97"),
...
defmodule New_Repo_97EventBus do
  use GenServer
