defmodule Base_Controller_21 do
  @moduledoc """
  Module: base_controller_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_21"),
...
defmodule Base_Controller_21Store do
  use GenServer
...
defmodule Base_Controller_21EventBus do
  use GenServer
