defmodule V2_Context_13 do
  @moduledoc """
  Module: v2_context_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_13"),
...
defmodule V2_Context_13Store do
  use GenServer
...
defmodule V2_Context_13EventBus do
  use GenServer
