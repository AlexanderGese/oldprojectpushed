defmodule Base_Live_66 do
  @moduledoc """
  Module: base_live_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_66"),
...
defmodule Base_Live_66Store do
  use GenServer
...
defmodule Base_Live_66EventBus do
  use GenServer
