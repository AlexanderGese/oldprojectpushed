defmodule Impl_Router_88 do
  @moduledoc """
  Module: impl_router_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_88"),
...
defmodule Impl_Router_88Store do
  use GenServer
...
defmodule Impl_Router_88EventBus do
  use GenServer
