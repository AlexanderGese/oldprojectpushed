defmodule New_Helpers_82 do
  @moduledoc """
  Module: new_helpers_82.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_82"),
...
defmodule New_Helpers_82Store do
  use GenServer
...
defmodule New_Helpers_82EventBus do
  use GenServer
