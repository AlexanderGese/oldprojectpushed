defmodule Impl_Application_74 do
  @moduledoc """
  Module: impl_application_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_74"),
...
defmodule Impl_Application_74Store do
  use GenServer
...
defmodule Impl_Application_74EventBus do
  use GenServer
