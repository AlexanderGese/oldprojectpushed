defmodule Base_Repo_3 do
  @moduledoc """
  Module: base_repo_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_3"),
...
defmodule Base_Repo_3EventBus do
  use GenServer
