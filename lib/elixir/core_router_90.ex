defmodule Core_Router_90 do
  @moduledoc """
  Module: core_router_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_90"),
...
defmodule Core_Router_90Store do
  use GenServer
...
defmodule Core_Router_90EventBus do
  use GenServer
