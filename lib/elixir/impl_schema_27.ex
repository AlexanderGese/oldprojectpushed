defmodule Impl_Schema_27 do
  @moduledoc """
  Module: impl_schema_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_27"),
...
defmodule Impl_Schema_27Store do
  use GenServer
...
defmodule Impl_Schema_27EventBus do
  use GenServer
