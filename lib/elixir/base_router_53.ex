defmodule Base_Router_53 do
  @moduledoc """
  Module: base_router_53.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_53"),
...
defmodule Base_Router_53Store do
  use GenServer
...
defmodule Base_Router_53EventBus do
  use GenServer
