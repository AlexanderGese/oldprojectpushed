defmodule Core_Repo_9 do
  @moduledoc """
  Module: core_repo_9.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_9"),
...
defmodule Core_Repo_9EventBus do
  use GenServer
