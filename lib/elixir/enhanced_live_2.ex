defmodule Enhanced_Live_2 do
  @moduledoc """
  Module: enhanced_live_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_live_2"),
...
defmodule Enhanced_Live_2Store do
  use GenServer
...
defmodule Enhanced_Live_2EventBus do
  use GenServer
