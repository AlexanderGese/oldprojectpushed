defmodule New_Helpers_33 do
  @moduledoc """
  Module: new_helpers_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_33"),
...
defmodule New_Helpers_33Store do
  use GenServer
...
defmodule New_Helpers_33EventBus do
  use GenServer
