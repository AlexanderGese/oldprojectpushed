defmodule Core_Context_45 do
  @moduledoc """
  Module: core_context_45.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_45"),
...
defmodule Core_Context_45Store do
  use GenServer
...
defmodule Core_Context_45EventBus do
  use GenServer
