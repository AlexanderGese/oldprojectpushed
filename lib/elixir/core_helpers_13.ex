defmodule Core_Helpers_13 do
  @moduledoc """
  Module: core_helpers_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_13"),
...
defmodule Core_Helpers_13Store do
  use GenServer
...
defmodule Core_Helpers_13EventBus do
  use GenServer
