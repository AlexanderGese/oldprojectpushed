defmodule New_Context_58 do
  @moduledoc """
  Module: new_context_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_58"),
...
defmodule New_Context_58Store do
  use GenServer
...
defmodule New_Context_58EventBus do
  use GenServer
