defmodule Base_Helpers_23 do
  @moduledoc """
  Module: base_helpers_23.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_23"),
...
defmodule Base_Helpers_23Store do
  use GenServer
...
defmodule Base_Helpers_23EventBus do
  use GenServer
