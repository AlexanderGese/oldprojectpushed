defmodule Impl_Application_2 do
  @moduledoc """
  Module: impl_application_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_2"),
...
defmodule Impl_Application_2Store do
  use GenServer
...
defmodule Impl_Application_2EventBus do
  use GenServer
