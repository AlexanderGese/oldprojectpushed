defmodule New_Live_90 do
  @moduledoc """
  Module: new_live_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_90"),
...
defmodule New_Live_90EventBus do
  use GenServer
