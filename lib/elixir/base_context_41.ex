defmodule Base_Context_41 do
  @moduledoc """
  Module: base_context_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_41"),
...
defmodule Base_Context_41Store do
  use GenServer
...
defmodule Base_Context_41EventBus do
  use GenServer
