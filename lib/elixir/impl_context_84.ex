defmodule Impl_Context_84 do
  @moduledoc """
  Module: impl_context_84.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_84"),
...
defmodule Impl_Context_84Store do
  use GenServer
...
defmodule Impl_Context_84EventBus do
  use GenServer
