defmodule New_Context_66 do
  @moduledoc """
  Module: new_context_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_66"),
...
defmodule New_Context_66Store do
  use GenServer
...
defmodule New_Context_66EventBus do
  use GenServer
