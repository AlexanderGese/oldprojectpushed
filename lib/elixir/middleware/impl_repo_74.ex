defmodule Impl_Repo_74 do
  @moduledoc """
  Module: impl_repo_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_74"),
...
defmodule Impl_Repo_74Store do
  use GenServer
...
defmodule Impl_Repo_74EventBus do
  use GenServer
