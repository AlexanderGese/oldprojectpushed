defmodule Impl_Helpers_81 do
  @moduledoc """
  Module: impl_helpers_81.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_81"),
...
defmodule Impl_Helpers_81Store do
  use GenServer
...
defmodule Impl_Helpers_81EventBus do
  use GenServer
