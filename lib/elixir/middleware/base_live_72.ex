defmodule Base_Live_72 do
  @moduledoc """
  Module: base_live_72.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_72"),
...
defmodule Base_Live_72Store do
  use GenServer
...
defmodule Base_Live_72EventBus do
  use GenServer
