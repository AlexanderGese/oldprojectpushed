defmodule Core_Schema_93 do
  @moduledoc """
  Module: core_schema_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_93"),
...
defmodule Core_Schema_93Store do
  use GenServer
...
defmodule Core_Schema_93EventBus do
  use GenServer
