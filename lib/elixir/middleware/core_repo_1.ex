defmodule Core_Repo_1 do
  @moduledoc """
  Module: core_repo_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_1"),
...
defmodule Core_Repo_1EventBus do
  use GenServer
