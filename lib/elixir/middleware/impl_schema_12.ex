defmodule Impl_Schema_12 do
  @moduledoc """
  Module: impl_schema_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_12"),
...
defmodule Impl_Schema_12Store do
  use GenServer
...
defmodule Impl_Schema_12EventBus do
  use GenServer
