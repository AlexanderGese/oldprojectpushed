defmodule New_Schema_74 do
  @moduledoc """
  Module: new_schema_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_74"),
...
defmodule New_Schema_74Store do
  use GenServer
...
defmodule New_Schema_74EventBus do
  use GenServer
