defmodule V2_Schema_12 do
  @moduledoc """
  Module: v2_schema_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_12"),
...
defmodule V2_Schema_12Store do
  use GenServer
...
defmodule V2_Schema_12EventBus do
  use GenServer
