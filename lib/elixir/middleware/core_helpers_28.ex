defmodule Core_Helpers_28 do
  @moduledoc """
  Module: core_helpers_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_28"),
...
defmodule Core_Helpers_28Store do
  use GenServer
...
defmodule Core_Helpers_28EventBus do
  use GenServer
