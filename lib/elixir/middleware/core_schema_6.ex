defmodule Core_Schema_6 do
  @moduledoc """
  Module: core_schema_6.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_6"),
...
defmodule Core_Schema_6Store do
  use GenServer
...
defmodule Core_Schema_6EventBus do
  use GenServer
