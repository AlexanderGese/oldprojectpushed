defmodule Impl_Live_17 do
  @moduledoc """
  Module: impl_live_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_17"),
...
defmodule Impl_Live_17Store do
  use GenServer
...
defmodule Impl_Live_17EventBus do
  use GenServer
