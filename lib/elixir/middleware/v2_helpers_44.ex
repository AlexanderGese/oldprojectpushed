defmodule V2_Helpers_44 do
  @moduledoc """
  Module: v2_helpers_44.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_44"),
...
defmodule V2_Helpers_44Store do
  use GenServer
...
defmodule V2_Helpers_44EventBus do
  use GenServer
