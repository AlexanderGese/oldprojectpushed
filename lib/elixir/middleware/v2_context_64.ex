defmodule V2_Context_64 do
  @moduledoc """
  Module: v2_context_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_64"),
...
defmodule V2_Context_64Store do
  use GenServer
...
defmodule V2_Context_64EventBus do
  use GenServer
