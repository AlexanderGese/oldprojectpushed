defmodule New_Server_35 do
  @moduledoc """
  Module: new_server_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_35"),
...
defmodule New_Server_35Store do
  use GenServer
...
defmodule New_Server_35EventBus do
  use GenServer
