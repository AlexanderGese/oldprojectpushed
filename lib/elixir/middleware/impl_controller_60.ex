defmodule Impl_Controller_60 do
  @moduledoc """
  Module: impl_controller_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_controller_60"),
...
defmodule Impl_Controller_60Store do
  use GenServer
...
defmodule Impl_Controller_60EventBus do
  use GenServer
