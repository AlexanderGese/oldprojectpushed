defmodule V2_Application_17 do
  @moduledoc """
  Module: v2_application_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_application_17"),
...
defmodule V2_Application_17Store do
  use GenServer
...
defmodule V2_Application_17EventBus do
  use GenServer
