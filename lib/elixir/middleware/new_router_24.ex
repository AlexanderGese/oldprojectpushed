defmodule New_Router_24 do
  @moduledoc """
  Module: new_router_24.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_24"),
...
defmodule New_Router_24Store do
  use GenServer
...
defmodule New_Router_24EventBus do
  use GenServer
