defmodule New_Helpers_71 do
  @moduledoc """
  Module: new_helpers_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_71"),
...
defmodule New_Helpers_71Store do
  use GenServer
...
defmodule New_Helpers_71EventBus do
  use GenServer
