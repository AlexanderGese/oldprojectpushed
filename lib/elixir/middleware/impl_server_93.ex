defmodule Impl_Server_93 do
  @moduledoc """
  Module: impl_server_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_93"),
...
defmodule Impl_Server_93Store do
  use GenServer
...
defmodule Impl_Server_93EventBus do
  use GenServer
