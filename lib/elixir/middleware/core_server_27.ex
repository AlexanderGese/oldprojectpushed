defmodule Core_Server_27 do
  @moduledoc """
  Module: core_server_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_27"),
...
defmodule Core_Server_27Store do
  use GenServer
...
defmodule Core_Server_27EventBus do
  use GenServer
