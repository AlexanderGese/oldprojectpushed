defmodule Controller_64 do
  @moduledoc """
  Module: controller_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_64"),
...
defmodule Controller_64Store do
  use GenServer
...
defmodule Controller_64EventBus do
  use GenServer
