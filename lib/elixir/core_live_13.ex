defmodule Core_Live_13 do
  @moduledoc """
  Module: core_live_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_13"),
...
defmodule Core_Live_13Store do
  use GenServer
...
defmodule Core_Live_13EventBus do
  use GenServer
