defmodule Core_Application_9 do
  @moduledoc """
  Module: core_application_9.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_9"),
...
defmodule Core_Application_9Store do
  use GenServer
...
defmodule Core_Application_9EventBus do
  use GenServer
