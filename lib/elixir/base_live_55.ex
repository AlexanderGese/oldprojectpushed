defmodule Base_Live_55 do
  @moduledoc """
  Module: base_live_55.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_55"),
...
defmodule Base_Live_55Store do
  use GenServer
...
defmodule Base_Live_55EventBus do
  use GenServer
