defmodule Core_Helpers_6 do
  @moduledoc """
  Module: core_helpers_6.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_6"),
...
defmodule Core_Helpers_6Store do
  use GenServer
...
defmodule Core_Helpers_6EventBus do
  use GenServer
