defmodule Base_Live_93 do
  @moduledoc """
  Module: base_live_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_93"),
...
defmodule Base_Live_93Store do
  use GenServer
...
defmodule Base_Live_93EventBus do
  use GenServer
