defmodule New_Controller_96 do
  @moduledoc """
  Module: new_controller_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_96"),
...
defmodule New_Controller_96Store do
  use GenServer
...
defmodule New_Controller_96EventBus do
  use GenServer
