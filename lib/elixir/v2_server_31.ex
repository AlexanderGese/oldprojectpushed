defmodule V2_Server_31 do
  @moduledoc """
  Module: v2_server_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_31"),
...
defmodule V2_Server_31Store do
  use GenServer
...
defmodule V2_Server_31EventBus do
  use GenServer
