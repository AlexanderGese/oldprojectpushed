defmodule Base_Router_9 do
  @moduledoc """
  Module: base_router_9.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_9"),
...
defmodule Base_Router_9Store do
  use GenServer
...
defmodule Base_Router_9EventBus do
  use GenServer
