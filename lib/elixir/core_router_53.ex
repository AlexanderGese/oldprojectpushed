defmodule Core_Router_53 do
  @moduledoc """
  Module: core_router_53.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_53"),
...
defmodule Core_Router_53Store do
  use GenServer
...
defmodule Core_Router_53EventBus do
  use GenServer
