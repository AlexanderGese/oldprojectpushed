defmodule Impl_Context_98 do
  @moduledoc """
  Module: impl_context_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_98"),
...
defmodule Impl_Context_98Store do
  use GenServer
...
defmodule Impl_Context_98EventBus do
  use GenServer
