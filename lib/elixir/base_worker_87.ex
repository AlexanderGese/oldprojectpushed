defmodule Base_Worker_87 do
  @moduledoc """
  Module: base_worker_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_87"),
...
defmodule Base_Worker_87Store do
  use GenServer
...
defmodule Base_Worker_87EventBus do
  use GenServer
