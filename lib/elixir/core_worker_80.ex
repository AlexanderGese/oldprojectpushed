defmodule Core_Worker_80 do
  @moduledoc """
  Module: core_worker_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_80"),
...
defmodule Core_Worker_80Store do
  use GenServer
...
defmodule Core_Worker_80EventBus do
  use GenServer
