defmodule Impl_Router_96 do
  @moduledoc """
  Module: impl_router_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_96"),
...
defmodule Impl_Router_96Store do
  use GenServer
...
defmodule Impl_Router_96EventBus do
  use GenServer
