defmodule New_Controller_75 do
  @moduledoc """
  Module: new_controller_75.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_75"),
...
defmodule New_Controller_75Store do
  use GenServer
...
defmodule New_Controller_75EventBus do
  use GenServer
