defmodule Impl_Helpers_38 do
  @moduledoc """
  Module: impl_helpers_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_38"),
...
defmodule Impl_Helpers_38Store do
  use GenServer
...
defmodule Impl_Helpers_38EventBus do
  use GenServer
