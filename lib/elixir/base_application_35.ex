defmodule Base_Application_35 do
  @moduledoc """
  Module: base_application_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_35"),
...
defmodule Base_Application_35Store do
  use GenServer
...
defmodule Base_Application_35EventBus do
  use GenServer
