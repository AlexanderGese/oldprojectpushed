defmodule Base_Schema_2 do
  @moduledoc """
  Module: base_schema_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_2"),
...
defmodule Base_Schema_2Store do
  use GenServer
...
defmodule Base_Schema_2EventBus do
  use GenServer
