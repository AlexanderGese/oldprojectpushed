defmodule Core_Context_52 do
  @moduledoc """
  Module: core_context_52.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_52"),
...
defmodule Core_Context_52Store do
  use GenServer
...
defmodule Core_Context_52EventBus do
  use GenServer
