defmodule Impl_Controller_11 do
  @moduledoc """
  Module: impl_controller_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_controller_11"),
...
defmodule Impl_Controller_11Store do
  use GenServer
...
defmodule Impl_Controller_11EventBus do
  use GenServer
