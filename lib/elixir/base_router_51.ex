defmodule Base_Router_51 do
  @moduledoc """
  Module: base_router_51.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_51"),
...
defmodule Base_Router_51Store do
  use GenServer
...
defmodule Base_Router_51EventBus do
  use GenServer
