defmodule Impl_Schema_26 do
  @moduledoc """
  Module: impl_schema_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_26"),
...
defmodule Impl_Schema_26Store do
  use GenServer
...
defmodule Impl_Schema_26EventBus do
  use GenServer
