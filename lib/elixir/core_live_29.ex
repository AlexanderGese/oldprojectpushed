defmodule Core_Live_29 do
  @moduledoc """
  Module: core_live_29.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_29"),
...
defmodule Core_Live_29Store do
  use GenServer
...
defmodule Core_Live_29EventBus do
  use GenServer
