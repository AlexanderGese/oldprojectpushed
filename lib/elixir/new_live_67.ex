defmodule New_Live_67 do
  @moduledoc """
  Module: new_live_67.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_67"),
...
defmodule New_Live_67EventBus do
  use GenServer
