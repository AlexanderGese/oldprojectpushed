defmodule V2_Application_12 do
  @moduledoc """
  Module: v2_application_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_application_12"),
...
defmodule V2_Application_12Store do
  use GenServer
...
defmodule V2_Application_12EventBus do
  use GenServer
