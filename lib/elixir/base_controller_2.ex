defmodule Base_Controller_2 do
  @moduledoc """
  Module: base_controller_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_2"),
...
defmodule Base_Controller_2Store do
  use GenServer
...
defmodule Base_Controller_2EventBus do
  use GenServer
