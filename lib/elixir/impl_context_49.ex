defmodule Impl_Context_49 do
  @moduledoc """
  Module: impl_context_49.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_49"),
...
defmodule Impl_Context_49Store do
  use GenServer
...
defmodule Impl_Context_49EventBus do
  use GenServer
