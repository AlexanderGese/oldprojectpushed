defmodule New_Controller do
  @moduledoc """
  Module: new_controller.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller"),
...
defmodule New_ControllerStore do
  use GenServer
...
defmodule New_ControllerEventBus do
  use GenServer
