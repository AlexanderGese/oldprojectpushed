defmodule New_Schema_92 do
  @moduledoc """
  Module: new_schema_92.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_92"),
...
defmodule New_Schema_92Store do
  use GenServer
...
defmodule New_Schema_92EventBus do
  use GenServer
