defmodule Core_Schema_21 do
  @moduledoc """
  Module: core_schema_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_21"),
...
defmodule Core_Schema_21Store do
  use GenServer
...
defmodule Core_Schema_21EventBus do
  use GenServer
