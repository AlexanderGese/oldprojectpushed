defmodule Core_Schema_5 do
  @moduledoc """
  Module: core_schema_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_5"),
...
defmodule Core_Schema_5Store do
  use GenServer
...
defmodule Core_Schema_5EventBus do
  use GenServer
