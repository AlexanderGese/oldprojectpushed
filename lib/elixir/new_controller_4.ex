defmodule New_Controller_4 do
  @moduledoc """
  Module: new_controller_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_4"),
...
defmodule New_Controller_4Store do
  use GenServer
...
defmodule New_Controller_4EventBus do
  use GenServer
