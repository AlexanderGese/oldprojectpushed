defmodule Base_Schema_18 do
  @moduledoc """
  Module: base_schema_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_18"),
...
defmodule Base_Schema_18Store do
  use GenServer
...
defmodule Base_Schema_18EventBus do
  use GenServer
