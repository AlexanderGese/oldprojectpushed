defmodule Core_Server_11 do
  @moduledoc """
  Module: core_server_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_11"),
...
defmodule Core_Server_11Store do
  use GenServer
...
defmodule Core_Server_11EventBus do
  use GenServer
