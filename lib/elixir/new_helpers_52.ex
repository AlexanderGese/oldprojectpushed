defmodule New_Helpers_52 do
  @moduledoc """
  Module: new_helpers_52.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_52"),
...
defmodule New_Helpers_52Store do
  use GenServer
...
defmodule New_Helpers_52EventBus do
  use GenServer
