defmodule Base_Context_81 do
  @moduledoc """
  Module: base_context_81.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_81"),
...
defmodule Base_Context_81Store do
  use GenServer
...
defmodule Base_Context_81EventBus do
  use GenServer
