defmodule New_Controller_45 do
  @moduledoc """
  Module: new_controller_45.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_45"),
...
defmodule New_Controller_45Store do
  use GenServer
...
defmodule New_Controller_45EventBus do
  use GenServer
