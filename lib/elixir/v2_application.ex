defmodule V2_Application do
  @moduledoc """
  Module: v2_application.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_application"),
...
defmodule V2_ApplicationStore do
  use GenServer
...
defmodule V2_ApplicationEventBus do
  use GenServer
