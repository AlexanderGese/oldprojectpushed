defmodule Impl_Application_91 do
  @moduledoc """
  Module: impl_application_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_91"),
...
defmodule Impl_Application_91Store do
  use GenServer
...
defmodule Impl_Application_91EventBus do
  use GenServer
