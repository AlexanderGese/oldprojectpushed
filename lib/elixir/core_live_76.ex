defmodule Core_Live_76 do
  @moduledoc """
  Module: core_live_76.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_76"),
...
defmodule Core_Live_76Store do
  use GenServer
...
defmodule Core_Live_76EventBus do
  use GenServer
