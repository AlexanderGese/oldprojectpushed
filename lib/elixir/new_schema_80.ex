defmodule New_Schema_80 do
  @moduledoc """
  Module: new_schema_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_80"),
...
defmodule New_Schema_80Store do
  use GenServer
...
defmodule New_Schema_80EventBus do
  use GenServer
