defmodule Core_Worker_6 do
  @moduledoc """
  Module: core_worker_6.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_6"),
...
defmodule Core_Worker_6Store do
  use GenServer
...
defmodule Core_Worker_6EventBus do
  use GenServer
