defmodule Impl_Schema_21 do
  @moduledoc """
  Module: impl_schema_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_21"),
...
defmodule Impl_Schema_21Store do
  use GenServer
...
defmodule Impl_Schema_21EventBus do
  use GenServer
