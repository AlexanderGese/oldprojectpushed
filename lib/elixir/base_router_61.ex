defmodule Base_Router_61 do
  @moduledoc """
  Module: base_router_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_61"),
...
defmodule Base_Router_61Store do
  use GenServer
...
defmodule Base_Router_61EventBus do
  use GenServer
