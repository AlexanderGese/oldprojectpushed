defmodule Base_Application_42 do
  @moduledoc """
  Module: base_application_42.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_42"),
...
defmodule Base_Application_42Store do
  use GenServer
...
defmodule Base_Application_42EventBus do
  use GenServer
