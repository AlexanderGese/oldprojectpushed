defmodule Core_Schema_78 do
  @moduledoc """
  Module: core_schema_78.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_78"),
...
defmodule Core_Schema_78Store do
  use GenServer
...
defmodule Core_Schema_78EventBus do
  use GenServer
