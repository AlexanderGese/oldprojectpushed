defmodule Base_Live_45 do
  @moduledoc """
  Module: base_live_45.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_45"),
...
defmodule Base_Live_45Store do
  use GenServer
...
defmodule Base_Live_45EventBus do
  use GenServer
