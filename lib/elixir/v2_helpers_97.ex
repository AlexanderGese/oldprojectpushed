defmodule V2_Helpers_97 do
  @moduledoc """
  Module: v2_helpers_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_97"),
...
defmodule V2_Helpers_97Store do
  use GenServer
...
defmodule V2_Helpers_97EventBus do
  use GenServer
