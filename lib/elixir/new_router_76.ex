defmodule New_Router_76 do
  @moduledoc """
  Module: new_router_76.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_76"),
...
defmodule New_Router_76Store do
  use GenServer
...
defmodule New_Router_76EventBus do
  use GenServer
