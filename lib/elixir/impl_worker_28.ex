defmodule Impl_Worker_28 do
  @moduledoc """
  Module: impl_worker_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_28"),
...
defmodule Impl_Worker_28Store do
  use GenServer
...
defmodule Impl_Worker_28EventBus do
  use GenServer
