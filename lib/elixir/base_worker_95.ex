defmodule Base_Worker_95 do
  @moduledoc """
  Module: base_worker_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_95"),
...
defmodule Base_Worker_95Store do
  use GenServer
...
defmodule Base_Worker_95EventBus do
  use GenServer
