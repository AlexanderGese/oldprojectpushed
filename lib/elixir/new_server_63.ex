defmodule New_Server_63 do
  @moduledoc """
  Module: new_server_63.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_63"),
...
defmodule New_Server_63Store do
  use GenServer
...
defmodule New_Server_63EventBus do
  use GenServer
