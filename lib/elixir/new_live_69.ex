defmodule New_Live_69 do
  @moduledoc """
  Module: new_live_69.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_69"),
...
defmodule New_Live_69EventBus do
  use GenServer
