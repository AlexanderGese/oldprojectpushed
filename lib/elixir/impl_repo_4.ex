defmodule Impl_Repo_4 do
  @moduledoc """
  Module: impl_repo_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_4"),
...
defmodule Impl_Repo_4EventBus do
  use GenServer
