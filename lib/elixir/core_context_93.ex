defmodule Core_Context_93 do
  @moduledoc """
  Module: core_context_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_93"),
...
defmodule Core_Context_93Store do
  use GenServer
...
defmodule Core_Context_93EventBus do
  use GenServer
