defmodule New_Router_36 do
  @moduledoc """
  Module: new_router_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_36"),
...
defmodule New_Router_36Store do
  use GenServer
...
defmodule New_Router_36EventBus do
  use GenServer
