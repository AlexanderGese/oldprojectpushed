defmodule Impl_Helpers_7 do
  @moduledoc """
  Module: impl_helpers_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_7"),
...
defmodule Impl_Helpers_7Store do
  use GenServer
...
defmodule Impl_Helpers_7EventBus do
  use GenServer
