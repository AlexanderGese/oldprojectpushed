defmodule Core_Server_28 do
  @moduledoc """
  Module: core_server_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_28"),
...
defmodule Core_Server_28Store do
  use GenServer
...
defmodule Core_Server_28EventBus do
  use GenServer
