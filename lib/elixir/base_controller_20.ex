defmodule Base_Controller_20 do
  @moduledoc """
  Module: base_controller_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_20"),
...
defmodule Base_Controller_20Store do
  use GenServer
...
defmodule Base_Controller_20EventBus do
  use GenServer
