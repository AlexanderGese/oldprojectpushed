defmodule Base_Live_89 do
  @moduledoc """
  Module: base_live_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_89"),
...
defmodule Base_Live_89Store do
  use GenServer
...
defmodule Base_Live_89EventBus do
  use GenServer
