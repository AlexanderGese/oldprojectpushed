defmodule Base_Schema_96 do
  @moduledoc """
  Module: base_schema_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_96"),
...
defmodule Base_Schema_96Store do
  use GenServer
...
defmodule Base_Schema_96EventBus do
  use GenServer
