defmodule Base_Controller_13 do
  @moduledoc """
  Module: base_controller_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_13"),
...
defmodule Base_Controller_13Store do
  use GenServer
...
defmodule Base_Controller_13EventBus do
  use GenServer
