defmodule Base_Application do
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application"),
...
defmodule Base_ApplicationStore do
  use GenServer
...
defmodule Base_ApplicationEventBus do
  use GenServer
