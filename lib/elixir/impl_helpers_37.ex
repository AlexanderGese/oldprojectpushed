defmodule Impl_Helpers_37 do
  @moduledoc """
  Module: impl_helpers_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_37"),
...
defmodule Impl_Helpers_37Store do
  use GenServer
...
defmodule Impl_Helpers_37EventBus do
  use GenServer
