defmodule Impl_Helpers_12 do
  @moduledoc """
  Module: impl_helpers_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_12"),
...
defmodule Impl_Helpers_12Store do
  use GenServer
...
defmodule Impl_Helpers_12EventBus do
  use GenServer
