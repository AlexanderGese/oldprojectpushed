defmodule Base_Controller_80 do
  @moduledoc """
  Module: base_controller_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_80"),
...
defmodule Base_Controller_80Store do
  use GenServer
...
defmodule Base_Controller_80EventBus do
  use GenServer
