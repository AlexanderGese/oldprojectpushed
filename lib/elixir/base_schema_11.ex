defmodule Base_Schema_11 do
  @moduledoc """
  Module: base_schema_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_11"),
...
defmodule Base_Schema_11Store do
  use GenServer
...
defmodule Base_Schema_11EventBus do
  use GenServer
