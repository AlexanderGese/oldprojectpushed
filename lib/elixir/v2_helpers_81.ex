defmodule V2_Helpers_81 do
  @moduledoc """
  Module: v2_helpers_81.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_81"),
...
defmodule V2_Helpers_81Store do
  use GenServer
...
defmodule V2_Helpers_81EventBus do
  use GenServer
