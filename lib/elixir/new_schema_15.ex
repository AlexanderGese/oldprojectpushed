defmodule New_Schema_15 do
  @moduledoc """
  Module: new_schema_15.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_15"),
...
defmodule New_Schema_15Store do
  use GenServer
...
defmodule New_Schema_15EventBus do
  use GenServer
