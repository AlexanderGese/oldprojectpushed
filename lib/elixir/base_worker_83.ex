defmodule Base_Worker_83 do
  @moduledoc """
  Module: base_worker_83.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_83"),
...
defmodule Base_Worker_83Store do
  use GenServer
...
defmodule Base_Worker_83EventBus do
  use GenServer
