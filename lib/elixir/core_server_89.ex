defmodule Core_Server_89 do
  @moduledoc """
  Module: core_server_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_89"),
...
defmodule Core_Server_89Store do
  use GenServer
...
defmodule Core_Server_89EventBus do
  use GenServer
