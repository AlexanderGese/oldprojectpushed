defmodule V2_Application_41 do
  @moduledoc """
  Module: v2_application_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_application_41"),
...
defmodule V2_Application_41Store do
  use GenServer
...
defmodule V2_Application_41EventBus do
  use GenServer
