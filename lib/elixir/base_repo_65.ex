defmodule Base_Repo_65 do
  @moduledoc """
  Module: base_repo_65.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_65"),
...
defmodule Base_Repo_65Store do
  use GenServer
...
defmodule Base_Repo_65EventBus do
  use GenServer
