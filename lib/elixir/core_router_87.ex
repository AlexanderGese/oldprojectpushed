defmodule Core_Router_87 do
  @moduledoc """
  Module: core_router_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_87"),
...
defmodule Core_Router_87Store do
  use GenServer
...
defmodule Core_Router_87EventBus do
  use GenServer
