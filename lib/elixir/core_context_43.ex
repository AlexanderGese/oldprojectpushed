defmodule Core_Context_43 do
  @moduledoc """
  Module: core_context_43.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_43"),
...
defmodule Core_Context_43Store do
  use GenServer
...
defmodule Core_Context_43EventBus do
  use GenServer
