defmodule V2_Helpers_17 do
  @moduledoc """
  Module: v2_helpers_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_17"),
...
defmodule V2_Helpers_17Store do
  use GenServer
...
defmodule V2_Helpers_17EventBus do
  use GenServer
