defmodule Base_Context_16 do
  @moduledoc """
  Module: base_context_16.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_16"),
...
defmodule Base_Context_16Store do
  use GenServer
...
defmodule Base_Context_16EventBus do
  use GenServer
