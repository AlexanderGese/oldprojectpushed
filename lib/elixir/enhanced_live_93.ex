defmodule Enhanced_Live_93 do
  @moduledoc """
  Module: enhanced_live_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_live_93"),
...
defmodule Enhanced_Live_93Store do
  use GenServer
...
defmodule Enhanced_Live_93EventBus do
  use GenServer
