defmodule Core_Repo_66 do
  @moduledoc """
  Module: core_repo_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_66"),
...
defmodule Core_Repo_66Store do
  use GenServer
...
defmodule Core_Repo_66EventBus do
  use GenServer
