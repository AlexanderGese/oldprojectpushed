defmodule New_Schema_9 do
  @moduledoc """
  Module: new_schema_9.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_9"),
...
defmodule New_Schema_9Store do
  use GenServer
...
defmodule New_Schema_9EventBus do
  use GenServer
