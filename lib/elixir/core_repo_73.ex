defmodule Core_Repo_73 do
  @moduledoc """
  Module: core_repo_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_73"),
...
defmodule Core_Repo_73Store do
  use GenServer
...
defmodule Core_Repo_73EventBus do
  use GenServer
