defmodule New_Router_42 do
  @moduledoc """
  Module: new_router_42.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_42"),
...
defmodule New_Router_42Store do
  use GenServer
...
defmodule New_Router_42EventBus do
  use GenServer
