defmodule New_Controller_97 do
  @moduledoc """
  Module: new_controller_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_97"),
...
defmodule New_Controller_97Store do
  use GenServer
...
defmodule New_Controller_97EventBus do
  use GenServer
