defmodule Core_Schema_64 do
  @moduledoc """
  Module: core_schema_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_64"),
...
defmodule Core_Schema_64Store do
  use GenServer
...
defmodule Core_Schema_64EventBus do
  use GenServer
