defmodule Impl_Live_12 do
  @moduledoc """
  Module: impl_live_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_12"),
...
defmodule Impl_Live_12Store do
  use GenServer
...
defmodule Impl_Live_12EventBus do
  use GenServer
