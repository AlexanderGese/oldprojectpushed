defmodule Base_Context_50 do
  @moduledoc """
  Module: base_context_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_50"),
...
defmodule Base_Context_50Store do
  use GenServer
...
defmodule Base_Context_50EventBus do
  use GenServer
