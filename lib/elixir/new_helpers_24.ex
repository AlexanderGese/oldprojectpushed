defmodule New_Helpers_24 do
  @moduledoc """
  Module: new_helpers_24.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_24"),
...
defmodule New_Helpers_24Store do
  use GenServer
...
defmodule New_Helpers_24EventBus do
  use GenServer
