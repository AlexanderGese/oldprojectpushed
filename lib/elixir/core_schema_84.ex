defmodule Core_Schema_84 do
  @moduledoc """
  Module: core_schema_84.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_84"),
...
defmodule Core_Schema_84Store do
  use GenServer
...
defmodule Core_Schema_84EventBus do
  use GenServer
