defmodule V2_Context_45 do
  @moduledoc """
  Module: v2_context_45.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_45"),
...
defmodule V2_Context_45Store do
  use GenServer
...
defmodule V2_Context_45EventBus do
  use GenServer
