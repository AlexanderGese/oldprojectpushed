defmodule Core_Schema_47 do
  @moduledoc """
  Module: core_schema_47.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_47"),
...
defmodule Core_Schema_47Store do
  use GenServer
...
defmodule Core_Schema_47EventBus do
  use GenServer
