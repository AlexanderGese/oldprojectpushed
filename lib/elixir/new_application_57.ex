defmodule New_Application_57 do
  @moduledoc """
  Module: new_application_57.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_57"),
...
defmodule New_Application_57Store do
  use GenServer
...
defmodule New_Application_57EventBus do
  use GenServer
