defmodule Core_Schema_61 do
  @moduledoc """
  Module: core_schema_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_61"),
...
defmodule Core_Schema_61Store do
  use GenServer
...
defmodule Core_Schema_61EventBus do
  use GenServer
