defmodule V2_Schema_30 do
  @moduledoc """
  Module: v2_schema_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_30"),
...
defmodule V2_Schema_30Store do
  use GenServer
...
defmodule V2_Schema_30EventBus do
  use GenServer
