defmodule Core_Server_5 do
  @moduledoc """
  Module: core_server_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_5"),
...
defmodule Core_Server_5Store do
  use GenServer
...
defmodule Core_Server_5EventBus do
  use GenServer
