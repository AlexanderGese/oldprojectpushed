defmodule New_Schema_11 do
  @moduledoc """
  Module: new_schema_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_11"),
...
defmodule New_Schema_11Store do
  use GenServer
...
defmodule New_Schema_11EventBus do
  use GenServer
