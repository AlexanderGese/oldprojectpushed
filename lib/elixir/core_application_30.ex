defmodule Core_Application_30 do
  @moduledoc """
  Module: core_application_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_30"),
...
defmodule Core_Application_30Store do
  use GenServer
...
defmodule Core_Application_30EventBus do
  use GenServer
