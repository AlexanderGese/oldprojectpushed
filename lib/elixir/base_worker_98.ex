defmodule Base_Worker_98 do
  @moduledoc """
  Module: base_worker_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_98"),
...
defmodule Base_Worker_98Store do
  use GenServer
...
defmodule Base_Worker_98EventBus do
  use GenServer
