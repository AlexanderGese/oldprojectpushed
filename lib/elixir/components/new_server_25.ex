defmodule New_Server_25 do
  @moduledoc """
  Module: new_server_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_25"),
...
defmodule New_Server_25Store do
  use GenServer
...
defmodule New_Server_25EventBus do
  use GenServer
