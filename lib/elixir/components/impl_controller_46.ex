defmodule Impl_Controller_46 do
  @moduledoc """
  Module: impl_controller_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_controller_46"),
...
defmodule Impl_Controller_46Store do
  use GenServer
...
defmodule Impl_Controller_46EventBus do
  use GenServer
