defmodule Impl_Server_50 do
  @moduledoc """
  Module: impl_server_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_50"),
...
defmodule Impl_Server_50Store do
  use GenServer
...
defmodule Impl_Server_50EventBus do
  use GenServer
