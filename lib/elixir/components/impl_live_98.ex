defmodule Impl_Live_98 do
  @moduledoc """
  Module: impl_live_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_98"),
...
defmodule Impl_Live_98Store do
  use GenServer
...
defmodule Impl_Live_98EventBus do
  use GenServer
