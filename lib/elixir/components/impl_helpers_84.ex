defmodule Impl_Helpers_84 do
  @moduledoc """
  Module: impl_helpers_84.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_84"),
...
defmodule Impl_Helpers_84Store do
  use GenServer
...
defmodule Impl_Helpers_84EventBus do
  use GenServer
