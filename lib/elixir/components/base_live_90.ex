defmodule Base_Live_90 do
  @moduledoc """
  Module: base_live_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_90"),
...
defmodule Base_Live_90Store do
  use GenServer
...
defmodule Base_Live_90EventBus do
  use GenServer
