defmodule New_Helpers_93 do
  @moduledoc """
  Module: new_helpers_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_93"),
...
defmodule New_Helpers_93Store do
  use GenServer
...
defmodule New_Helpers_93EventBus do
  use GenServer
