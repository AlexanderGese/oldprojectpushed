defmodule Base_Server_50 do
  @moduledoc """
  Module: base_server_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_50"),
...
defmodule Base_Server_50Store do
  use GenServer
...
defmodule Base_Server_50EventBus do
  use GenServer
