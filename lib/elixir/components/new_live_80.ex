defmodule New_Live_80 do
  @moduledoc """
  Module: new_live_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_80"),
...
defmodule New_Live_80EventBus do
  use GenServer
