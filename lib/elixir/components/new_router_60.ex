defmodule New_Router_60 do
  @moduledoc """
  Module: new_router_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_60"),
...
defmodule New_Router_60Store do
  use GenServer
...
defmodule New_Router_60EventBus do
  use GenServer
