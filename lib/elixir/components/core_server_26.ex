defmodule Core_Server_26 do
  @moduledoc """
  Module: core_server_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_26"),
...
defmodule Core_Server_26Store do
  use GenServer
...
defmodule Core_Server_26EventBus do
  use GenServer
