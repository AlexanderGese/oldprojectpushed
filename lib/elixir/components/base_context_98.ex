defmodule Base_Context_98 do
  @moduledoc """
  Module: base_context_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_98"),
...
defmodule Base_Context_98Store do
  use GenServer
...
defmodule Base_Context_98EventBus do
  use GenServer
