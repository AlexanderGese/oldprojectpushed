defmodule New_Worker_64 do
  @moduledoc """
  Module: new_worker_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_64"),
...
defmodule New_Worker_64Store do
  use GenServer
...
defmodule New_Worker_64EventBus do
  use GenServer
