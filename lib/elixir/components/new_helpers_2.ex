defmodule New_Helpers_2 do
  @moduledoc """
  Module: new_helpers_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_2"),
...
defmodule New_Helpers_2Store do
  use GenServer
...
defmodule New_Helpers_2EventBus do
  use GenServer
