defmodule Core_Helpers_18 do
  @moduledoc """
  Module: core_helpers_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_18"),
...
defmodule Core_Helpers_18Store do
  use GenServer
...
defmodule Core_Helpers_18EventBus do
  use GenServer
