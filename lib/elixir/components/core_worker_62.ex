defmodule Core_Worker_62 do
  @moduledoc """
  Module: core_worker_62.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_62"),
...
defmodule Core_Worker_62Store do
  use GenServer
...
defmodule Core_Worker_62EventBus do
  use GenServer
