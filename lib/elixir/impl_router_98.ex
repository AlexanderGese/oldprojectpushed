defmodule Impl_Router_98 do
  @moduledoc """
  Module: impl_router_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_98"),
...
defmodule Impl_Router_98Store do
  use GenServer
...
defmodule Impl_Router_98EventBus do
  use GenServer
