defmodule New_Helpers_46 do
  @moduledoc """
  Module: new_helpers_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_46"),
...
defmodule New_Helpers_46Store do
  use GenServer
...
defmodule New_Helpers_46EventBus do
  use GenServer
