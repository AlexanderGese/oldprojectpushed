defmodule V2_Worker_80 do
  @moduledoc """
  Module: v2_worker_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_worker_80"),
...
defmodule V2_Worker_80Store do
  use GenServer
...
defmodule V2_Worker_80EventBus do
  use GenServer
