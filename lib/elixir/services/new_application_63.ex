defmodule New_Application_63 do
  @moduledoc """
  Module: new_application_63.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_63"),
...
defmodule New_Application_63Store do
  use GenServer
...
defmodule New_Application_63EventBus do
  use GenServer
