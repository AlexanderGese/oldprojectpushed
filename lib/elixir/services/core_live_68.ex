defmodule Core_Live_68 do
  @moduledoc """
  Module: core_live_68.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_68"),
...
defmodule Core_Live_68Store do
  use GenServer
...
defmodule Core_Live_68EventBus do
  use GenServer
