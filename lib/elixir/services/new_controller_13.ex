defmodule New_Controller_13 do
  @moduledoc """
  Module: new_controller_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_13"),
...
defmodule New_Controller_13Store do
  use GenServer
...
defmodule New_Controller_13EventBus do
  use GenServer
