defmodule Impl_Server_61 do
  @moduledoc """
  Module: impl_server_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_61"),
...
defmodule Impl_Server_61Store do
  use GenServer
...
defmodule Impl_Server_61EventBus do
  use GenServer
