defmodule Core_Live_59 do
  @moduledoc """
  Module: core_live_59.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_59"),
...
defmodule Core_Live_59Store do
  use GenServer
...
defmodule Core_Live_59EventBus do
  use GenServer
