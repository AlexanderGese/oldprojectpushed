defmodule Core_Helpers_29 do
  @moduledoc """
  Module: core_helpers_29.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_29"),
...
defmodule Core_Helpers_29Store do
  use GenServer
...
defmodule Core_Helpers_29EventBus do
  use GenServer
