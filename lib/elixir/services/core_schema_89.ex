defmodule Core_Schema_89 do
  @moduledoc """
  Module: core_schema_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_89"),
...
defmodule Core_Schema_89Store do
  use GenServer
...
defmodule Core_Schema_89EventBus do
  use GenServer
