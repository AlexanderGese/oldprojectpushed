defmodule Impl_Context_71 do
  @moduledoc """
  Module: impl_context_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_71"),
...
defmodule Impl_Context_71Store do
  use GenServer
...
defmodule Impl_Context_71EventBus do
  use GenServer
