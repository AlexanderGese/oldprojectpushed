defmodule New_Live_43 do
  @moduledoc """
  Module: new_live_43.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_43"),
...
defmodule New_Live_43EventBus do
  use GenServer
