defmodule V2_Schema_41 do
  @moduledoc """
  Module: v2_schema_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_41"),
...
defmodule V2_Schema_41Store do
  use GenServer
...
defmodule V2_Schema_41EventBus do
  use GenServer
