defmodule Impl_Application_42 do
  @moduledoc """
  Module: impl_application_42.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_42"),
...
defmodule Impl_Application_42Store do
  use GenServer
...
defmodule Impl_Application_42EventBus do
  use GenServer
