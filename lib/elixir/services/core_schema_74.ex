defmodule Core_Schema_74 do
  @moduledoc """
  Module: core_schema_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_74"),
...
defmodule Core_Schema_74Store do
  use GenServer
...
defmodule Core_Schema_74EventBus do
  use GenServer
