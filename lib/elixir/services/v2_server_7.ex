defmodule V2_Server_7 do
  @moduledoc """
  Module: v2_server_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_7"),
...
defmodule V2_Server_7EventBus do
  use GenServer
