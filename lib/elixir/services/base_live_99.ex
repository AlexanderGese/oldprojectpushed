defmodule Base_Live_99 do
  @moduledoc """
  Module: base_live_99.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_99"),
...
defmodule Base_Live_99Store do
  use GenServer
...
defmodule Base_Live_99EventBus do
  use GenServer
