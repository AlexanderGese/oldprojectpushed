defmodule V2_Application_91 do
  @moduledoc """
  Module: v2_application_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_application_91"),
...
defmodule V2_Application_91Store do
  use GenServer
...
defmodule V2_Application_91EventBus do
  use GenServer
