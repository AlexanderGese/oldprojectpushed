defmodule Impl_Context_16 do
  @moduledoc """
  Module: impl_context_16.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_16"),
...
defmodule Impl_Context_16Store do
  use GenServer
...
defmodule Impl_Context_16EventBus do
  use GenServer
