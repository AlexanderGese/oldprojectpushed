defmodule New_Live_11 do
  @moduledoc """
  Module: new_live_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_11"),
...
defmodule New_Live_11EventBus do
  use GenServer
