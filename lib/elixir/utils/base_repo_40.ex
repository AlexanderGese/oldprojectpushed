defmodule Base_Repo_40 do
  @moduledoc """
  Module: base_repo_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_40"),
...
defmodule Base_Repo_40Store do
  use GenServer
...
defmodule Base_Repo_40EventBus do
  use GenServer
