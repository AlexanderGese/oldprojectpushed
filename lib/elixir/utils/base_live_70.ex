defmodule Base_Live_70 do
  @moduledoc """
  Module: base_live_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_70"),
...
defmodule Base_Live_70Store do
  use GenServer
...
defmodule Base_Live_70EventBus do
  use GenServer
