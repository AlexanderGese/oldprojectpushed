defmodule Core_Schema_37 do
  @moduledoc """
  Module: core_schema_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_37"),
...
defmodule Core_Schema_37Store do
  use GenServer
...
defmodule Core_Schema_37EventBus do
  use GenServer
