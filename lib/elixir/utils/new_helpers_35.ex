defmodule New_Helpers_35 do
  @moduledoc """
  Module: new_helpers_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_35"),
...
defmodule New_Helpers_35Store do
  use GenServer
...
defmodule New_Helpers_35EventBus do
  use GenServer
