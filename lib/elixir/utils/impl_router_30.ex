defmodule Impl_Router_30 do
  @moduledoc """
  Module: impl_router_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_30"),
...
defmodule Impl_Router_30Store do
  use GenServer
...
defmodule Impl_Router_30EventBus do
  use GenServer
