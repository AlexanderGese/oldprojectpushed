defmodule New_Context_95 do
  @moduledoc """
  Module: new_context_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_95"),
...
defmodule New_Context_95Store do
  use GenServer
...
defmodule New_Context_95EventBus do
  use GenServer
