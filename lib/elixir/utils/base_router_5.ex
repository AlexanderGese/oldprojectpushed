defmodule Base_Router_5 do
  @moduledoc """
  Module: base_router_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_5"),
...
defmodule Base_Router_5Store do
  use GenServer
...
defmodule Base_Router_5EventBus do
  use GenServer
