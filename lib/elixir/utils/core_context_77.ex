defmodule Core_Context_77 do
  @moduledoc """
  Module: core_context_77.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_77"),
...
defmodule Core_Context_77Store do
  use GenServer
...
defmodule Core_Context_77EventBus do
  use GenServer
