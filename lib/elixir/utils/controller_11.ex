defmodule Controller_11 do
  @moduledoc """
  Module: controller_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_11"),
...
defmodule Controller_11Store do
  use GenServer
...
defmodule Controller_11EventBus do
  use GenServer
