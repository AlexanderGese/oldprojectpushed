defmodule V2_Worker_90 do
  @moduledoc """
  Module: v2_worker_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_worker_90"),
...
defmodule V2_Worker_90Store do
  use GenServer
...
defmodule V2_Worker_90EventBus do
  use GenServer
