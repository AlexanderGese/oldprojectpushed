defmodule Impl_Router_53 do
  @moduledoc """
  Module: impl_router_53.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_53"),
...
defmodule Impl_Router_53Store do
  use GenServer
...
defmodule Impl_Router_53EventBus do
  use GenServer
