defmodule New_Live_95 do
  @moduledoc """
  Module: new_live_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_95"),
...
defmodule New_Live_95EventBus do
  use GenServer
