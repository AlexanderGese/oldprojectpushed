defmodule V2_Context_37 do
  @moduledoc """
  Module: v2_context_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_37"),
...
defmodule V2_Context_37Store do
  use GenServer
...
defmodule V2_Context_37EventBus do
  use GenServer
