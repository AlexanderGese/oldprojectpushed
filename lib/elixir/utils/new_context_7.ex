defmodule New_Context_7 do
  @moduledoc """
  Module: new_context_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_7"),
...
defmodule New_Context_7Store do
  use GenServer
...
defmodule New_Context_7EventBus do
  use GenServer
