defmodule Base_Context_64 do
  @moduledoc """
  Module: base_context_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_64"),
...
defmodule Base_Context_64Store do
  use GenServer
...
defmodule Base_Context_64EventBus do
  use GenServer
