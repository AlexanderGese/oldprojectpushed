defmodule New_Live_44 do
  @moduledoc """
  Module: new_live_44.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_44"),
...
defmodule New_Live_44EventBus do
  use GenServer
