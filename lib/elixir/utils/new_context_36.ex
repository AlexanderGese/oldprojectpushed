defmodule New_Context_36 do
  @moduledoc """
  Module: new_context_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_36"),
...
defmodule New_Context_36Store do
  use GenServer
...
defmodule New_Context_36EventBus do
  use GenServer
