defmodule Impl_Application_4 do
  @moduledoc """
  Module: impl_application_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_4"),
...
defmodule Impl_Application_4Store do
  use GenServer
...
defmodule Impl_Application_4EventBus do
  use GenServer
