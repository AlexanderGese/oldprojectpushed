defmodule New_Helpers_14 do
  @moduledoc """
  Module: new_helpers_14.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_14"),
...
defmodule New_Helpers_14Store do
  use GenServer
...
defmodule New_Helpers_14EventBus do
  use GenServer
