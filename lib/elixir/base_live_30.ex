defmodule Base_Live_30 do
  @moduledoc """
  Module: base_live_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_30"),
...
defmodule Base_Live_30Store do
  use GenServer
...
defmodule Base_Live_30EventBus do
  use GenServer
