defmodule New_Server_89 do
  @moduledoc """
  Module: new_server_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_89"),
...
defmodule New_Server_89Store do
  use GenServer
...
defmodule New_Server_89EventBus do
  use GenServer
