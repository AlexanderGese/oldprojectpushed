defmodule New_Helpers_91 do
  @moduledoc """
  Module: new_helpers_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_91"),
...
defmodule New_Helpers_91Store do
  use GenServer
...
defmodule New_Helpers_91EventBus do
  use GenServer
