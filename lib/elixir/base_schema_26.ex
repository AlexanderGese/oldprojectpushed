defmodule Base_Schema_26 do
  @moduledoc """
  Module: base_schema_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_26"),
...
defmodule Base_Schema_26Store do
  use GenServer
...
defmodule Base_Schema_26EventBus do
  use GenServer
