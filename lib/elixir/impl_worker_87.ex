defmodule Impl_Worker_87 do
  @moduledoc """
  Module: impl_worker_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_87"),
...
defmodule Impl_Worker_87Store do
  use GenServer
...
defmodule Impl_Worker_87EventBus do
  use GenServer
