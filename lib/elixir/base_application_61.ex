defmodule Base_Application_61 do
  @moduledoc """
  Module: base_application_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_61"),
...
defmodule Base_Application_61Store do
  use GenServer
...
defmodule Base_Application_61EventBus do
  use GenServer
