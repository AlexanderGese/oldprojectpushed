defmodule Base_Live_61 do
  @moduledoc """
  Module: base_live_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_61"),
...
defmodule Base_Live_61Store do
  use GenServer
...
defmodule Base_Live_61EventBus do
  use GenServer
