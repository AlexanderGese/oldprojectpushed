defmodule V2_Router_32 do
  @moduledoc """
  Module: v2_router_32.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_router_32"),
...
defmodule V2_Router_32Store do
  use GenServer
...
defmodule V2_Router_32EventBus do
  use GenServer
