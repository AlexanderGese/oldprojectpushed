defmodule V2_Helpers_74 do
  @moduledoc """
  Module: v2_helpers_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_74"),
...
defmodule V2_Helpers_74Store do
  use GenServer
...
defmodule V2_Helpers_74EventBus do
  use GenServer
