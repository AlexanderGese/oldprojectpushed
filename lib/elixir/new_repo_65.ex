defmodule New_Repo_65 do
  @moduledoc """
  Module: new_repo_65.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_65"),
...
defmodule New_Repo_65EventBus do
  use GenServer
