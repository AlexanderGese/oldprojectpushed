defmodule Impl_Live_57 do
  @moduledoc """
  Module: impl_live_57.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_57"),
...
defmodule Impl_Live_57Store do
  use GenServer
...
defmodule Impl_Live_57EventBus do
  use GenServer
