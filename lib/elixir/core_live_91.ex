defmodule Core_Live_91 do
  @moduledoc """
  Module: core_live_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_91"),
...
defmodule Core_Live_91Store do
  use GenServer
...
defmodule Core_Live_91EventBus do
  use GenServer
