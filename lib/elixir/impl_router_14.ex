defmodule Impl_Router_14 do
  @moduledoc """
  Module: impl_router_14.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_14"),
...
defmodule Impl_Router_14Store do
  use GenServer
...
defmodule Impl_Router_14EventBus do
  use GenServer
