defmodule Impl_Router_12 do
  @moduledoc """
  Module: impl_router_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_12"),
...
defmodule Impl_Router_12Store do
  use GenServer
...
defmodule Impl_Router_12EventBus do
  use GenServer
