defmodule Base_Controller_27 do
  @moduledoc """
  Module: base_controller_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_27"),
...
defmodule Base_Controller_27Store do
  use GenServer
...
defmodule Base_Controller_27EventBus do
  use GenServer
