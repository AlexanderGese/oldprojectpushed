defmodule V2_Schema_50 do
  @moduledoc """
  Module: v2_schema_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_50"),
...
defmodule V2_Schema_50Store do
  use GenServer
...
defmodule V2_Schema_50EventBus do
  use GenServer
