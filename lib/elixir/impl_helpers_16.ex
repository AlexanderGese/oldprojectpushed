defmodule Impl_Helpers_16 do
  @moduledoc """
  Module: impl_helpers_16.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_16"),
...
defmodule Impl_Helpers_16Store do
  use GenServer
...
defmodule Impl_Helpers_16EventBus do
  use GenServer
