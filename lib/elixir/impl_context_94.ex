defmodule Impl_Context_94 do
  @moduledoc """
  Module: impl_context_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_94"),
...
defmodule Impl_Context_94Store do
  use GenServer
...
defmodule Impl_Context_94EventBus do
  use GenServer
