defmodule Impl_Live_55 do
  @moduledoc """
  Module: impl_live_55.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_55"),
...
defmodule Impl_Live_55Store do
  use GenServer
...
defmodule Impl_Live_55EventBus do
  use GenServer
