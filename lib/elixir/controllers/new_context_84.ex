defmodule New_Context_84 do
  @moduledoc """
  Module: new_context_84.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_84"),
...
defmodule New_Context_84Store do
  use GenServer
...
defmodule New_Context_84EventBus do
  use GenServer
