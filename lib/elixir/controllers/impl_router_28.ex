defmodule Impl_Router_28 do
  @moduledoc """
  Module: impl_router_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_28"),
...
defmodule Impl_Router_28Store do
  use GenServer
...
defmodule Impl_Router_28EventBus do
  use GenServer
