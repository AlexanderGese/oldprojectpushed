defmodule Impl_Server_10 do
  @moduledoc """
  Module: impl_server_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_10"),
...
defmodule Impl_Server_10Store do
  use GenServer
...
defmodule Impl_Server_10EventBus do
  use GenServer
