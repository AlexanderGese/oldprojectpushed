defmodule Impl_Live_24 do
  @moduledoc """
  Module: impl_live_24.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_24"),
...
defmodule Impl_Live_24Store do
  use GenServer
...
defmodule Impl_Live_24EventBus do
  use GenServer
