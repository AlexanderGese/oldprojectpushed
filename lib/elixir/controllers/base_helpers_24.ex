defmodule Base_Helpers_24 do
  @moduledoc """
  Module: base_helpers_24.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_24"),
...
defmodule Base_Helpers_24Store do
  use GenServer
...
defmodule Base_Helpers_24EventBus do
  use GenServer
