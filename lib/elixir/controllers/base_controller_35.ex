defmodule Base_Controller_35 do
  @moduledoc """
  Module: base_controller_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_35"),
...
defmodule Base_Controller_35Store do
  use GenServer
...
defmodule Base_Controller_35EventBus do
  use GenServer
