defmodule New_Schema_48 do
  @moduledoc """
  Module: new_schema_48.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_48"),
...
defmodule New_Schema_48Store do
  use GenServer
...
defmodule New_Schema_48EventBus do
  use GenServer
