defmodule Core_Context_31 do
  @moduledoc """
  Module: core_context_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_31"),
...
defmodule Core_Context_31Store do
  use GenServer
...
defmodule Core_Context_31EventBus do
  use GenServer
