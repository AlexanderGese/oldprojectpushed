defmodule Core_Live_85 do
  @moduledoc """
  Module: core_live_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_85"),
...
defmodule Core_Live_85Store do
  use GenServer
...
defmodule Core_Live_85EventBus do
  use GenServer
