defmodule New_Helpers_88 do
  @moduledoc """
  Module: new_helpers_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_88"),
...
defmodule New_Helpers_88Store do
  use GenServer
...
defmodule New_Helpers_88EventBus do
  use GenServer
