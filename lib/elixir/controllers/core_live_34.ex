defmodule Core_Live_34 do
  @moduledoc """
  Module: core_live_34.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_34"),
...
defmodule Core_Live_34Store do
  use GenServer
...
defmodule Core_Live_34EventBus do
  use GenServer
