defmodule New_Worker_66 do
  @moduledoc """
  Module: new_worker_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_66"),
...
defmodule New_Worker_66Store do
  use GenServer
...
defmodule New_Worker_66EventBus do
  use GenServer
