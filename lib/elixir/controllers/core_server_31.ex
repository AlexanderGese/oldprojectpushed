defmodule Core_Server_31 do
  @moduledoc """
  Module: core_server_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_31"),
...
defmodule Core_Server_31Store do
  use GenServer
...
defmodule Core_Server_31EventBus do
  use GenServer
