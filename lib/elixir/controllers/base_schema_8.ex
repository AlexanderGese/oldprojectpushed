defmodule Base_Schema_8 do
  @moduledoc """
  Module: base_schema_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_8"),
...
defmodule Base_Schema_8Store do
  use GenServer
...
defmodule Base_Schema_8EventBus do
  use GenServer
