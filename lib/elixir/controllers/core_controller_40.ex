defmodule Core_Controller_40 do
  @moduledoc """
  Module: core_controller_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_40"),
...
defmodule Core_Controller_40Store do
  use GenServer
...
defmodule Core_Controller_40EventBus do
  use GenServer
