defmodule V2_Worker_1 do
  @moduledoc """
  Module: v2_worker_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_worker_1"),
...
defmodule V2_Worker_1EventBus do
  use GenServer
