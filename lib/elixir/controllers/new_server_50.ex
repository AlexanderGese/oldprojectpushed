defmodule New_Server_50 do
  @moduledoc """
  Module: new_server_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_50"),
...
defmodule New_Server_50Store do
  use GenServer
...
defmodule New_Server_50EventBus do
  use GenServer
