defmodule Enhanced_Helpers_4 do
  @moduledoc """
  Module: enhanced_helpers_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_helpers_4"),
...
defmodule Enhanced_Helpers_4Store do
  use GenServer
...
defmodule Enhanced_Helpers_4EventBus do
  use GenServer
