defmodule V2_Server_36 do
  @moduledoc """
  Module: v2_server_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_36"),
...
defmodule V2_Server_36Store do
  use GenServer
...
defmodule V2_Server_36EventBus do
  use GenServer
