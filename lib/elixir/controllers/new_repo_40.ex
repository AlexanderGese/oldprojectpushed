defmodule New_Repo_40 do
  @moduledoc """
  Module: new_repo_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_40"),
...
defmodule New_Repo_40EventBus do
  use GenServer
