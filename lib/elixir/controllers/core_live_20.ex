defmodule Core_Live_20 do
  @moduledoc """
  Module: core_live_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_20"),
...
defmodule Core_Live_20Store do
  use GenServer
...
defmodule Core_Live_20EventBus do
  use GenServer
