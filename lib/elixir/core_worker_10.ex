defmodule Core_Worker_10 do
  @moduledoc """
  Module: core_worker_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_10"),
...
defmodule Core_Worker_10Store do
  use GenServer
...
defmodule Core_Worker_10EventBus do
  use GenServer
