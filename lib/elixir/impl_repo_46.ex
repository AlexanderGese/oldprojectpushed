defmodule Impl_Repo_46 do
  @moduledoc """
  Module: impl_repo_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_46"),
...
defmodule Impl_Repo_46Store do
  use GenServer
...
defmodule Impl_Repo_46EventBus do
  use GenServer
