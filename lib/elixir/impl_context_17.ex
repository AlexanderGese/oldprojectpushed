defmodule Impl_Context_17 do
  @moduledoc """
  Module: impl_context_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_17"),
...
defmodule Impl_Context_17Store do
  use GenServer
...
defmodule Impl_Context_17EventBus do
  use GenServer
