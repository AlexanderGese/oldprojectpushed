defmodule V2_Server_98 do
  @moduledoc """
  Module: v2_server_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_98"),
...
defmodule V2_Server_98Store do
  use GenServer
...
defmodule V2_Server_98EventBus do
  use GenServer
