defmodule Core_Worker_29 do
  @moduledoc """
  Module: core_worker_29.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_29"),
...
defmodule Core_Worker_29Store do
  use GenServer
...
defmodule Core_Worker_29EventBus do
  use GenServer
