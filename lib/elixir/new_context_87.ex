defmodule New_Context_87 do
  @moduledoc """
  Module: new_context_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_87"),
...
defmodule New_Context_87Store do
  use GenServer
...
defmodule New_Context_87EventBus do
  use GenServer
