defmodule Base_Worker_43 do
  @moduledoc """
  Module: base_worker_43.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_43"),
...
defmodule Base_Worker_43Store do
  use GenServer
...
defmodule Base_Worker_43EventBus do
  use GenServer
