defmodule Base_Controller_47 do
  @moduledoc """
  Module: base_controller_47.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_47"),
...
defmodule Base_Controller_47Store do
  use GenServer
...
defmodule Base_Controller_47EventBus do
  use GenServer
