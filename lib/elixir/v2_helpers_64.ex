defmodule V2_Helpers_64 do
  @moduledoc """
  Module: v2_helpers_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_64"),
...
defmodule V2_Helpers_64Store do
  use GenServer
...
defmodule V2_Helpers_64EventBus do
  use GenServer
