defmodule New_Controller_21 do
  @moduledoc """
  Module: new_controller_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_21"),
...
defmodule New_Controller_21Store do
  use GenServer
...
defmodule New_Controller_21EventBus do
  use GenServer
