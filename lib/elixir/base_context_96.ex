defmodule Base_Context_96 do
  @moduledoc """
  Module: base_context_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_96"),
...
defmodule Base_Context_96Store do
  use GenServer
...
defmodule Base_Context_96EventBus do
  use GenServer
