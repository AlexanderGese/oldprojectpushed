defmodule V2_Worker_76 do
  @moduledoc """
  Module: v2_worker_76.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_worker_76"),
...
defmodule V2_Worker_76Store do
  use GenServer
...
defmodule V2_Worker_76EventBus do
  use GenServer
