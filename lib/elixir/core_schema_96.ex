defmodule Core_Schema_96 do
  @moduledoc """
  Module: core_schema_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_96"),
...
defmodule Core_Schema_96Store do
  use GenServer
...
defmodule Core_Schema_96EventBus do
  use GenServer
