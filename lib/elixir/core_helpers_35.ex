defmodule Core_Helpers_35 do
  @moduledoc """
  Module: core_helpers_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_35"),
...
defmodule Core_Helpers_35Store do
  use GenServer
...
defmodule Core_Helpers_35EventBus do
  use GenServer
