defmodule Base_Context_44 do
  @moduledoc """
  Module: base_context_44.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_44"),
...
defmodule Base_Context_44Store do
  use GenServer
...
defmodule Base_Context_44EventBus do
  use GenServer
