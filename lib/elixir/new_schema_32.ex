defmodule New_Schema_32 do
  @moduledoc """
  Module: new_schema_32.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_32"),
...
defmodule New_Schema_32Store do
  use GenServer
...
defmodule New_Schema_32EventBus do
  use GenServer
