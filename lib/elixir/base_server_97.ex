defmodule Base_Server_97 do
  @moduledoc """
  Module: base_server_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_97"),
...
defmodule Base_Server_97Store do
  use GenServer
...
defmodule Base_Server_97EventBus do
  use GenServer
