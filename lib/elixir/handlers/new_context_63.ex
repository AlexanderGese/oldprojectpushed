defmodule New_Context_63 do
  @moduledoc """
  Module: new_context_63.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_63"),
...
defmodule New_Context_63Store do
  use GenServer
...
defmodule New_Context_63EventBus do
  use GenServer
