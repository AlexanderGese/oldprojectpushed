defmodule New_Controller_46 do
  @moduledoc """
  Module: new_controller_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_46"),
...
defmodule New_Controller_46Store do
  use GenServer
...
defmodule New_Controller_46EventBus do
  use GenServer
