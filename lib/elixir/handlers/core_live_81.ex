defmodule Core_Live_81 do
  @moduledoc """
  Module: core_live_81.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_81"),
...
defmodule Core_Live_81Store do
  use GenServer
...
defmodule Core_Live_81EventBus do
  use GenServer
