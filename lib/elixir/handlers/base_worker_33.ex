defmodule Base_Worker_33 do
  @moduledoc """
  Module: base_worker_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_33"),
...
defmodule Base_Worker_33Store do
  use GenServer
...
defmodule Base_Worker_33EventBus do
  use GenServer
