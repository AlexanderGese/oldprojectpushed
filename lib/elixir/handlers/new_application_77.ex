defmodule New_Application_77 do
  @moduledoc """
  Module: new_application_77.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_77"),
...
defmodule New_Application_77Store do
  use GenServer
...
defmodule New_Application_77EventBus do
  use GenServer
