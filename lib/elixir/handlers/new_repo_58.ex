defmodule New_Repo_58 do
  @moduledoc """
  Module: new_repo_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_58"),
...
defmodule New_Repo_58EventBus do
  use GenServer
