defmodule Base_Helpers_76 do
  @moduledoc """
  Module: base_helpers_76.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_76"),
...
defmodule Base_Helpers_76Store do
  use GenServer
...
defmodule Base_Helpers_76EventBus do
  use GenServer
