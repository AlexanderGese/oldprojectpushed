defmodule Base_Helpers_61 do
  @moduledoc """
  Module: base_helpers_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_61"),
...
defmodule Base_Helpers_61Store do
  use GenServer
...
defmodule Base_Helpers_61EventBus do
  use GenServer
