defmodule New_Schema_14 do
  @moduledoc """
  Module: new_schema_14.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_14"),
...
defmodule New_Schema_14Store do
  use GenServer
...
defmodule New_Schema_14EventBus do
  use GenServer
