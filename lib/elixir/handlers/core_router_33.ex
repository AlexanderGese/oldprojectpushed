defmodule Core_Router_33 do
  @moduledoc """
  Module: core_router_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_33"),
...
defmodule Core_Router_33Store do
  use GenServer
...
defmodule Core_Router_33EventBus do
  use GenServer
