defmodule Core_Application_38 do
  @moduledoc """
  Module: core_application_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_38"),
...
defmodule Core_Application_38Store do
  use GenServer
...
defmodule Core_Application_38EventBus do
  use GenServer
