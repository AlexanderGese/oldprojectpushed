defmodule Base_Application_26 do
  @moduledoc """
  Module: base_application_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_26"),
...
defmodule Base_Application_26Store do
  use GenServer
...
defmodule Base_Application_26EventBus do
  use GenServer
