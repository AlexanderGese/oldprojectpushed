defmodule Base_Repo_9 do
  @moduledoc """
  Module: base_repo_9.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_9"),
...
defmodule Base_Repo_9EventBus do
  use GenServer
