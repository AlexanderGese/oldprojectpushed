defmodule Impl_Live_88 do
  @moduledoc """
  Module: impl_live_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_88"),
...
defmodule Impl_Live_88Store do
  use GenServer
...
defmodule Impl_Live_88EventBus do
  use GenServer
