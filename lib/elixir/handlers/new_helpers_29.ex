defmodule New_Helpers_29 do
  @moduledoc """
  Module: new_helpers_29.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_29"),
...
defmodule New_Helpers_29Store do
  use GenServer
...
defmodule New_Helpers_29EventBus do
  use GenServer
