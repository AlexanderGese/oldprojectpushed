defmodule Core_Controller_94 do
  @moduledoc """
  Module: core_controller_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_94"),
...
defmodule Core_Controller_94Store do
  use GenServer
...
defmodule Core_Controller_94EventBus do
  use GenServer
