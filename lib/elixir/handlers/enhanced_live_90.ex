defmodule Enhanced_Live_90 do
  @moduledoc """
  Module: enhanced_live_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_live_90"),
...
defmodule Enhanced_Live_90Store do
  use GenServer
...
defmodule Enhanced_Live_90EventBus do
  use GenServer
