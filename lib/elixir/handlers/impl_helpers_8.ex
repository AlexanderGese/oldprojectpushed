defmodule Impl_Helpers_8 do
  @moduledoc """
  Module: impl_helpers_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_8"),
...
defmodule Impl_Helpers_8Store do
  use GenServer
...
defmodule Impl_Helpers_8EventBus do
  use GenServer
