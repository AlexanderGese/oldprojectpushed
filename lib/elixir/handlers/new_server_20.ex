defmodule New_Server_20 do
  @moduledoc """
  Module: new_server_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_20"),
...
defmodule New_Server_20Store do
  use GenServer
...
defmodule New_Server_20EventBus do
  use GenServer
