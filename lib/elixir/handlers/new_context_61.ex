defmodule New_Context_61 do
  @moduledoc """
  Module: new_context_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_61"),
...
defmodule New_Context_61Store do
  use GenServer
...
defmodule New_Context_61EventBus do
  use GenServer
