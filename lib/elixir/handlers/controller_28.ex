defmodule Controller_28 do
  @moduledoc """
  Module: controller_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_28"),
...
defmodule Controller_28Store do
  use GenServer
...
defmodule Controller_28EventBus do
  use GenServer
