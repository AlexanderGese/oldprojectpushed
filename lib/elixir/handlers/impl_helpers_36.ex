defmodule Impl_Helpers_36 do
  @moduledoc """
  Module: impl_helpers_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_36"),
...
defmodule Impl_Helpers_36Store do
  use GenServer
...
defmodule Impl_Helpers_36EventBus do
  use GenServer
