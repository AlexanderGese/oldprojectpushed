defmodule New_Schema_20 do
  @moduledoc """
  Module: new_schema_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_20"),
...
defmodule New_Schema_20Store do
  use GenServer
...
defmodule New_Schema_20EventBus do
  use GenServer
