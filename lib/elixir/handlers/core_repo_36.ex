defmodule Core_Repo_36 do
  @moduledoc """
  Module: core_repo_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_36"),
...
defmodule Core_Repo_36Store do
  use GenServer
...
defmodule Core_Repo_36EventBus do
  use GenServer
