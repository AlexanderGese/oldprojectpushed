defmodule V2_Router_24 do
  @moduledoc """
  Module: v2_router_24.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_router_24"),
...
defmodule V2_Router_24Store do
  use GenServer
...
defmodule V2_Router_24EventBus do
  use GenServer
