defmodule Core_Helpers_63 do
  @moduledoc """
  Module: core_helpers_63.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_63"),
...
defmodule Core_Helpers_63Store do
  use GenServer
...
defmodule Core_Helpers_63EventBus do
  use GenServer
