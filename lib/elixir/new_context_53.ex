defmodule New_Context_53 do
  @moduledoc """
  Module: new_context_53.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_53"),
...
defmodule New_Context_53Store do
  use GenServer
...
defmodule New_Context_53EventBus do
  use GenServer
