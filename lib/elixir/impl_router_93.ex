defmodule Impl_Router_93 do
  @moduledoc """
  Module: impl_router_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_93"),
...
defmodule Impl_Router_93Store do
  use GenServer
...
defmodule Impl_Router_93EventBus do
  use GenServer
