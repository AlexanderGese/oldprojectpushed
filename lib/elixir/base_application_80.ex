defmodule Base_Application_80 do
  @moduledoc """
  Module: base_application_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_80"),
...
defmodule Base_Application_80Store do
  use GenServer
...
defmodule Base_Application_80EventBus do
  use GenServer
