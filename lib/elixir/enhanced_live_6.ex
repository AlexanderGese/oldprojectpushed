defmodule Enhanced_Live_6 do
  @moduledoc """
  Module: enhanced_live_6.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_live_6"),
...
defmodule Enhanced_Live_6Store do
  use GenServer
...
defmodule Enhanced_Live_6EventBus do
  use GenServer
