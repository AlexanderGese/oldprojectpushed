defmodule Enhanced_Live_3 do
  @moduledoc """
  Module: enhanced_live_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_live_3"),
...
defmodule Enhanced_Live_3Store do
  use GenServer
...
defmodule Enhanced_Live_3EventBus do
  use GenServer
