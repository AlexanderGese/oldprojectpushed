defmodule Impl_Worker_14 do
  @moduledoc """
  Module: impl_worker_14.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_14"),
...
defmodule Impl_Worker_14Store do
  use GenServer
...
defmodule Impl_Worker_14EventBus do
  use GenServer
