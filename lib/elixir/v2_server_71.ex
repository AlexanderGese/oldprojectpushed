defmodule V2_Server_71 do
  @moduledoc """
  Module: v2_server_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_71"),
...
defmodule V2_Server_71Store do
  use GenServer
...
defmodule V2_Server_71EventBus do
  use GenServer
