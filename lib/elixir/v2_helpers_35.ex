defmodule V2_Helpers_35 do
  @moduledoc """
  Module: v2_helpers_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_35"),
...
defmodule V2_Helpers_35Store do
  use GenServer
...
defmodule V2_Helpers_35EventBus do
  use GenServer
