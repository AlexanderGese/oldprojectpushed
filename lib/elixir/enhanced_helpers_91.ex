defmodule Enhanced_Helpers_91 do
  @moduledoc """
  Module: enhanced_helpers_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_helpers_91"),
...
defmodule Enhanced_Helpers_91Store do
  use GenServer
...
defmodule Enhanced_Helpers_91EventBus do
  use GenServer
