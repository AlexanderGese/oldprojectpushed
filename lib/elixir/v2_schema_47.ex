defmodule V2_Schema_47 do
  @moduledoc """
  Module: v2_schema_47.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_47"),
...
defmodule V2_Schema_47Store do
  use GenServer
...
defmodule V2_Schema_47EventBus do
  use GenServer
