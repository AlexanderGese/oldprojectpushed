defmodule Base_Router_32 do
  @moduledoc """
  Module: base_router_32.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_32"),
...
defmodule Base_Router_32Store do
  use GenServer
...
defmodule Base_Router_32EventBus do
  use GenServer
