defmodule Impl_Server_94 do
  @moduledoc """
  Module: impl_server_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_94"),
...
defmodule Impl_Server_94Store do
  use GenServer
...
defmodule Impl_Server_94EventBus do
  use GenServer
