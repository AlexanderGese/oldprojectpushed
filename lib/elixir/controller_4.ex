defmodule Controller_4 do
  @moduledoc """
  Module: controller_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_4"),
...
defmodule Controller_4Store do
  use GenServer
...
defmodule Controller_4EventBus do
  use GenServer
