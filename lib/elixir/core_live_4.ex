defmodule Core_Live_4 do
  @moduledoc """
  Module: core_live_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_4"),
...
defmodule Core_Live_4EventBus do
  use GenServer
