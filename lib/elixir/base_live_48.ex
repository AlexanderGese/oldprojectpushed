defmodule Base_Live_48 do
  @moduledoc """
  Module: base_live_48.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_48"),
...
defmodule Base_Live_48Store do
  use GenServer
...
defmodule Base_Live_48EventBus do
  use GenServer
