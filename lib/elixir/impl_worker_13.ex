defmodule Impl_Worker_13 do
  @moduledoc """
  Module: impl_worker_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_13"),
...
defmodule Impl_Worker_13Store do
  use GenServer
...
defmodule Impl_Worker_13EventBus do
  use GenServer
