defmodule Impl_Helpers_24 do
  @moduledoc """
  Module: impl_helpers_24.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_24"),
...
defmodule Impl_Helpers_24Store do
  use GenServer
...
defmodule Impl_Helpers_24EventBus do
  use GenServer
