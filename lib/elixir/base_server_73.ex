defmodule Base_Server_73 do
  @moduledoc """
  Module: base_server_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_73"),
...
defmodule Base_Server_73Store do
  use GenServer
...
defmodule Base_Server_73EventBus do
  use GenServer
