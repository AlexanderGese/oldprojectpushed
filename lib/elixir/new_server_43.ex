defmodule New_Server_43 do
  @moduledoc """
  Module: new_server_43.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_43"),
...
defmodule New_Server_43Store do
  use GenServer
...
defmodule New_Server_43EventBus do
  use GenServer
