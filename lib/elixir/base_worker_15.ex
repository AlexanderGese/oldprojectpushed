defmodule Base_Worker_15 do
  @moduledoc """
  Module: base_worker_15.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_15"),
...
defmodule Base_Worker_15Store do
  use GenServer
...
defmodule Base_Worker_15EventBus do
  use GenServer
