defmodule Base_Application_2 do
  @moduledoc """
  Module: base_application_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_2"),
...
defmodule Base_Application_2Store do
  use GenServer
...
defmodule Base_Application_2EventBus do
  use GenServer
