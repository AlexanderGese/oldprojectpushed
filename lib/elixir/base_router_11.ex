defmodule Base_Router_11 do
  @moduledoc """
  Module: base_router_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_11"),
...
defmodule Base_Router_11Store do
  use GenServer
...
defmodule Base_Router_11EventBus do
  use GenServer
