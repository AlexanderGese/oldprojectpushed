defmodule Impl_Server_77 do
  @moduledoc """
  Module: impl_server_77.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_77"),
...
defmodule Impl_Server_77Store do
  use GenServer
...
defmodule Impl_Server_77EventBus do
  use GenServer
