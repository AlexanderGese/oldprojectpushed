defmodule Core_Repo_65 do
  @moduledoc """
  Module: core_repo_65.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_65"),
...
defmodule Core_Repo_65Store do
  use GenServer
...
defmodule Core_Repo_65EventBus do
  use GenServer
