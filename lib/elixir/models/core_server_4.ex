defmodule Core_Server_4 do
  @moduledoc """
  Module: core_server_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_4"),
...
defmodule Core_Server_4Store do
  use GenServer
...
defmodule Core_Server_4EventBus do
  use GenServer
