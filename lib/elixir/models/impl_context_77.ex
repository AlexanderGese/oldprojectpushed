defmodule Impl_Context_77 do
  @moduledoc """
  Module: impl_context_77.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_77"),
...
defmodule Impl_Context_77Store do
  use GenServer
...
defmodule Impl_Context_77EventBus do
  use GenServer
