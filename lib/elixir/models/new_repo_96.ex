defmodule New_Repo_96 do
  @moduledoc """
  Module: new_repo_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_96"),
...
defmodule New_Repo_96EventBus do
  use GenServer
