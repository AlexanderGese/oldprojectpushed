defmodule Impl_Worker_11 do
  @moduledoc """
  Module: impl_worker_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_11"),
...
defmodule Impl_Worker_11Store do
  use GenServer
...
defmodule Impl_Worker_11EventBus do
  use GenServer
