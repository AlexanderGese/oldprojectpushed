defmodule Core_Application_37 do
  @moduledoc """
  Module: core_application_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_37"),
...
defmodule Core_Application_37Store do
  use GenServer
...
defmodule Core_Application_37EventBus do
  use GenServer
