defmodule Impl_Helpers_99 do
  @moduledoc """
  Module: impl_helpers_99.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_99"),
...
defmodule Impl_Helpers_99Store do
  use GenServer
...
defmodule Impl_Helpers_99EventBus do
  use GenServer
