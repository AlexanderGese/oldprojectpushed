defmodule New_Repo_44 do
  @moduledoc """
  Module: new_repo_44.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_44"),
...
defmodule New_Repo_44EventBus do
  use GenServer
