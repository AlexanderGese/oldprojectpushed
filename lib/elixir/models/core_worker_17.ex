defmodule Core_Worker_17 do
  @moduledoc """
  Module: core_worker_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_17"),
...
defmodule Core_Worker_17Store do
  use GenServer
...
defmodule Core_Worker_17EventBus do
  use GenServer
