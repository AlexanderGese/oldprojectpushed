defmodule Base_Repo_72 do
  @moduledoc """
  Module: base_repo_72.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_72"),
...
defmodule Base_Repo_72Store do
  use GenServer
...
defmodule Base_Repo_72EventBus do
  use GenServer
