defmodule New_Controller_30 do
  @moduledoc """
  Module: new_controller_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_30"),
...
defmodule New_Controller_30Store do
  use GenServer
...
defmodule New_Controller_30EventBus do
  use GenServer
