defmodule Impl_Context_90 do
  @moduledoc """
  Module: impl_context_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_90"),
...
defmodule Impl_Context_90Store do
  use GenServer
...
defmodule Impl_Context_90EventBus do
  use GenServer
