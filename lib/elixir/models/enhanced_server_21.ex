defmodule Enhanced_Server_21 do
  @moduledoc """
  Module: enhanced_server_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_server_21"),
...
defmodule Enhanced_Server_21Store do
  use GenServer
...
defmodule Enhanced_Server_21EventBus do
  use GenServer
