defmodule Impl_Live_79 do
  @moduledoc """
  Module: impl_live_79.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_79"),
...
defmodule Impl_Live_79Store do
  use GenServer
...
defmodule Impl_Live_79EventBus do
  use GenServer
