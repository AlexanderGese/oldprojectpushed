defmodule Core_Controller_85 do
  @moduledoc """
  Module: core_controller_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_85"),
...
defmodule Core_Controller_85Store do
  use GenServer
...
defmodule Core_Controller_85EventBus do
  use GenServer
