defmodule New_Live_64 do
  @moduledoc """
  Module: new_live_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_64"),
...
defmodule New_Live_64EventBus do
  use GenServer
