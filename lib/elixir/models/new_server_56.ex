defmodule New_Server_56 do
  @moduledoc """
  Module: new_server_56.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_56"),
...
defmodule New_Server_56Store do
  use GenServer
...
defmodule New_Server_56EventBus do
  use GenServer
