defmodule Core_Helpers_58 do
  @moduledoc """
  Module: core_helpers_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_58"),
...
defmodule Core_Helpers_58Store do
  use GenServer
...
defmodule Core_Helpers_58EventBus do
  use GenServer
