defmodule Impl_Schema_73 do
  @moduledoc """
  Module: impl_schema_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_73"),
...
defmodule Impl_Schema_73Store do
  use GenServer
...
defmodule Impl_Schema_73EventBus do
  use GenServer
