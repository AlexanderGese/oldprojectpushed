defmodule Base_Router_40 do
  @moduledoc """
  Module: base_router_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_40"),
...
defmodule Base_Router_40Store do
  use GenServer
...
defmodule Base_Router_40EventBus do
  use GenServer
