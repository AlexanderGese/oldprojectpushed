defmodule Impl_Router_36 do
  @moduledoc """
  Module: impl_router_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_36"),
...
defmodule Impl_Router_36Store do
  use GenServer
...
defmodule Impl_Router_36EventBus do
  use GenServer
