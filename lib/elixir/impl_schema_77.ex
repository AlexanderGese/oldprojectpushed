defmodule Impl_Schema_77 do
  @moduledoc """
  Module: impl_schema_77.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_77"),
...
defmodule Impl_Schema_77Store do
  use GenServer
...
defmodule Impl_Schema_77EventBus do
  use GenServer
