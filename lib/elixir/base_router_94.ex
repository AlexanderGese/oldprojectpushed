defmodule Base_Router_94 do
  @moduledoc """
  Module: base_router_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_94"),
...
defmodule Base_Router_94Store do
  use GenServer
...
defmodule Base_Router_94EventBus do
  use GenServer
