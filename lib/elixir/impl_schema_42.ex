defmodule Impl_Schema_42 do
  @moduledoc """
  Module: impl_schema_42.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_42"),
...
defmodule Impl_Schema_42Store do
  use GenServer
...
defmodule Impl_Schema_42EventBus do
  use GenServer
