defmodule New_Context_27 do
  @moduledoc """
  Module: new_context_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_27"),
...
defmodule New_Context_27Store do
  use GenServer
...
defmodule New_Context_27EventBus do
  use GenServer
