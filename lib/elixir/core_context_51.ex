defmodule Core_Context_51 do
  @moduledoc """
  Module: core_context_51.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_51"),
...
defmodule Core_Context_51Store do
  use GenServer
...
defmodule Core_Context_51EventBus do
  use GenServer
