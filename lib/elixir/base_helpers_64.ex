defmodule Base_Helpers_64 do
  @moduledoc """
  Module: base_helpers_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_64"),
...
defmodule Base_Helpers_64Store do
  use GenServer
...
defmodule Base_Helpers_64EventBus do
  use GenServer
