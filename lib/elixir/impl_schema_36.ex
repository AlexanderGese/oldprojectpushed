defmodule Impl_Schema_36 do
  @moduledoc """
  Module: impl_schema_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_36"),
...
defmodule Impl_Schema_36Store do
  use GenServer
...
defmodule Impl_Schema_36EventBus do
  use GenServer
