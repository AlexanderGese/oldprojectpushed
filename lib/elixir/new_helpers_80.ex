defmodule New_Helpers_80 do
  @moduledoc """
  Module: new_helpers_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_80"),
...
defmodule New_Helpers_80Store do
  use GenServer
...
defmodule New_Helpers_80EventBus do
  use GenServer
