defmodule Core_Context_34 do
  @moduledoc """
  Module: core_context_34.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_34"),
...
defmodule Core_Context_34Store do
  use GenServer
...
defmodule Core_Context_34EventBus do
  use GenServer
