defmodule Base_Live_23 do
  @moduledoc """
  Module: base_live_23.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_23"),
...
defmodule Base_Live_23Store do
  use GenServer
...
defmodule Base_Live_23EventBus do
  use GenServer
