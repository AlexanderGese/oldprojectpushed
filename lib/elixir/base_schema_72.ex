defmodule Base_Schema_72 do
  @moduledoc """
  Module: base_schema_72.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_72"),
...
defmodule Base_Schema_72Store do
  use GenServer
...
defmodule Base_Schema_72EventBus do
  use GenServer
