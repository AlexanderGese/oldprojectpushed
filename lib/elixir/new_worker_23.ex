defmodule New_Worker_23 do
  @moduledoc """
  Module: new_worker_23.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_23"),
...
defmodule New_Worker_23Store do
  use GenServer
...
defmodule New_Worker_23EventBus do
  use GenServer
