defmodule Base_Repo_7 do
  @moduledoc """
  Module: base_repo_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_7"),
...
defmodule Base_Repo_7EventBus do
  use GenServer
