defmodule Core_Controller_60 do
  @moduledoc """
  Module: core_controller_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_60"),
...
defmodule Core_Controller_60Store do
  use GenServer
...
defmodule Core_Controller_60EventBus do
  use GenServer
