defmodule Base_Repo_21 do
  @moduledoc """
  Module: base_repo_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_21"),
...
defmodule Base_Repo_21Store do
  use GenServer
...
defmodule Base_Repo_21EventBus do
  use GenServer
