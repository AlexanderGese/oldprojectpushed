defmodule New_Router_89 do
  @moduledoc """
  Module: new_router_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_89"),
...
defmodule New_Router_89Store do
  use GenServer
...
defmodule New_Router_89EventBus do
  use GenServer
