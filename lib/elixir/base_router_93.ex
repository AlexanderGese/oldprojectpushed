defmodule Base_Router_93 do
  @moduledoc """
  Module: base_router_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_93"),
...
defmodule Base_Router_93Store do
  use GenServer
...
defmodule Base_Router_93EventBus do
  use GenServer
