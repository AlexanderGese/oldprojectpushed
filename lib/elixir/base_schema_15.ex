defmodule Base_Schema_15 do
  @moduledoc """
  Module: base_schema_15.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_15"),
...
defmodule Base_Schema_15Store do
  use GenServer
...
defmodule Base_Schema_15EventBus do
  use GenServer
