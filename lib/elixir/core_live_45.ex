defmodule Core_Live_45 do
  @moduledoc """
  Module: core_live_45.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_45"),
...
defmodule Core_Live_45Store do
  use GenServer
...
defmodule Core_Live_45EventBus do
  use GenServer
