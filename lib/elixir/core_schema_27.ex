defmodule Core_Schema_27 do
  @moduledoc """
  Module: core_schema_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_27"),
...
defmodule Core_Schema_27Store do
  use GenServer
...
defmodule Core_Schema_27EventBus do
  use GenServer
