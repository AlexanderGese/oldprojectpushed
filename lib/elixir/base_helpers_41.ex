defmodule Base_Helpers_41 do
  @moduledoc """
  Module: base_helpers_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_41"),
...
defmodule Base_Helpers_41Store do
  use GenServer
...
defmodule Base_Helpers_41EventBus do
  use GenServer
