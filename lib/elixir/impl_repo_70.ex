defmodule Impl_Repo_70 do
  @moduledoc """
  Module: impl_repo_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_70"),
...
defmodule Impl_Repo_70Store do
  use GenServer
...
defmodule Impl_Repo_70EventBus do
  use GenServer
