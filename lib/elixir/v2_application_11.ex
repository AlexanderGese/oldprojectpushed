defmodule V2_Application_11 do
  @moduledoc """
  Module: v2_application_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_application_11"),
...
defmodule V2_Application_11Store do
  use GenServer
...
defmodule V2_Application_11EventBus do
  use GenServer
