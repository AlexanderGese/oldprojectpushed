defmodule Base_Live_74 do
  @moduledoc """
  Module: base_live_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_74"),
...
defmodule Base_Live_74Store do
  use GenServer
...
defmodule Base_Live_74EventBus do
  use GenServer
