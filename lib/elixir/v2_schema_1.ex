defmodule V2_Schema_1 do
  @moduledoc """
  Module: v2_schema_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_1"),
...
defmodule V2_Schema_1EventBus do
  use GenServer
