defmodule Core_Worker_8 do
  @moduledoc """
  Module: core_worker_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_8"),
...
defmodule Core_Worker_8Store do
  use GenServer
...
defmodule Core_Worker_8EventBus do
  use GenServer
