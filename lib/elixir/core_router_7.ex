defmodule Core_Router_7 do
  @moduledoc """
  Module: core_router_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_7"),
...
defmodule Core_Router_7Store do
  use GenServer
...
defmodule Core_Router_7EventBus do
  use GenServer
