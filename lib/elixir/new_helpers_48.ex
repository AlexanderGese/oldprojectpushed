defmodule New_Helpers_48 do
  @moduledoc """
  Module: new_helpers_48.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_48"),
...
defmodule New_Helpers_48Store do
  use GenServer
...
defmodule New_Helpers_48EventBus do
  use GenServer
