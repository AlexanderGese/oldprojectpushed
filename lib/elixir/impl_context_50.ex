defmodule Impl_Context_50 do
  @moduledoc """
  Module: impl_context_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_50"),
...
defmodule Impl_Context_50Store do
  use GenServer
...
defmodule Impl_Context_50EventBus do
  use GenServer
