defmodule Controller_2 do
  @moduledoc """
  Module: controller_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_2"),
...
defmodule Controller_2Store do
  use GenServer
...
defmodule Controller_2EventBus do
  use GenServer
