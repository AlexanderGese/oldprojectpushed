defmodule Core_Controller_35 do
  @moduledoc """
  Module: core_controller_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_35"),
...
defmodule Core_Controller_35Store do
  use GenServer
...
defmodule Core_Controller_35EventBus do
  use GenServer
