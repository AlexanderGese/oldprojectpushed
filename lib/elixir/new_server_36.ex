defmodule New_Server_36 do
  @moduledoc """
  Module: new_server_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_36"),
...
defmodule New_Server_36Store do
  use GenServer
...
defmodule New_Server_36EventBus do
  use GenServer
