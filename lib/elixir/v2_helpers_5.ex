defmodule V2_Helpers_5 do
  @moduledoc """
  Module: v2_helpers_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_5"),
...
defmodule V2_Helpers_5Store do
  use GenServer
...
defmodule V2_Helpers_5EventBus do
  use GenServer
