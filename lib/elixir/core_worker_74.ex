defmodule Core_Worker_74 do
  @moduledoc """
  Module: core_worker_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_74"),
...
defmodule Core_Worker_74Store do
  use GenServer
...
defmodule Core_Worker_74EventBus do
  use GenServer
