defmodule Base_Server_1 do
  @moduledoc """
  Module: base_server_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_1"),
...
defmodule Base_Server_1Store do
  use GenServer
...
defmodule Base_Server_1EventBus do
  use GenServer
