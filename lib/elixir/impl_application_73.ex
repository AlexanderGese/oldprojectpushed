defmodule Impl_Application_73 do
  @moduledoc """
  Module: impl_application_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_73"),
...
defmodule Impl_Application_73Store do
  use GenServer
...
defmodule Impl_Application_73EventBus do
  use GenServer
