defmodule Impl_Controller_13 do
  @moduledoc """
  Module: impl_controller_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_controller_13"),
...
defmodule Impl_Controller_13Store do
  use GenServer
...
defmodule Impl_Controller_13EventBus do
  use GenServer
