defmodule V2_Router_87 do
  @moduledoc """
  Module: v2_router_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_router_87"),
...
defmodule V2_Router_87Store do
  use GenServer
...
defmodule V2_Router_87EventBus do
  use GenServer
