defmodule Core_Server_55 do
  @moduledoc """
  Module: core_server_55.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_55"),
...
defmodule Core_Server_55Store do
  use GenServer
...
defmodule Core_Server_55EventBus do
  use GenServer
