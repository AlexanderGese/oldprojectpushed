defmodule Base_Worker_73 do
  @moduledoc """
  Module: base_worker_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_73"),
...
defmodule Base_Worker_73Store do
  use GenServer
...
defmodule Base_Worker_73EventBus do
  use GenServer
