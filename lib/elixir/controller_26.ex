defmodule Controller_26 do
  @moduledoc """
  Module: controller_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_26"),
...
defmodule Controller_26Store do
  use GenServer
...
defmodule Controller_26EventBus do
  use GenServer
