defmodule Core_Context_64 do
  @moduledoc """
  Module: core_context_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_64"),
...
defmodule Core_Context_64Store do
  use GenServer
...
defmodule Core_Context_64EventBus do
  use GenServer
