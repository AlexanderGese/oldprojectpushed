defmodule Impl_Context_36 do
  @moduledoc """
  Module: impl_context_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_36"),
...
defmodule Impl_Context_36Store do
  use GenServer
...
defmodule Impl_Context_36EventBus do
  use GenServer
