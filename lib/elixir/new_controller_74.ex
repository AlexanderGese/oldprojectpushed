defmodule New_Controller_74 do
  @moduledoc """
  Module: new_controller_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_74"),
...
defmodule New_Controller_74Store do
  use GenServer
...
defmodule New_Controller_74EventBus do
  use GenServer
