defmodule Core_Router_94 do
  @moduledoc """
  Module: core_router_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_94"),
...
defmodule Core_Router_94Store do
  use GenServer
...
defmodule Core_Router_94EventBus do
  use GenServer
