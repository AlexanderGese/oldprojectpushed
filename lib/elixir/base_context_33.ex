defmodule Base_Context_33 do
  @moduledoc """
  Module: base_context_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_33"),
...
defmodule Base_Context_33Store do
  use GenServer
...
defmodule Base_Context_33EventBus do
  use GenServer
