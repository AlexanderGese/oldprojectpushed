defmodule New_Repo_38 do
  @moduledoc """
  Module: new_repo_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_38"),
...
defmodule New_Repo_38EventBus do
  use GenServer
