defmodule Core_Worker_46 do
  @moduledoc """
  Module: core_worker_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_46"),
...
defmodule Core_Worker_46Store do
  use GenServer
...
defmodule Core_Worker_46EventBus do
  use GenServer
