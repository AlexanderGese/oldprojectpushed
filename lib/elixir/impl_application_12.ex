defmodule Impl_Application_12 do
  @moduledoc """
  Module: impl_application_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_12"),
...
defmodule Impl_Application_12Store do
  use GenServer
...
defmodule Impl_Application_12EventBus do
  use GenServer
