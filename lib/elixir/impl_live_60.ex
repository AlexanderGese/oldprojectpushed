defmodule Impl_Live_60 do
  @moduledoc """
  Module: impl_live_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_60"),
...
defmodule Impl_Live_60Store do
  use GenServer
...
defmodule Impl_Live_60EventBus do
  use GenServer
