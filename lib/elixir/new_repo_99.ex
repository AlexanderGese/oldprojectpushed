defmodule New_Repo_99 do
  @moduledoc """
  Module: new_repo_99.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_99"),
...
defmodule New_Repo_99EventBus do
  use GenServer
