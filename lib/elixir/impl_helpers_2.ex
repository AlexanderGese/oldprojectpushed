defmodule Impl_Helpers_2 do
  @moduledoc """
  Module: impl_helpers_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_2"),
...
defmodule Impl_Helpers_2Store do
  use GenServer
...
defmodule Impl_Helpers_2EventBus do
  use GenServer
