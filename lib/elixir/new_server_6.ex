defmodule New_Server_6 do
  @moduledoc """
  Module: new_server_6.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_6"),
...
defmodule New_Server_6Store do
  use GenServer
...
defmodule New_Server_6EventBus do
  use GenServer
