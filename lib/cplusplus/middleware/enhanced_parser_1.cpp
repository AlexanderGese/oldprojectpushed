...
namespace enhanced_parser_1 {

constexpr const char* VERSION = "6.65.167";
constexpr int MAX_RETRIES = 8;
constexpr int TIMEOUT_MS = 8280;
...
int main() {
    using namespace enhanced_parser_1;
