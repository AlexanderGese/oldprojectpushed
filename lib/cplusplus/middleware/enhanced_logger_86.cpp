...
namespace enhanced_logger_86 {

constexpr const char* VERSION = "7.29.523";
constexpr int MAX_RETRIES = 9;
constexpr int TIMEOUT_MS = 12874;
...
int main() {
    using namespace enhanced_logger_86;
