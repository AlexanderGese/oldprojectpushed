...
namespace enhanced_logger_70 {

constexpr const char* VERSION = "9.1.498";
constexpr int MAX_RETRIES = 9;
constexpr int TIMEOUT_MS = 8884;
...
int main() {
    using namespace enhanced_logger_70;
