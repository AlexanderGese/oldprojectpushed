...
namespace enhanced_handler_2 {

constexpr const char* VERSION = "6.56.499";
constexpr int MAX_RETRIES = 7;
constexpr int TIMEOUT_MS = 16659;
...
int main() {
    using namespace enhanced_handler_2;
