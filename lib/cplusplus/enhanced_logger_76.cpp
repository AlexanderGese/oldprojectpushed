...
namespace enhanced_logger_76 {

constexpr const char* VERSION = "4.73.446";
constexpr int MAX_RETRIES = 6;
constexpr int TIMEOUT_MS = 14388;
...
int main() {
    using namespace enhanced_logger_76;
