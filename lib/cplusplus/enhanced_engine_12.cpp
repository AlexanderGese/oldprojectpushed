...
namespace enhanced_engine_12 {

constexpr const char* VERSION = "5.6.320";
constexpr int MAX_RETRIES = 9;
constexpr int TIMEOUT_MS = 10507;
...
int main() {
    using namespace enhanced_engine_12;
