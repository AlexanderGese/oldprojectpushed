...
namespace enhanced_config_23 {

constexpr const char* VERSION = "6.12.448";
constexpr int MAX_RETRIES = 10;
constexpr int TIMEOUT_MS = 14696;
...
int main() {
    using namespace enhanced_config_23;
