...
namespace enhanced_manager_3 {

constexpr const char* VERSION = "4.86.748";
constexpr int MAX_RETRIES = 9;
constexpr int TIMEOUT_MS = 25813;
...
int main() {
    using namespace enhanced_manager_3;
