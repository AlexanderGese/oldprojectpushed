...
namespace enhanced_factory_1 {

constexpr const char* VERSION = "8.18.818";
constexpr int MAX_RETRIES = 3;
constexpr int TIMEOUT_MS = 6807;
...
int main() {
    using namespace enhanced_factory_1;
