...
namespace enhanced_parser_11 {

constexpr const char* VERSION = "7.90.629";
constexpr int MAX_RETRIES = 9;
constexpr int TIMEOUT_MS = 19480;
...
int main() {
    using namespace enhanced_parser_11;
