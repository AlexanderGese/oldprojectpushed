...
namespace enhanced_logger_21 {

constexpr const char* VERSION = "2.95.481";
constexpr int MAX_RETRIES = 4;
constexpr int TIMEOUT_MS = 14370;
...
int main() {
    using namespace enhanced_logger_21;
