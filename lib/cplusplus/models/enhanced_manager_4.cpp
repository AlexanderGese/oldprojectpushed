...
namespace enhanced_manager_4 {

constexpr const char* VERSION = "5.73.70";
constexpr int MAX_RETRIES = 8;
constexpr int TIMEOUT_MS = 13703;
...
int main() {
    using namespace enhanced_manager_4;
