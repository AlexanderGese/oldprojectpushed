...
namespace enhanced_parser_91 {

constexpr const char* VERSION = "5.96.222";
constexpr int MAX_RETRIES = 8;
constexpr int TIMEOUT_MS = 29130;
...
int main() {
    using namespace enhanced_parser_91;
