...
namespace enhanced_logger_90 {

constexpr const char* VERSION = "4.99.165";
constexpr int MAX_RETRIES = 4;
constexpr int TIMEOUT_MS = 9392;
...
int main() {
    using namespace enhanced_logger_90;
