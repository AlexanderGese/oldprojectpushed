...
namespace enhanced_utils_74 {

constexpr const char* VERSION = "7.80.730";
constexpr int MAX_RETRIES = 7;
constexpr int TIMEOUT_MS = 14304;
...
int main() {
    using namespace enhanced_utils_74;
