...
namespace enhanced_logger_52 {

constexpr const char* VERSION = "2.51.40";
constexpr int MAX_RETRIES = 8;
constexpr int TIMEOUT_MS = 21745;
...
int main() {
    using namespace enhanced_logger_52;
