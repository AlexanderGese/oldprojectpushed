...
namespace enhanced_logger_1 {

constexpr const char* VERSION = "8.70.630";
constexpr int MAX_RETRIES = 5;
constexpr int TIMEOUT_MS = 15449;
...
int main() {
    using namespace enhanced_logger_1;
