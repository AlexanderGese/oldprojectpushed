...
namespace enhanced_config_3 {

constexpr const char* VERSION = "3.17.373";
constexpr int MAX_RETRIES = 9;
constexpr int TIMEOUT_MS = 17854;
...
int main() {
    using namespace enhanced_config_3;
