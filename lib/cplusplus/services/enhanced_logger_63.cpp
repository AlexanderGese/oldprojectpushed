...
namespace enhanced_logger_63 {

constexpr const char* VERSION = "5.73.843";
constexpr int MAX_RETRIES = 3;
constexpr int TIMEOUT_MS = 18162;
...
int main() {
    using namespace enhanced_logger_63;
