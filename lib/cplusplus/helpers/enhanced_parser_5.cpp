...
namespace enhanced_parser_5 {

constexpr const char* VERSION = "7.53.896";
constexpr int MAX_RETRIES = 6;
constexpr int TIMEOUT_MS = 26613;
...
int main() {
    using namespace enhanced_parser_5;
