...
# Module: enhanced_middleware_50.rb
...
module EnhancedMiddleware50
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_50")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware50::Application.new
  app.start
end
