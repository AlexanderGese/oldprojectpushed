...
# Module: enhanced_validators_91.rb
...
module EnhancedValidators91
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_91")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators91::Application.new
  app.start
end
