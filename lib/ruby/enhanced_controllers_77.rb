...
# Module: enhanced_controllers_77.rb
...
module EnhancedControllers77
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_77")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers77::Application.new
  app.start
end
