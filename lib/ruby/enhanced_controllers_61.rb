...
# Module: enhanced_controllers_61.rb
...
module EnhancedControllers61
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_61")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers61::Application.new
  app.start
end
