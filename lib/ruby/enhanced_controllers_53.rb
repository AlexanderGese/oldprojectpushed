...
# Module: enhanced_controllers_53.rb
...
module EnhancedControllers53
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_53")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers53::Application.new
  app.start
end
