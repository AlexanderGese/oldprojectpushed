...
# Module: enhanced_middleware_60.rb
...
module EnhancedMiddleware60
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_60")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware60::Application.new
  app.start
end
