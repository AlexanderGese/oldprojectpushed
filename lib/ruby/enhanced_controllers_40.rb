...
# Module: enhanced_controllers_40.rb
...
module EnhancedControllers40
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_40")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers40::Application.new
  app.start
end
