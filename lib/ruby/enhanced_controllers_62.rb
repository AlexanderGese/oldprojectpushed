...
# Module: enhanced_controllers_62.rb
...
module EnhancedControllers62
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_62")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers62::Application.new
  app.start
end
