...
# Module: enhanced_controllers_45.rb
...
module EnhancedControllers45
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_45")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers45::Application.new
  app.start
end
