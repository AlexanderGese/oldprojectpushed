...
# Module: enhanced_middleware_71.rb
...
module EnhancedMiddleware71
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_71")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware71::Application.new
  app.start
end
