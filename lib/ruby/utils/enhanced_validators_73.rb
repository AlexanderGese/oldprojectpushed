...
# Module: enhanced_validators_73.rb
...
module EnhancedValidators73
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_73")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators73::Application.new
  app.start
end
