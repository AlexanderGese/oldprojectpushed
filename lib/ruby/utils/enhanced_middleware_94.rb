...
# Module: enhanced_middleware_94.rb
...
module EnhancedMiddleware94
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_94")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware94::Application.new
  app.start
end
