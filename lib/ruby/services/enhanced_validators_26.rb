...
# Module: enhanced_validators_26.rb
...
module EnhancedValidators26
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_26")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators26::Application.new
  app.start
end
