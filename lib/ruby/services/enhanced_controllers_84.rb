...
# Module: enhanced_controllers_84.rb
...
module EnhancedControllers84
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_84")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers84::Application.new
  app.start
end
