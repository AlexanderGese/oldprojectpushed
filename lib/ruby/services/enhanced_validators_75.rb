...
# Module: enhanced_validators_75.rb
...
module EnhancedValidators75
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_75")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators75::Application.new
  app.start
end
