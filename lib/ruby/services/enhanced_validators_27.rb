...
# Module: enhanced_validators_27.rb
...
module EnhancedValidators27
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_27")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators27::Application.new
  app.start
end
