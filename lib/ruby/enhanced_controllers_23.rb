...
# Module: enhanced_controllers_23.rb
...
module EnhancedControllers23
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_23")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers23::Application.new
  app.start
end
