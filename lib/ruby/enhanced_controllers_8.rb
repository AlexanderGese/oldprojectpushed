...
# Module: enhanced_controllers_8.rb
...
module EnhancedControllers8
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_8")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers8::Application.new
  app.start
end
