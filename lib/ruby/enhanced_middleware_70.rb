...
# Module: enhanced_middleware_70.rb
...
module EnhancedMiddleware70
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_70")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware70::Application.new
  app.start
end
