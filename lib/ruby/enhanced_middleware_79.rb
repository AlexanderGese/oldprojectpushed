...
# Module: enhanced_middleware_79.rb
...
module EnhancedMiddleware79
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_79")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware79::Application.new
  app.start
end
