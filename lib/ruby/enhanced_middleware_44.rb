...
# Module: enhanced_middleware_44.rb
...
module EnhancedMiddleware44
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_44")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware44::Application.new
  app.start
end
