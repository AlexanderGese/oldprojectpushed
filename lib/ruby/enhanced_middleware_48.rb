...
# Module: enhanced_middleware_48.rb
...
module EnhancedMiddleware48
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_48")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware48::Application.new
  app.start
end
