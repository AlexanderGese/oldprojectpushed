...
# Module: enhanced_validators_53.rb
...
module EnhancedValidators53
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_53")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators53::Application.new
  app.start
end
