...
# Module: enhanced_controllers_11.rb
...
module EnhancedControllers11
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_11")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers11::Application.new
  app.start
end
