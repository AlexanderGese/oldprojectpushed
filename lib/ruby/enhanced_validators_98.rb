...
# Module: enhanced_validators_98.rb
...
module EnhancedValidators98
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_98")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators98::Application.new
  app.start
end
