...
# Module: enhanced_controllers_69.rb
...
module EnhancedControllers69
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_69")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers69::Application.new
  app.start
end
