...
# Module: enhanced_validators_34.rb
...
module EnhancedValidators34
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_34")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators34::Application.new
  app.start
end
