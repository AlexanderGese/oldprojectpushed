...
# Module: enhanced_controllers_88.rb
...
module EnhancedControllers88
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_88")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers88::Application.new
  app.start
end
