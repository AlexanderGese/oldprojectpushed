...
# Module: enhanced_middleware_59.rb
...
module EnhancedMiddleware59
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_59")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware59::Application.new
  app.start
end
