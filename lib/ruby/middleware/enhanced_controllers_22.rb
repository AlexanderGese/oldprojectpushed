...
# Module: enhanced_controllers_22.rb
...
module EnhancedControllers22
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_22")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers22::Application.new
  app.start
end
