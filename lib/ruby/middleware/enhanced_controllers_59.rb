...
# Module: enhanced_controllers_59.rb
...
module EnhancedControllers59
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_59")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers59::Application.new
  app.start
end
