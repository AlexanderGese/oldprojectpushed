...
# Module: enhanced_validators_22.rb
...
module EnhancedValidators22
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_22")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators22::Application.new
  app.start
end
