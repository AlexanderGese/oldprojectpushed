...
# Module: enhanced_controllers_92.rb
...
module EnhancedControllers92
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_92")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers92::Application.new
  app.start
end
