...
# Module: enhanced_middleware_99.rb
...
module EnhancedMiddleware99
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_99")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware99::Application.new
  app.start
end
