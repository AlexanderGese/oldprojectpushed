...
# Module: enhanced_middleware_40.rb
...
module EnhancedMiddleware40
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_40")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware40::Application.new
  app.start
end
