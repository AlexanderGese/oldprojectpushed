...
namespace enhanced_logger_8 {

constexpr const char* VERSION = "2.36.427";
constexpr int MAX_RETRIES = 4;
constexpr int TIMEOUT_MS = 10576;
...
int main() {
    using namespace enhanced_logger_8;
