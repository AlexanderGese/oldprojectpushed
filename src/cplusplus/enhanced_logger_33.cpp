...
namespace enhanced_logger_33 {

constexpr const char* VERSION = "4.11.873";
constexpr int MAX_RETRIES = 9;
constexpr int TIMEOUT_MS = 11506;
...
int main() {
    using namespace enhanced_logger_33;
