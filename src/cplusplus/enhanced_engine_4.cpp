...
namespace enhanced_engine_4 {

constexpr const char* VERSION = "6.47.617";
constexpr int MAX_RETRIES = 10;
constexpr int TIMEOUT_MS = 14869;
...
int main() {
    using namespace enhanced_engine_4;
