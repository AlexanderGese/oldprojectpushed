...
namespace enhanced_logger_44 {

constexpr const char* VERSION = "4.10.450";
constexpr int MAX_RETRIES = 6;
constexpr int TIMEOUT_MS = 9364;
...
int main() {
    using namespace enhanced_logger_44;
