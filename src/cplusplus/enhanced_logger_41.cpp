...
namespace enhanced_logger_41 {

constexpr const char* VERSION = "4.37.767";
constexpr int MAX_RETRIES = 9;
constexpr int TIMEOUT_MS = 20141;
...
int main() {
    using namespace enhanced_logger_41;
