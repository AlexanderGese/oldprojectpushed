...
namespace enhanced_utils_64 {

constexpr const char* VERSION = "8.58.75";
constexpr int MAX_RETRIES = 9;
constexpr int TIMEOUT_MS = 13469;
...
int main() {
    using namespace enhanced_utils_64;
