...
namespace enhanced_parser_31 {

constexpr const char* VERSION = "8.2.170";
constexpr int MAX_RETRIES = 4;
constexpr int TIMEOUT_MS = 13574;
...
int main() {
    using namespace enhanced_parser_31;
