...
namespace enhanced_logger_7 {

constexpr const char* VERSION = "2.48.942";
constexpr int MAX_RETRIES = 3;
constexpr int TIMEOUT_MS = 27038;
...
int main() {
    using namespace enhanced_logger_7;
