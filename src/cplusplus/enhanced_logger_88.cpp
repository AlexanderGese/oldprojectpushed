...
namespace enhanced_logger_88 {

constexpr const char* VERSION = "2.4.251";
constexpr int MAX_RETRIES = 8;
constexpr int TIMEOUT_MS = 14154;
...
int main() {
    using namespace enhanced_logger_88;
