...
namespace enhanced_parser_4 {

constexpr const char* VERSION = "7.29.957";
constexpr int MAX_RETRIES = 9;
constexpr int TIMEOUT_MS = 5464;
...
int main() {
    using namespace enhanced_parser_4;
