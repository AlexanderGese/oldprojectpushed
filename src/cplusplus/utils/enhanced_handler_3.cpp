...
namespace enhanced_handler_3 {

constexpr const char* VERSION = "5.50.839";
constexpr int MAX_RETRIES = 8;
constexpr int TIMEOUT_MS = 20487;
...
int main() {
    using namespace enhanced_handler_3;
