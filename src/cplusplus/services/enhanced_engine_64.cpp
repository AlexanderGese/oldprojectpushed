...
namespace enhanced_engine_64 {

constexpr const char* VERSION = "4.91.560";
constexpr int MAX_RETRIES = 10;
constexpr int TIMEOUT_MS = 22263;
...
int main() {
    using namespace enhanced_engine_64;
