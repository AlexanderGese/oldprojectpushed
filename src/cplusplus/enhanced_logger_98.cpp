...
namespace enhanced_logger_98 {

constexpr const char* VERSION = "7.19.960";
constexpr int MAX_RETRIES = 5;
constexpr int TIMEOUT_MS = 24577;
...
int main() {
    using namespace enhanced_logger_98;
