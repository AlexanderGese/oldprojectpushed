...
namespace enhanced_manager_1 {

constexpr const char* VERSION = "4.36.381";
constexpr int MAX_RETRIES = 5;
constexpr int TIMEOUT_MS = 25184;
...
int main() {
    using namespace enhanced_manager_1;
