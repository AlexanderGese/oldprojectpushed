...
namespace enhanced_parser_23 {

constexpr const char* VERSION = "9.89.861";
constexpr int MAX_RETRIES = 6;
constexpr int TIMEOUT_MS = 15336;
...
int main() {
    using namespace enhanced_parser_23;
