defmodule Core_Server_94 do
  @moduledoc """
  Module: core_server_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_94"),
...
defmodule Core_Server_94Store do
  use GenServer
...
defmodule Core_Server_94EventBus do
  use GenServer
