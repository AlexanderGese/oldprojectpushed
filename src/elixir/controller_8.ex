defmodule Controller_8 do
  @moduledoc """
  Module: controller_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_8"),
...
defmodule Controller_8Store do
  use GenServer
...
defmodule Controller_8EventBus do
  use GenServer
