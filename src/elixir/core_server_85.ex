defmodule Core_Server_85 do
  @moduledoc """
  Module: core_server_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_85"),
...
defmodule Core_Server_85Store do
  use GenServer
...
defmodule Core_Server_85EventBus do
  use GenServer
