defmodule Impl_Schema_61 do
  @moduledoc """
  Module: impl_schema_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_61"),
...
defmodule Impl_Schema_61Store do
  use GenServer
...
defmodule Impl_Schema_61EventBus do
  use GenServer
