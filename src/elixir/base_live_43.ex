defmodule Base_Live_43 do
  @moduledoc """
  Module: base_live_43.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_43"),
...
defmodule Base_Live_43Store do
  use GenServer
...
defmodule Base_Live_43EventBus do
  use GenServer
