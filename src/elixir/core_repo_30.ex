defmodule Core_Repo_30 do
  @moduledoc """
  Module: core_repo_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_30"),
...
defmodule Core_Repo_30Store do
  use GenServer
...
defmodule Core_Repo_30EventBus do
  use GenServer
