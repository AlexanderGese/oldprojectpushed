defmodule Impl_Server_15 do
  @moduledoc """
  Module: impl_server_15.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_15"),
...
defmodule Impl_Server_15Store do
  use GenServer
...
defmodule Impl_Server_15EventBus do
  use GenServer
