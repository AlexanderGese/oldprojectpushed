defmodule Base_Repo_60 do
  @moduledoc """
  Module: base_repo_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_60"),
...
defmodule Base_Repo_60Store do
  use GenServer
...
defmodule Base_Repo_60EventBus do
  use GenServer
