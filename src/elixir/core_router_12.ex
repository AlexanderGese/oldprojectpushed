defmodule Core_Router_12 do
  @moduledoc """
  Module: core_router_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_12"),
...
defmodule Core_Router_12Store do
  use GenServer
...
defmodule Core_Router_12EventBus do
  use GenServer
