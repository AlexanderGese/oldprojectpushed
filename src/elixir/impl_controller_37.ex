defmodule Impl_Controller_37 do
  @moduledoc """
  Module: impl_controller_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_controller_37"),
...
defmodule Impl_Controller_37Store do
  use GenServer
...
defmodule Impl_Controller_37EventBus do
  use GenServer
