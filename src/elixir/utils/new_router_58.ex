defmodule New_Router_58 do
  @moduledoc """
  Module: new_router_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_58"),
...
defmodule New_Router_58Store do
  use GenServer
...
defmodule New_Router_58EventBus do
  use GenServer
