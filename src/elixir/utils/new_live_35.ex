defmodule New_Live_35 do
  @moduledoc """
  Module: new_live_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_35"),
...
defmodule New_Live_35EventBus do
  use GenServer
