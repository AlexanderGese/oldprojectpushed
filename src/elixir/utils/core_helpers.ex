defmodule Core_Helpers do
  @moduledoc """
  Module: core_helpers.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers"),
...
defmodule Core_HelpersStore do
  use GenServer
...
defmodule Core_HelpersEventBus do
  use GenServer
