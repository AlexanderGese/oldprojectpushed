defmodule Core_Live_66 do
  @moduledoc """
  Module: core_live_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_66"),
...
defmodule Core_Live_66Store do
  use GenServer
...
defmodule Core_Live_66EventBus do
  use GenServer
