defmodule V2_Schema_14 do
  @moduledoc """
  Module: v2_schema_14.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_14"),
...
defmodule V2_Schema_14Store do
  use GenServer
...
defmodule V2_Schema_14EventBus do
  use GenServer
