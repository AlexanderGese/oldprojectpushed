defmodule Base_Controller_95 do
  @moduledoc """
  Module: base_controller_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_95"),
...
defmodule Base_Controller_95Store do
  use GenServer
...
defmodule Base_Controller_95EventBus do
  use GenServer
