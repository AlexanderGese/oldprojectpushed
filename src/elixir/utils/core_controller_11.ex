defmodule Core_Controller_11 do
  @moduledoc """
  Module: core_controller_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_11"),
...
defmodule Core_Controller_11Store do
  use GenServer
...
defmodule Core_Controller_11EventBus do
  use GenServer
