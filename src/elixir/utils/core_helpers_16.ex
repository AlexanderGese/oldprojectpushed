defmodule Core_Helpers_16 do
  @moduledoc """
  Module: core_helpers_16.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_16"),
...
defmodule Core_Helpers_16Store do
  use GenServer
...
defmodule Core_Helpers_16EventBus do
  use GenServer
