defmodule New_Application_2 do
  @moduledoc """
  Module: new_application_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_2"),
...
defmodule New_Application_2Store do
  use GenServer
...
defmodule New_Application_2EventBus do
  use GenServer
