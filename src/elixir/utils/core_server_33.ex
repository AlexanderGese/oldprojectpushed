defmodule Core_Server_33 do
  @moduledoc """
  Module: core_server_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_33"),
...
defmodule Core_Server_33Store do
  use GenServer
...
defmodule Core_Server_33EventBus do
  use GenServer
