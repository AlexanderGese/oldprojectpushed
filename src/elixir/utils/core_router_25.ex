defmodule Core_Router_25 do
  @moduledoc """
  Module: core_router_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_25"),
...
defmodule Core_Router_25Store do
  use GenServer
...
defmodule Core_Router_25EventBus do
  use GenServer
