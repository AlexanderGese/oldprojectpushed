defmodule New_Context_97 do
  @moduledoc """
  Module: new_context_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_97"),
...
defmodule New_Context_97Store do
  use GenServer
...
defmodule New_Context_97EventBus do
  use GenServer
