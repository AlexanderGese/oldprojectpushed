defmodule New_Worker_80 do
  @moduledoc """
  Module: new_worker_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_80"),
...
defmodule New_Worker_80Store do
  use GenServer
...
defmodule New_Worker_80EventBus do
  use GenServer
