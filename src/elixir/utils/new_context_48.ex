defmodule New_Context_48 do
  @moduledoc """
  Module: new_context_48.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_48"),
...
defmodule New_Context_48Store do
  use GenServer
...
defmodule New_Context_48EventBus do
  use GenServer
