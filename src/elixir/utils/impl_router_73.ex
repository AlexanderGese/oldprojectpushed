defmodule Impl_Router_73 do
  @moduledoc """
  Module: impl_router_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_73"),
...
defmodule Impl_Router_73Store do
  use GenServer
...
defmodule Impl_Router_73EventBus do
  use GenServer
