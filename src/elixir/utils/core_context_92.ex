defmodule Core_Context_92 do
  @moduledoc """
  Module: core_context_92.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_92"),
...
defmodule Core_Context_92Store do
  use GenServer
...
defmodule Core_Context_92EventBus do
  use GenServer
