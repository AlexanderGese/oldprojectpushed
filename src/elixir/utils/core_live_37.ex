defmodule Core_Live_37 do
  @moduledoc """
  Module: core_live_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_37"),
...
defmodule Core_Live_37Store do
  use GenServer
...
defmodule Core_Live_37EventBus do
  use GenServer
