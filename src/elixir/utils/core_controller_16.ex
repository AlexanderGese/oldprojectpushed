defmodule Core_Controller_16 do
  @moduledoc """
  Module: core_controller_16.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_16"),
...
defmodule Core_Controller_16Store do
  use GenServer
...
defmodule Core_Controller_16EventBus do
  use GenServer
