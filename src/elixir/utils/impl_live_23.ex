defmodule Impl_Live_23 do
  @moduledoc """
  Module: impl_live_23.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_23"),
...
defmodule Impl_Live_23Store do
  use GenServer
...
defmodule Impl_Live_23EventBus do
  use GenServer
