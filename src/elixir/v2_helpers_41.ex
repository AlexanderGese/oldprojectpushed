defmodule V2_Helpers_41 do
  @moduledoc """
  Module: v2_helpers_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_41"),
...
defmodule V2_Helpers_41Store do
  use GenServer
...
defmodule V2_Helpers_41EventBus do
  use GenServer
