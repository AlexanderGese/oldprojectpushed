defmodule Impl_Server_28 do
  @moduledoc """
  Module: impl_server_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_28"),
...
defmodule Impl_Server_28Store do
  use GenServer
...
defmodule Impl_Server_28EventBus do
  use GenServer
