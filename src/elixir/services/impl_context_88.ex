defmodule Impl_Context_88 do
  @moduledoc """
  Module: impl_context_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_88"),
...
defmodule Impl_Context_88Store do
  use GenServer
...
defmodule Impl_Context_88EventBus do
  use GenServer
