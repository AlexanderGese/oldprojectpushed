defmodule Core_Context_4 do
  @moduledoc """
  Module: core_context_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_4"),
...
defmodule Core_Context_4Store do
  use GenServer
...
defmodule Core_Context_4EventBus do
  use GenServer
