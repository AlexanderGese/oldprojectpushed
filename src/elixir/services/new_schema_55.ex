defmodule New_Schema_55 do
  @moduledoc """
  Module: new_schema_55.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_55"),
...
defmodule New_Schema_55Store do
  use GenServer
...
defmodule New_Schema_55EventBus do
  use GenServer
