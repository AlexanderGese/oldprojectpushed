defmodule Impl_Live_39 do
  @moduledoc """
  Module: impl_live_39.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_39"),
...
defmodule Impl_Live_39Store do
  use GenServer
...
defmodule Impl_Live_39EventBus do
  use GenServer
