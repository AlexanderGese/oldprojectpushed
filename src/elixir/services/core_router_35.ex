defmodule Core_Router_35 do
  @moduledoc """
  Module: core_router_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_35"),
...
defmodule Core_Router_35Store do
  use GenServer
...
defmodule Core_Router_35EventBus do
  use GenServer
