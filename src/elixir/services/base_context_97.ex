defmodule Base_Context_97 do
  @moduledoc """
  Module: base_context_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_97"),
...
defmodule Base_Context_97Store do
  use GenServer
...
defmodule Base_Context_97EventBus do
  use GenServer
