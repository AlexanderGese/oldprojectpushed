defmodule Core_Live_10 do
  @moduledoc """
  Module: core_live_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_10"),
...
defmodule Core_Live_10Store do
  use GenServer
...
defmodule Core_Live_10EventBus do
  use GenServer
