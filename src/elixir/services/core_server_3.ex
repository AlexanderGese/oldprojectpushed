defmodule Core_Server_3 do
  @moduledoc """
  Module: core_server_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_3"),
...
defmodule Core_Server_3Store do
  use GenServer
...
defmodule Core_Server_3EventBus do
  use GenServer
