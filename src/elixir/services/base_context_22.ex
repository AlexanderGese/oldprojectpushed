defmodule Base_Context_22 do
  @moduledoc """
  Module: base_context_22.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_22"),
...
defmodule Base_Context_22Store do
  use GenServer
...
defmodule Base_Context_22EventBus do
  use GenServer
