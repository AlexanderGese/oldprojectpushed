defmodule Impl_Application_95 do
  @moduledoc """
  Module: impl_application_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_95"),
...
defmodule Impl_Application_95Store do
  use GenServer
...
defmodule Impl_Application_95EventBus do
  use GenServer
