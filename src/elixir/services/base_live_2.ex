defmodule Base_Live_2 do
  @moduledoc """
  Module: base_live_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_2"),
...
defmodule Base_Live_2EventBus do
  use GenServer
