defmodule New_Server_17 do
  @moduledoc """
  Module: new_server_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_17"),
...
defmodule New_Server_17Store do
  use GenServer
...
defmodule New_Server_17EventBus do
  use GenServer
