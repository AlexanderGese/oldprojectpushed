defmodule V2_Worker_99 do
  @moduledoc """
  Module: v2_worker_99.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_worker_99"),
...
defmodule V2_Worker_99Store do
  use GenServer
...
defmodule V2_Worker_99EventBus do
  use GenServer
