defmodule Impl_Live_94 do
  @moduledoc """
  Module: impl_live_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_94"),
...
defmodule Impl_Live_94Store do
  use GenServer
...
defmodule Impl_Live_94EventBus do
  use GenServer
