defmodule Base_Context_23 do
  @moduledoc """
  Module: base_context_23.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_23"),
...
defmodule Base_Context_23Store do
  use GenServer
...
defmodule Base_Context_23EventBus do
  use GenServer
