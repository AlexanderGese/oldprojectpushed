defmodule Base_Server_64 do
  @moduledoc """
  Module: base_server_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_64"),
...
defmodule Base_Server_64Store do
  use GenServer
...
defmodule Base_Server_64EventBus do
  use GenServer
