defmodule Impl_Schema_71 do
  @moduledoc """
  Module: impl_schema_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_71"),
...
defmodule Impl_Schema_71Store do
  use GenServer
...
defmodule Impl_Schema_71EventBus do
  use GenServer
