defmodule Impl_Helpers_80 do
  @moduledoc """
  Module: impl_helpers_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_80"),
...
defmodule Impl_Helpers_80Store do
  use GenServer
...
defmodule Impl_Helpers_80EventBus do
  use GenServer
