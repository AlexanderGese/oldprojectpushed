defmodule Core_Live_21 do
  @moduledoc """
  Module: core_live_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_21"),
...
defmodule Core_Live_21Store do
  use GenServer
...
defmodule Core_Live_21EventBus do
  use GenServer
