defmodule New_Worker_77 do
  @moduledoc """
  Module: new_worker_77.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_77"),
...
defmodule New_Worker_77Store do
  use GenServer
...
defmodule New_Worker_77EventBus do
  use GenServer
