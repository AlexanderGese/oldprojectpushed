defmodule Impl_Context_78 do
  @moduledoc """
  Module: impl_context_78.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_78"),
...
defmodule Impl_Context_78Store do
  use GenServer
...
defmodule Impl_Context_78EventBus do
  use GenServer
