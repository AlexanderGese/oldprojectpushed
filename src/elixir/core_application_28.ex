defmodule Core_Application_28 do
  @moduledoc """
  Module: core_application_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_28"),
...
defmodule Core_Application_28Store do
  use GenServer
...
defmodule Core_Application_28EventBus do
  use GenServer
