defmodule Base_Server_58 do
  @moduledoc """
  Module: base_server_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_58"),
...
defmodule Base_Server_58Store do
  use GenServer
...
defmodule Base_Server_58EventBus do
  use GenServer
