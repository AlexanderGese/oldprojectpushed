defmodule New_Helpers_94 do
  @moduledoc """
  Module: new_helpers_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_94"),
...
defmodule New_Helpers_94Store do
  use GenServer
...
defmodule New_Helpers_94EventBus do
  use GenServer
