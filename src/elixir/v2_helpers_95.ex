defmodule V2_Helpers_95 do
  @moduledoc """
  Module: v2_helpers_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_95"),
...
defmodule V2_Helpers_95Store do
  use GenServer
...
defmodule V2_Helpers_95EventBus do
  use GenServer
