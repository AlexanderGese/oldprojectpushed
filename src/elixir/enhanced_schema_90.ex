defmodule Enhanced_Schema_90 do
  @moduledoc """
  Module: enhanced_schema_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_schema_90"),
...
defmodule Enhanced_Schema_90Store do
  use GenServer
...
defmodule Enhanced_Schema_90EventBus do
  use GenServer
