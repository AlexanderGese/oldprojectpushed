defmodule Impl_Router_5 do
  @moduledoc """
  Module: impl_router_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_5"),
...
defmodule Impl_Router_5Store do
  use GenServer
...
defmodule Impl_Router_5EventBus do
  use GenServer
