defmodule Core_Repo_63 do
  @moduledoc """
  Module: core_repo_63.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_63"),
...
defmodule Core_Repo_63Store do
  use GenServer
...
defmodule Core_Repo_63EventBus do
  use GenServer
