defmodule Core_Schema_50 do
  @moduledoc """
  Module: core_schema_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_50"),
...
defmodule Core_Schema_50Store do
  use GenServer
...
defmodule Core_Schema_50EventBus do
  use GenServer
