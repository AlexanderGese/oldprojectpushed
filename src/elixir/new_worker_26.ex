defmodule New_Worker_26 do
  @moduledoc """
  Module: new_worker_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_26"),
...
defmodule New_Worker_26Store do
  use GenServer
...
defmodule New_Worker_26EventBus do
  use GenServer
