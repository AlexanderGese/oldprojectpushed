defmodule V2_Context_99 do
  @moduledoc """
  Module: v2_context_99.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_99"),
...
defmodule V2_Context_99Store do
  use GenServer
...
defmodule V2_Context_99EventBus do
  use GenServer
