defmodule New_Helpers_56 do
  @moduledoc """
  Module: new_helpers_56.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_56"),
...
defmodule New_Helpers_56Store do
  use GenServer
...
defmodule New_Helpers_56EventBus do
  use GenServer
