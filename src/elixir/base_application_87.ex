defmodule Base_Application_87 do
  @moduledoc """
  Module: base_application_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_87"),
...
defmodule Base_Application_87Store do
  use GenServer
...
defmodule Base_Application_87EventBus do
  use GenServer
