defmodule New_Context_69 do
  @moduledoc """
  Module: new_context_69.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_69"),
...
defmodule New_Context_69Store do
  use GenServer
...
defmodule New_Context_69EventBus do
  use GenServer
