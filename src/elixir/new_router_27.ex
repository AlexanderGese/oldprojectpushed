defmodule New_Router_27 do
  @moduledoc """
  Module: new_router_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_27"),
...
defmodule New_Router_27Store do
  use GenServer
...
defmodule New_Router_27EventBus do
  use GenServer
