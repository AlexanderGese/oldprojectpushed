defmodule New_Server_66 do
  @moduledoc """
  Module: new_server_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_66"),
...
defmodule New_Server_66Store do
  use GenServer
...
defmodule New_Server_66EventBus do
  use GenServer
