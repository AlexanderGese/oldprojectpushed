defmodule New_Context_49 do
  @moduledoc """
  Module: new_context_49.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_49"),
...
defmodule New_Context_49Store do
  use GenServer
...
defmodule New_Context_49EventBus do
  use GenServer
