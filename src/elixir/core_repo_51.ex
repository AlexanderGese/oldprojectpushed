defmodule Core_Repo_51 do
  @moduledoc """
  Module: core_repo_51.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_51"),
...
defmodule Core_Repo_51Store do
  use GenServer
...
defmodule Core_Repo_51EventBus do
  use GenServer
