defmodule Base_Context_47 do
  @moduledoc """
  Module: base_context_47.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_47"),
...
defmodule Base_Context_47Store do
  use GenServer
...
defmodule Base_Context_47EventBus do
  use GenServer
