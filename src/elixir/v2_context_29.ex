defmodule V2_Context_29 do
  @moduledoc """
  Module: v2_context_29.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_29"),
...
defmodule V2_Context_29Store do
  use GenServer
...
defmodule V2_Context_29EventBus do
  use GenServer
