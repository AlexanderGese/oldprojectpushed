defmodule V2_Server_4 do
  @moduledoc """
  Module: v2_server_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_4"),
...
defmodule V2_Server_4EventBus do
  use GenServer
