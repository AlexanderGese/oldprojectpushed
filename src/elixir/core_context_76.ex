defmodule Core_Context_76 do
  @moduledoc """
  Module: core_context_76.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_76"),
...
defmodule Core_Context_76Store do
  use GenServer
...
defmodule Core_Context_76EventBus do
  use GenServer
