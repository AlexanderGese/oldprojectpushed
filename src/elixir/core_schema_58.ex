defmodule Core_Schema_58 do
  @moduledoc """
  Module: core_schema_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_58"),
...
defmodule Core_Schema_58Store do
  use GenServer
...
defmodule Core_Schema_58EventBus do
  use GenServer
