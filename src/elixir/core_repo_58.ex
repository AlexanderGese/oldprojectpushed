defmodule Core_Repo_58 do
  @moduledoc """
  Module: core_repo_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_58"),
...
defmodule Core_Repo_58Store do
  use GenServer
...
defmodule Core_Repo_58EventBus do
  use GenServer
