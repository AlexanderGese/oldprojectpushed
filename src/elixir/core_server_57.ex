defmodule Core_Server_57 do
  @moduledoc """
  Module: core_server_57.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_57"),
...
defmodule Core_Server_57Store do
  use GenServer
...
defmodule Core_Server_57EventBus do
  use GenServer
