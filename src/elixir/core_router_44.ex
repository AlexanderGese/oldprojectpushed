defmodule Core_Router_44 do
  @moduledoc """
  Module: core_router_44.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_44"),
...
defmodule Core_Router_44Store do
  use GenServer
...
defmodule Core_Router_44EventBus do
  use GenServer
