defmodule V2_Context_2 do
  @moduledoc """
  Module: v2_context_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_2"),
...
defmodule V2_Context_2Store do
  use GenServer
...
defmodule V2_Context_2EventBus do
  use GenServer
