defmodule V2_Context_58 do
  @moduledoc """
  Module: v2_context_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_58"),
...
defmodule V2_Context_58Store do
  use GenServer
...
defmodule V2_Context_58EventBus do
  use GenServer
