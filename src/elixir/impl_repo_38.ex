defmodule Impl_Repo_38 do
  @moduledoc """
  Module: impl_repo_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_38"),
...
defmodule Impl_Repo_38Store do
  use GenServer
...
defmodule Impl_Repo_38EventBus do
  use GenServer
