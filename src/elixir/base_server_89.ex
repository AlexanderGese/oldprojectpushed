defmodule Base_Server_89 do
  @moduledoc """
  Module: base_server_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_89"),
...
defmodule Base_Server_89Store do
  use GenServer
...
defmodule Base_Server_89EventBus do
  use GenServer
