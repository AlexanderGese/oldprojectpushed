defmodule New_Worker_5 do
  @moduledoc """
  Module: new_worker_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_5"),
...
defmodule New_Worker_5Store do
  use GenServer
...
defmodule New_Worker_5EventBus do
  use GenServer
