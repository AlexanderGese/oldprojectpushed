defmodule Base_Schema_85 do
  @moduledoc """
  Module: base_schema_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_85"),
...
defmodule Base_Schema_85Store do
  use GenServer
...
defmodule Base_Schema_85EventBus do
  use GenServer
