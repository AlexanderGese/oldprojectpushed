defmodule V2_Server_97 do
  @moduledoc """
  Module: v2_server_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_97"),
...
defmodule V2_Server_97Store do
  use GenServer
...
defmodule V2_Server_97EventBus do
  use GenServer
