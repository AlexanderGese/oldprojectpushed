defmodule Core_Helpers_38 do
  @moduledoc """
  Module: core_helpers_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_38"),
...
defmodule Core_Helpers_38Store do
  use GenServer
...
defmodule Core_Helpers_38EventBus do
  use GenServer
