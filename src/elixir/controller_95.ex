defmodule Controller_95 do
  @moduledoc """
  Module: controller_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_95"),
...
defmodule Controller_95Store do
  use GenServer
...
defmodule Controller_95EventBus do
  use GenServer
