defmodule Core_Worker_28 do
  @moduledoc """
  Module: core_worker_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_28"),
...
defmodule Core_Worker_28Store do
  use GenServer
...
defmodule Core_Worker_28EventBus do
  use GenServer
