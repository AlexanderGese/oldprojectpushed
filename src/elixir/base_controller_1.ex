defmodule Base_Controller_1 do
  @moduledoc """
  Module: base_controller_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_1"),
...
defmodule Base_Controller_1Store do
  use GenServer
...
defmodule Base_Controller_1EventBus do
  use GenServer
