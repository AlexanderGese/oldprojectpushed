defmodule Core_Context_23 do
  @moduledoc """
  Module: core_context_23.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_23"),
...
defmodule Core_Context_23Store do
  use GenServer
...
defmodule Core_Context_23EventBus do
  use GenServer
