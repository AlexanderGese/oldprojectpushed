defmodule Core_Context_8 do
  @moduledoc """
  Module: core_context_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_8"),
...
defmodule Core_Context_8Store do
  use GenServer
...
defmodule Core_Context_8EventBus do
  use GenServer
