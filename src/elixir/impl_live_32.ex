defmodule Impl_Live_32 do
  @moduledoc """
  Module: impl_live_32.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_32"),
...
defmodule Impl_Live_32Store do
  use GenServer
...
defmodule Impl_Live_32EventBus do
  use GenServer
