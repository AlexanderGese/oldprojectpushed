defmodule Core_Controller_41 do
  @moduledoc """
  Module: core_controller_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_41"),
...
defmodule Core_Controller_41Store do
  use GenServer
...
defmodule Core_Controller_41EventBus do
  use GenServer
