defmodule Impl_Live_3 do
  @moduledoc """
  Module: impl_live_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_3"),
...
defmodule Impl_Live_3EventBus do
  use GenServer
