defmodule Base_Repo_73 do
  @moduledoc """
  Module: base_repo_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_73"),
...
defmodule Base_Repo_73Store do
  use GenServer
...
defmodule Base_Repo_73EventBus do
  use GenServer
