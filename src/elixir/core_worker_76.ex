defmodule Core_Worker_76 do
  @moduledoc """
  Module: core_worker_76.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_76"),
...
defmodule Core_Worker_76Store do
  use GenServer
...
defmodule Core_Worker_76EventBus do
  use GenServer
