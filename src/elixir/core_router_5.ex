defmodule Core_Router_5 do
  @moduledoc """
  Module: core_router_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_5"),
...
defmodule Core_Router_5Store do
  use GenServer
...
defmodule Core_Router_5EventBus do
  use GenServer
