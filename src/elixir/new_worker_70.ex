defmodule New_Worker_70 do
  @moduledoc """
  Module: new_worker_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_70"),
...
defmodule New_Worker_70Store do
  use GenServer
...
defmodule New_Worker_70EventBus do
  use GenServer
