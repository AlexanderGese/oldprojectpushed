defmodule Impl_Live_97 do
  @moduledoc """
  Module: impl_live_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_97"),
...
defmodule Impl_Live_97Store do
  use GenServer
...
defmodule Impl_Live_97EventBus do
  use GenServer
