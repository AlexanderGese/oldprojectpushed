defmodule Impl_Server_3 do
  @moduledoc """
  Module: impl_server_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_3"),
...
defmodule Impl_Server_3Store do
  use GenServer
...
defmodule Impl_Server_3EventBus do
  use GenServer
