defmodule Core_Helpers_26 do
  @moduledoc """
  Module: core_helpers_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_26"),
...
defmodule Core_Helpers_26Store do
  use GenServer
...
defmodule Core_Helpers_26EventBus do
  use GenServer
