defmodule Core_Context_74 do
  @moduledoc """
  Module: core_context_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_74"),
...
defmodule Core_Context_74Store do
  use GenServer
...
defmodule Core_Context_74EventBus do
  use GenServer
