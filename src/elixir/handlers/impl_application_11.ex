defmodule Impl_Application_11 do
  @moduledoc """
  Module: impl_application_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_11"),
...
defmodule Impl_Application_11Store do
  use GenServer
...
defmodule Impl_Application_11EventBus do
  use GenServer
