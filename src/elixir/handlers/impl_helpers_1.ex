defmodule Impl_Helpers_1 do
  @moduledoc """
  Module: impl_helpers_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_1"),
...
defmodule Impl_Helpers_1Store do
  use GenServer
...
defmodule Impl_Helpers_1EventBus do
  use GenServer
