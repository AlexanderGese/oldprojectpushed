defmodule Base_Context_3 do
  @moduledoc """
  Module: base_context_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_3"),
...
defmodule Base_Context_3Store do
  use GenServer
...
defmodule Base_Context_3EventBus do
  use GenServer
