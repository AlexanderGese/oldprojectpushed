defmodule New_Controller_17 do
  @moduledoc """
  Module: new_controller_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_17"),
...
defmodule New_Controller_17Store do
  use GenServer
...
defmodule New_Controller_17EventBus do
  use GenServer
