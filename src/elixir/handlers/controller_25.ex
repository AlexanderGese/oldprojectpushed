defmodule Controller_25 do
  @moduledoc """
  Module: controller_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_25"),
...
defmodule Controller_25Store do
  use GenServer
...
defmodule Controller_25EventBus do
  use GenServer
