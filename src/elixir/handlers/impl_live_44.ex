defmodule Impl_Live_44 do
  @moduledoc """
  Module: impl_live_44.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_44"),
...
defmodule Impl_Live_44Store do
  use GenServer
...
defmodule Impl_Live_44EventBus do
  use GenServer
