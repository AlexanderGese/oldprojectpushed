defmodule V2_Server_50 do
  @moduledoc """
  Module: v2_server_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_50"),
...
defmodule V2_Server_50Store do
  use GenServer
...
defmodule V2_Server_50EventBus do
  use GenServer
