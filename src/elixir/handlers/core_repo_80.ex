defmodule Core_Repo_80 do
  @moduledoc """
  Module: core_repo_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_80"),
...
defmodule Core_Repo_80Store do
  use GenServer
...
defmodule Core_Repo_80EventBus do
  use GenServer
