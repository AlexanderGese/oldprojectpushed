defmodule Core_Worker_40 do
  @moduledoc """
  Module: core_worker_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_40"),
...
defmodule Core_Worker_40Store do
  use GenServer
...
defmodule Core_Worker_40EventBus do
  use GenServer
