defmodule Core_Context_85 do
  @moduledoc """
  Module: core_context_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_85"),
...
defmodule Core_Context_85Store do
  use GenServer
...
defmodule Core_Context_85EventBus do
  use GenServer
