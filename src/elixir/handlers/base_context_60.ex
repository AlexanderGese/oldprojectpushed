defmodule Base_Context_60 do
  @moduledoc """
  Module: base_context_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_60"),
...
defmodule Base_Context_60Store do
  use GenServer
...
defmodule Base_Context_60EventBus do
  use GenServer
