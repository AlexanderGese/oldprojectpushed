defmodule V2_Context_22 do
  @moduledoc """
  Module: v2_context_22.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_22"),
...
defmodule V2_Context_22Store do
  use GenServer
...
defmodule V2_Context_22EventBus do
  use GenServer
