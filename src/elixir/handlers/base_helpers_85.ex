defmodule Base_Helpers_85 do
  @moduledoc """
  Module: base_helpers_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_85"),
...
defmodule Base_Helpers_85Store do
  use GenServer
...
defmodule Base_Helpers_85EventBus do
  use GenServer
