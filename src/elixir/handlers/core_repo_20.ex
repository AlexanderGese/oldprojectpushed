defmodule Core_Repo_20 do
  @moduledoc """
  Module: core_repo_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_20"),
...
defmodule Core_Repo_20Store do
  use GenServer
...
defmodule Core_Repo_20EventBus do
  use GenServer
