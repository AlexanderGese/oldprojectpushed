defmodule Base_Live_10 do
  @moduledoc """
  Module: base_live_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_10"),
...
defmodule Base_Live_10Store do
  use GenServer
...
defmodule Base_Live_10EventBus do
  use GenServer
