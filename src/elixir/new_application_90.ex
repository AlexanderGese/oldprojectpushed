defmodule New_Application_90 do
  @moduledoc """
  Module: new_application_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_90"),
...
defmodule New_Application_90Store do
  use GenServer
...
defmodule New_Application_90EventBus do
  use GenServer
