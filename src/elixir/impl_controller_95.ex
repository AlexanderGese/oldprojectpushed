defmodule Impl_Controller_95 do
  @moduledoc """
  Module: impl_controller_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_controller_95"),
...
defmodule Impl_Controller_95Store do
  use GenServer
...
defmodule Impl_Controller_95EventBus do
  use GenServer
