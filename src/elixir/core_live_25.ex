defmodule Core_Live_25 do
  @moduledoc """
  Module: core_live_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_25"),
...
defmodule Core_Live_25Store do
  use GenServer
...
defmodule Core_Live_25EventBus do
  use GenServer
