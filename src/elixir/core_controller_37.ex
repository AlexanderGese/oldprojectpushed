defmodule Core_Controller_37 do
  @moduledoc """
  Module: core_controller_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_37"),
...
defmodule Core_Controller_37Store do
  use GenServer
...
defmodule Core_Controller_37EventBus do
  use GenServer
