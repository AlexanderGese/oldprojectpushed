defmodule Base_Server_99 do
  @moduledoc """
  Module: base_server_99.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_99"),
...
defmodule Base_Server_99Store do
  use GenServer
...
defmodule Base_Server_99EventBus do
  use GenServer
