defmodule Core_Controller_87 do
  @moduledoc """
  Module: core_controller_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_87"),
...
defmodule Core_Controller_87Store do
  use GenServer
...
defmodule Core_Controller_87EventBus do
  use GenServer
