defmodule New_Controller_93 do
  @moduledoc """
  Module: new_controller_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_93"),
...
defmodule New_Controller_93Store do
  use GenServer
...
defmodule New_Controller_93EventBus do
  use GenServer
