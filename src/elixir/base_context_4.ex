defmodule Base_Context_4 do
  @moduledoc """
  Module: base_context_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_4"),
...
defmodule Base_Context_4Store do
  use GenServer
...
defmodule Base_Context_4EventBus do
  use GenServer
