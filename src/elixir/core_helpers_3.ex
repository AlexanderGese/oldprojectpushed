defmodule Core_Helpers_3 do
  @moduledoc """
  Module: core_helpers_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_3"),
...
defmodule Core_Helpers_3Store do
  use GenServer
...
defmodule Core_Helpers_3EventBus do
  use GenServer
