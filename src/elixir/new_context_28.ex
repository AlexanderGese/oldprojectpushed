defmodule New_Context_28 do
  @moduledoc """
  Module: new_context_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_28"),
...
defmodule New_Context_28Store do
  use GenServer
...
defmodule New_Context_28EventBus do
  use GenServer
