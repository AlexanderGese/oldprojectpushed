defmodule Core_Live_1 do
  @moduledoc """
  Module: core_live_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_1"),
...
defmodule Core_Live_1EventBus do
  use GenServer
