defmodule Base_Context_42 do
  @moduledoc """
  Module: base_context_42.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_42"),
...
defmodule Base_Context_42Store do
  use GenServer
...
defmodule Base_Context_42EventBus do
  use GenServer
