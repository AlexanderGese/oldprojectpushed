defmodule New_Application_70 do
  @moduledoc """
  Module: new_application_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_70"),
...
defmodule New_Application_70Store do
  use GenServer
...
defmodule New_Application_70EventBus do
  use GenServer
