defmodule Base_Router_13 do
  @moduledoc """
  Module: base_router_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_13"),
...
defmodule Base_Router_13Store do
  use GenServer
...
defmodule Base_Router_13EventBus do
  use GenServer
