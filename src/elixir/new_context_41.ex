defmodule New_Context_41 do
  @moduledoc """
  Module: new_context_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_41"),
...
defmodule New_Context_41Store do
  use GenServer
...
defmodule New_Context_41EventBus do
  use GenServer
