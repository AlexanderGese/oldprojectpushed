defmodule Core_Application_46 do
  @moduledoc """
  Module: core_application_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_46"),
...
defmodule Core_Application_46Store do
  use GenServer
...
defmodule Core_Application_46EventBus do
  use GenServer
