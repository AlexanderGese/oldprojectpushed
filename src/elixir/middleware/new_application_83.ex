defmodule New_Application_83 do
  @moduledoc """
  Module: new_application_83.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_83"),
...
defmodule New_Application_83Store do
  use GenServer
...
defmodule New_Application_83EventBus do
  use GenServer
