defmodule Core_Live_3 do
  @moduledoc """
  Module: core_live_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_3"),
...
defmodule Core_Live_3EventBus do
  use GenServer
