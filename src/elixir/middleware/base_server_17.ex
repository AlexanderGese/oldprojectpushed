defmodule Base_Server_17 do
  @moduledoc """
  Module: base_server_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_17"),
...
defmodule Base_Server_17Store do
  use GenServer
...
defmodule Base_Server_17EventBus do
  use GenServer
