defmodule Impl_Schema_25 do
  @moduledoc """
  Module: impl_schema_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_25"),
...
defmodule Impl_Schema_25Store do
  use GenServer
...
defmodule Impl_Schema_25EventBus do
  use GenServer
