defmodule New_Router_25 do
  @moduledoc """
  Module: new_router_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_25"),
...
defmodule New_Router_25Store do
  use GenServer
...
defmodule New_Router_25EventBus do
  use GenServer
