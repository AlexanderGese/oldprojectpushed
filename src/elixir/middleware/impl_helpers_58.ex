defmodule Impl_Helpers_58 do
  @moduledoc """
  Module: impl_helpers_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_58"),
...
defmodule Impl_Helpers_58Store do
  use GenServer
...
defmodule Impl_Helpers_58EventBus do
  use GenServer
