defmodule Core_Repo_99 do
  @moduledoc """
  Module: core_repo_99.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_99"),
...
defmodule Core_Repo_99Store do
  use GenServer
...
defmodule Core_Repo_99EventBus do
  use GenServer
