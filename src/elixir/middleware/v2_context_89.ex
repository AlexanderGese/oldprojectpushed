defmodule V2_Context_89 do
  @moduledoc """
  Module: v2_context_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_89"),
...
defmodule V2_Context_89Store do
  use GenServer
...
defmodule V2_Context_89EventBus do
  use GenServer
