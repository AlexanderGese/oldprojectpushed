defmodule New_Controller_98 do
  @moduledoc """
  Module: new_controller_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_98"),
...
defmodule New_Controller_98Store do
  use GenServer
...
defmodule New_Controller_98EventBus do
  use GenServer
