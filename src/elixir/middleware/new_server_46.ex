defmodule New_Server_46 do
  @moduledoc """
  Module: new_server_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_46"),
...
defmodule New_Server_46Store do
  use GenServer
...
defmodule New_Server_46EventBus do
  use GenServer
