defmodule Base_Server_32 do
  @moduledoc """
  Module: base_server_32.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_32"),
...
defmodule Base_Server_32Store do
  use GenServer
...
defmodule Base_Server_32EventBus do
  use GenServer
