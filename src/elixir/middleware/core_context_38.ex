defmodule Core_Context_38 do
  @moduledoc """
  Module: core_context_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_38"),
...
defmodule Core_Context_38Store do
  use GenServer
...
defmodule Core_Context_38EventBus do
  use GenServer
