defmodule Enhanced_Live_13 do
  @moduledoc """
  Module: enhanced_live_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_live_13"),
...
defmodule Enhanced_Live_13Store do
  use GenServer
...
defmodule Enhanced_Live_13EventBus do
  use GenServer
