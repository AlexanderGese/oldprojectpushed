defmodule V2_Controller_20 do
  @moduledoc """
  Module: v2_controller_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_controller_20"),
...
defmodule V2_Controller_20Store do
  use GenServer
...
defmodule V2_Controller_20EventBus do
  use GenServer
