defmodule Core_Router_28 do
  @moduledoc """
  Module: core_router_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_28"),
...
defmodule Core_Router_28Store do
  use GenServer
...
defmodule Core_Router_28EventBus do
  use GenServer
