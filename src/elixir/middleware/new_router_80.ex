defmodule New_Router_80 do
  @moduledoc """
  Module: new_router_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_80"),
...
defmodule New_Router_80Store do
  use GenServer
...
defmodule New_Router_80EventBus do
  use GenServer
