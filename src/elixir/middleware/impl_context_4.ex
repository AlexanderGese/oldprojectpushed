defmodule Impl_Context_4 do
  @moduledoc """
  Module: impl_context_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_4"),
...
defmodule Impl_Context_4Store do
  use GenServer
...
defmodule Impl_Context_4EventBus do
  use GenServer
