defmodule New_Schema_40 do
  @moduledoc """
  Module: new_schema_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_40"),
...
defmodule New_Schema_40Store do
  use GenServer
...
defmodule New_Schema_40EventBus do
  use GenServer
