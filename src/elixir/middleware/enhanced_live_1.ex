defmodule Enhanced_Live_1 do
  @moduledoc """
  Module: enhanced_live_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_live_1"),
...
defmodule Enhanced_Live_1Store do
  use GenServer
...
defmodule Enhanced_Live_1EventBus do
  use GenServer
