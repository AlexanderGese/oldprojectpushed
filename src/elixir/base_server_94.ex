defmodule Base_Server_94 do
  @moduledoc """
  Module: base_server_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_94"),
...
defmodule Base_Server_94Store do
  use GenServer
...
defmodule Base_Server_94EventBus do
  use GenServer
