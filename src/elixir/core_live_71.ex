defmodule Core_Live_71 do
  @moduledoc """
  Module: core_live_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_71"),
...
defmodule Core_Live_71Store do
  use GenServer
...
defmodule Core_Live_71EventBus do
  use GenServer
