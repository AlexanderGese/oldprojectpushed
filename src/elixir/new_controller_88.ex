defmodule New_Controller_88 do
  @moduledoc """
  Module: new_controller_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_88"),
...
defmodule New_Controller_88Store do
  use GenServer
...
defmodule New_Controller_88EventBus do
  use GenServer
