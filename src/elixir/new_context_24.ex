defmodule New_Context_24 do
  @moduledoc """
  Module: new_context_24.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_24"),
...
defmodule New_Context_24Store do
  use GenServer
...
defmodule New_Context_24EventBus do
  use GenServer
