defmodule New_Router_40 do
  @moduledoc """
  Module: new_router_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_40"),
...
defmodule New_Router_40Store do
  use GenServer
...
defmodule New_Router_40EventBus do
  use GenServer
