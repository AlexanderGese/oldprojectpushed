defmodule Core_Schema_31 do
  @moduledoc """
  Module: core_schema_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_31"),
...
defmodule Core_Schema_31Store do
  use GenServer
...
defmodule Core_Schema_31EventBus do
  use GenServer
