defmodule New_Helpers_85 do
  @moduledoc """
  Module: new_helpers_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_85"),
...
defmodule New_Helpers_85Store do
  use GenServer
...
defmodule New_Helpers_85EventBus do
  use GenServer
