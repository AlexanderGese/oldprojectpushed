defmodule New_Schema_63 do
  @moduledoc """
  Module: new_schema_63.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_63"),
...
defmodule New_Schema_63Store do
  use GenServer
...
defmodule New_Schema_63EventBus do
  use GenServer
