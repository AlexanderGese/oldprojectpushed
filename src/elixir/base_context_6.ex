defmodule Base_Context_6 do
  @moduledoc """
  Module: base_context_6.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_6"),
...
defmodule Base_Context_6Store do
  use GenServer
...
defmodule Base_Context_6EventBus do
  use GenServer
