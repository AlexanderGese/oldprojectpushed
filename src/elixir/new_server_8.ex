defmodule New_Server_8 do
  @moduledoc """
  Module: new_server_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_8"),
...
defmodule New_Server_8Store do
  use GenServer
...
defmodule New_Server_8EventBus do
  use GenServer
