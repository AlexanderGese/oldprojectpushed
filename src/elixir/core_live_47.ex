defmodule Core_Live_47 do
  @moduledoc """
  Module: core_live_47.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_47"),
...
defmodule Core_Live_47Store do
  use GenServer
...
defmodule Core_Live_47EventBus do
  use GenServer
