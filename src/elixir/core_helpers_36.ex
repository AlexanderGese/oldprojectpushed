defmodule Core_Helpers_36 do
  @moduledoc """
  Module: core_helpers_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_36"),
...
defmodule Core_Helpers_36Store do
  use GenServer
...
defmodule Core_Helpers_36EventBus do
  use GenServer
