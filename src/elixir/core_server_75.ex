defmodule Core_Server_75 do
  @moduledoc """
  Module: core_server_75.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_75"),
...
defmodule Core_Server_75Store do
  use GenServer
...
defmodule Core_Server_75EventBus do
  use GenServer
