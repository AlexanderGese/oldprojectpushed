defmodule New_Server_84 do
  @moduledoc """
  Module: new_server_84.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_84"),
...
defmodule New_Server_84Store do
  use GenServer
...
defmodule New_Server_84EventBus do
  use GenServer
