defmodule Impl_Context_33 do
  @moduledoc """
  Module: impl_context_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_33"),
...
defmodule Impl_Context_33Store do
  use GenServer
...
defmodule Impl_Context_33EventBus do
  use GenServer
