defmodule Base_Live_34 do
  @moduledoc """
  Module: base_live_34.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_34"),
...
defmodule Base_Live_34Store do
  use GenServer
...
defmodule Base_Live_34EventBus do
  use GenServer
