defmodule V2_Helpers_65 do
  @moduledoc """
  Module: v2_helpers_65.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_65"),
...
defmodule V2_Helpers_65Store do
  use GenServer
...
defmodule V2_Helpers_65EventBus do
  use GenServer
