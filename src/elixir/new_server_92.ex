defmodule New_Server_92 do
  @moduledoc """
  Module: new_server_92.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_92"),
...
defmodule New_Server_92Store do
  use GenServer
...
defmodule New_Server_92EventBus do
  use GenServer
