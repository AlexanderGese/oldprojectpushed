defmodule Base_Server_28 do
  @moduledoc """
  Module: base_server_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_28"),
...
defmodule Base_Server_28Store do
  use GenServer
...
defmodule Base_Server_28EventBus do
  use GenServer
