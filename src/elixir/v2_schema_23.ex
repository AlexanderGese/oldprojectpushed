defmodule V2_Schema_23 do
  @moduledoc """
  Module: v2_schema_23.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_23"),
...
defmodule V2_Schema_23Store do
  use GenServer
...
defmodule V2_Schema_23EventBus do
  use GenServer
