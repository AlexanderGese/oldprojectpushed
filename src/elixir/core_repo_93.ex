defmodule Core_Repo_93 do
  @moduledoc """
  Module: core_repo_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_93"),
...
defmodule Core_Repo_93Store do
  use GenServer
...
defmodule Core_Repo_93EventBus do
  use GenServer
