defmodule Impl_Server_90 do
  @moduledoc """
  Module: impl_server_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_90"),
...
defmodule Impl_Server_90Store do
  use GenServer
...
defmodule Impl_Server_90EventBus do
  use GenServer
