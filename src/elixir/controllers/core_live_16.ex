defmodule Core_Live_16 do
  @moduledoc """
  Module: core_live_16.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_16"),
...
defmodule Core_Live_16Store do
  use GenServer
...
defmodule Core_Live_16EventBus do
  use GenServer
