defmodule New_Router_69 do
  @moduledoc """
  Module: new_router_69.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_69"),
...
defmodule New_Router_69Store do
  use GenServer
...
defmodule New_Router_69EventBus do
  use GenServer
