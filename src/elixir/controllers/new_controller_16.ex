defmodule New_Controller_16 do
  @moduledoc """
  Module: new_controller_16.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_16"),
...
defmodule New_Controller_16Store do
  use GenServer
...
defmodule New_Controller_16EventBus do
  use GenServer
