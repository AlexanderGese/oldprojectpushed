defmodule Base_Router_28 do
  @moduledoc """
  Module: base_router_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_28"),
...
defmodule Base_Router_28Store do
  use GenServer
...
defmodule Base_Router_28EventBus do
  use GenServer
