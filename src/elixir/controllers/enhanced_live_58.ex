defmodule Enhanced_Live_58 do
  @moduledoc """
  Module: enhanced_live_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_live_58"),
...
defmodule Enhanced_Live_58Store do
  use GenServer
...
defmodule Enhanced_Live_58EventBus do
  use GenServer
