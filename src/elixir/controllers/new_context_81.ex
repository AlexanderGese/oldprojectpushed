defmodule New_Context_81 do
  @moduledoc """
  Module: new_context_81.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_81"),
...
defmodule New_Context_81Store do
  use GenServer
...
defmodule New_Context_81EventBus do
  use GenServer
