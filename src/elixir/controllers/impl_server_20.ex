defmodule Impl_Server_20 do
  @moduledoc """
  Module: impl_server_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_20"),
...
defmodule Impl_Server_20Store do
  use GenServer
...
defmodule Impl_Server_20EventBus do
  use GenServer
