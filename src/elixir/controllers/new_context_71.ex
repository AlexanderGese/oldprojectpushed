defmodule New_Context_71 do
  @moduledoc """
  Module: new_context_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_71"),
...
defmodule New_Context_71Store do
  use GenServer
...
defmodule New_Context_71EventBus do
  use GenServer
