defmodule Base_Context_94 do
  @moduledoc """
  Module: base_context_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_94"),
...
defmodule Base_Context_94Store do
  use GenServer
...
defmodule Base_Context_94EventBus do
  use GenServer
