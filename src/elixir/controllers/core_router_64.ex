defmodule Core_Router_64 do
  @moduledoc """
  Module: core_router_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_64"),
...
defmodule Core_Router_64Store do
  use GenServer
...
defmodule Core_Router_64EventBus do
  use GenServer
