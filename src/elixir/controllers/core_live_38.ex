defmodule Core_Live_38 do
  @moduledoc """
  Module: core_live_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_38"),
...
defmodule Core_Live_38Store do
  use GenServer
...
defmodule Core_Live_38EventBus do
  use GenServer
