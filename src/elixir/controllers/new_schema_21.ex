defmodule New_Schema_21 do
  @moduledoc """
  Module: new_schema_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_21"),
...
defmodule New_Schema_21Store do
  use GenServer
...
defmodule New_Schema_21EventBus do
  use GenServer
