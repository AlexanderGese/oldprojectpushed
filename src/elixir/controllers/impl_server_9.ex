defmodule Impl_Server_9 do
  @moduledoc """
  Module: impl_server_9.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_9"),
...
defmodule Impl_Server_9Store do
  use GenServer
...
defmodule Impl_Server_9EventBus do
  use GenServer
