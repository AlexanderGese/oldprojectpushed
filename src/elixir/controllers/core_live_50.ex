defmodule Core_Live_50 do
  @moduledoc """
  Module: core_live_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_50"),
...
defmodule Core_Live_50Store do
  use GenServer
...
defmodule Core_Live_50EventBus do
  use GenServer
