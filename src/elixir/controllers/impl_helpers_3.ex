defmodule Impl_Helpers_3 do
  @moduledoc """
  Module: impl_helpers_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_3"),
...
defmodule Impl_Helpers_3Store do
  use GenServer
...
defmodule Impl_Helpers_3EventBus do
  use GenServer
