defmodule V2_Worker_13 do
  @moduledoc """
  Module: v2_worker_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_worker_13"),
...
defmodule V2_Worker_13Store do
  use GenServer
...
defmodule V2_Worker_13EventBus do
  use GenServer
