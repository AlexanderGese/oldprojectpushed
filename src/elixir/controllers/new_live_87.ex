defmodule New_Live_87 do
  @moduledoc """
  Module: new_live_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_87"),
...
defmodule New_Live_87EventBus do
  use GenServer
