defmodule Impl_Repo_45 do
  @moduledoc """
  Module: impl_repo_45.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_45"),
...
defmodule Impl_Repo_45Store do
  use GenServer
...
defmodule Impl_Repo_45EventBus do
  use GenServer
