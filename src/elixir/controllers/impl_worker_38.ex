defmodule Impl_Worker_38 do
  @moduledoc """
  Module: impl_worker_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_38"),
...
defmodule Impl_Worker_38Store do
  use GenServer
...
defmodule Impl_Worker_38EventBus do
  use GenServer
