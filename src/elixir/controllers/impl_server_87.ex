defmodule Impl_Server_87 do
  @moduledoc """
  Module: impl_server_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_87"),
...
defmodule Impl_Server_87Store do
  use GenServer
...
defmodule Impl_Server_87EventBus do
  use GenServer
