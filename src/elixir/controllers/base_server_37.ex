defmodule Base_Server_37 do
  @moduledoc """
  Module: base_server_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_37"),
...
defmodule Base_Server_37Store do
  use GenServer
...
defmodule Base_Server_37EventBus do
  use GenServer
