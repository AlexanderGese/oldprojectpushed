defmodule Base_Application_64 do
  @moduledoc """
  Module: base_application_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_64"),
...
defmodule Base_Application_64Store do
  use GenServer
...
defmodule Base_Application_64EventBus do
  use GenServer
