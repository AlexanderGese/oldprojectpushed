defmodule V2_Schema_96 do
  @moduledoc """
  Module: v2_schema_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_96"),
...
defmodule V2_Schema_96Store do
  use GenServer
...
defmodule V2_Schema_96EventBus do
  use GenServer
