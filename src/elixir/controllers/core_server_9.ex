defmodule Core_Server_9 do
  @moduledoc """
  Module: core_server_9.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_9"),
...
defmodule Core_Server_9Store do
  use GenServer
...
defmodule Core_Server_9EventBus do
  use GenServer
