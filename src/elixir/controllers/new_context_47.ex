defmodule New_Context_47 do
  @moduledoc """
  Module: new_context_47.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_47"),
...
defmodule New_Context_47Store do
  use GenServer
...
defmodule New_Context_47EventBus do
  use GenServer
