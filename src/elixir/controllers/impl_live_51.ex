defmodule Impl_Live_51 do
  @moduledoc """
  Module: impl_live_51.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_51"),
...
defmodule Impl_Live_51Store do
  use GenServer
...
defmodule Impl_Live_51EventBus do
  use GenServer
