defmodule Base_Router_73 do
  @moduledoc """
  Module: base_router_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_73"),
...
defmodule Base_Router_73Store do
  use GenServer
...
defmodule Base_Router_73EventBus do
  use GenServer
