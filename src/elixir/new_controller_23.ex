defmodule New_Controller_23 do
  @moduledoc """
  Module: new_controller_23.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_23"),
...
defmodule New_Controller_23Store do
  use GenServer
...
defmodule New_Controller_23EventBus do
  use GenServer
