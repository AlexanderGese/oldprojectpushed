defmodule Base_Context_18 do
  @moduledoc """
  Module: base_context_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_18"),
...
defmodule Base_Context_18Store do
  use GenServer
...
defmodule Base_Context_18EventBus do
  use GenServer
