defmodule New_Worker_90 do
  @moduledoc """
  Module: new_worker_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_90"),
...
defmodule New_Worker_90Store do
  use GenServer
...
defmodule New_Worker_90EventBus do
  use GenServer
