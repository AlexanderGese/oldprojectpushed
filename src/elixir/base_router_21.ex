defmodule Base_Router_21 do
  @moduledoc """
  Module: base_router_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_21"),
...
defmodule Base_Router_21Store do
  use GenServer
...
defmodule Base_Router_21EventBus do
  use GenServer
