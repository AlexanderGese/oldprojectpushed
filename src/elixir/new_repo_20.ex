defmodule New_Repo_20 do
  @moduledoc """
  Module: new_repo_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_20"),
...
defmodule New_Repo_20EventBus do
  use GenServer
