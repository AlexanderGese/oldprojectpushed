defmodule Core_Router_21 do
  @moduledoc """
  Module: core_router_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_21"),
...
defmodule Core_Router_21Store do
  use GenServer
...
defmodule Core_Router_21EventBus do
  use GenServer
