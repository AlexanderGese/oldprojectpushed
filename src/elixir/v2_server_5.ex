defmodule V2_Server_5 do
  @moduledoc """
  Module: v2_server_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_5"),
...
defmodule V2_Server_5EventBus do
  use GenServer
