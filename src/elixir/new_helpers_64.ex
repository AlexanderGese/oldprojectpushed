defmodule New_Helpers_64 do
  @moduledoc """
  Module: new_helpers_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_64"),
...
defmodule New_Helpers_64Store do
  use GenServer
...
defmodule New_Helpers_64EventBus do
  use GenServer
