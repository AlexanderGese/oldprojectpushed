defmodule Impl_Application_27 do
  @moduledoc """
  Module: impl_application_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_27"),
...
defmodule Impl_Application_27Store do
  use GenServer
...
defmodule Impl_Application_27EventBus do
  use GenServer
