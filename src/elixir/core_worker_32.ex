defmodule Core_Worker_32 do
  @moduledoc """
  Module: core_worker_32.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_32"),
...
defmodule Core_Worker_32Store do
  use GenServer
...
defmodule Core_Worker_32EventBus do
  use GenServer
