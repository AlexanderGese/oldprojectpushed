defmodule New_Context_93 do
  @moduledoc """
  Module: new_context_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_93"),
...
defmodule New_Context_93Store do
  use GenServer
...
defmodule New_Context_93EventBus do
  use GenServer
