defmodule New_Worker_42 do
  @moduledoc """
  Module: new_worker_42.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_42"),
...
defmodule New_Worker_42Store do
  use GenServer
...
defmodule New_Worker_42EventBus do
  use GenServer
