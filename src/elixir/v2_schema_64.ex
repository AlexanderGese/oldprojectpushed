defmodule V2_Schema_64 do
  @moduledoc """
  Module: v2_schema_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_64"),
...
defmodule V2_Schema_64Store do
  use GenServer
...
defmodule V2_Schema_64EventBus do
  use GenServer
