defmodule Impl_Schema_86 do
  @moduledoc """
  Module: impl_schema_86.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_86"),
...
defmodule Impl_Schema_86Store do
  use GenServer
...
defmodule Impl_Schema_86EventBus do
  use GenServer
