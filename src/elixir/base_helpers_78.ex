defmodule Base_Helpers_78 do
  @moduledoc """
  Module: base_helpers_78.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_78"),
...
defmodule Base_Helpers_78Store do
  use GenServer
...
defmodule Base_Helpers_78EventBus do
  use GenServer
