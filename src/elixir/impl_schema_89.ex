defmodule Impl_Schema_89 do
  @moduledoc """
  Module: impl_schema_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_89"),
...
defmodule Impl_Schema_89Store do
  use GenServer
...
defmodule Impl_Schema_89EventBus do
  use GenServer
