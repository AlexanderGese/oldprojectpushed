defmodule New_Context_21 do
  @moduledoc """
  Module: new_context_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_21"),
...
defmodule New_Context_21Store do
  use GenServer
...
defmodule New_Context_21EventBus do
  use GenServer
