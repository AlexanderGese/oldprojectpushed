defmodule Core_Context_40 do
  @moduledoc """
  Module: core_context_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_40"),
...
defmodule Core_Context_40Store do
  use GenServer
...
defmodule Core_Context_40EventBus do
  use GenServer
