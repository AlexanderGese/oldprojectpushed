defmodule New_Application_97 do
  @moduledoc """
  Module: new_application_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_97"),
...
defmodule New_Application_97Store do
  use GenServer
...
defmodule New_Application_97EventBus do
  use GenServer
