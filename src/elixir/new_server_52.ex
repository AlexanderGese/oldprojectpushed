defmodule New_Server_52 do
  @moduledoc """
  Module: new_server_52.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_52"),
...
defmodule New_Server_52Store do
  use GenServer
...
defmodule New_Server_52EventBus do
  use GenServer
