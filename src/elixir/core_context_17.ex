defmodule Core_Context_17 do
  @moduledoc """
  Module: core_context_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_17"),
...
defmodule Core_Context_17Store do
  use GenServer
...
defmodule Core_Context_17EventBus do
  use GenServer
