defmodule Impl_Controller_7 do
  @moduledoc """
  Module: impl_controller_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_controller_7"),
...
defmodule Impl_Controller_7Store do
  use GenServer
...
defmodule Impl_Controller_7EventBus do
  use GenServer
