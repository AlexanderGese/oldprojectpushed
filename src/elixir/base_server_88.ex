defmodule Base_Server_88 do
  @moduledoc """
  Module: base_server_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_88"),
...
defmodule Base_Server_88Store do
  use GenServer
...
defmodule Base_Server_88EventBus do
  use GenServer
