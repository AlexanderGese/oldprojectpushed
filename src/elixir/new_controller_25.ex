defmodule New_Controller_25 do
  @moduledoc """
  Module: new_controller_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_25"),
...
defmodule New_Controller_25Store do
  use GenServer
...
defmodule New_Controller_25EventBus do
  use GenServer
