defmodule Base_Helpers_28 do
  @moduledoc """
  Module: base_helpers_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_28"),
...
defmodule Base_Helpers_28Store do
  use GenServer
...
defmodule Base_Helpers_28EventBus do
  use GenServer
