defmodule New_Worker_40 do
  @moduledoc """
  Module: new_worker_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_40"),
...
defmodule New_Worker_40Store do
  use GenServer
...
defmodule New_Worker_40EventBus do
  use GenServer
