defmodule Application_80 do
  @moduledoc """
  Module: application_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "application_80"),
...
defmodule Application_80Store do
  use GenServer
...
defmodule Application_80EventBus do
  use GenServer
