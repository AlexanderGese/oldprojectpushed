defmodule Base_Repo_8 do
  @moduledoc """
  Module: base_repo_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_8"),
...
defmodule Base_Repo_8EventBus do
  use GenServer
