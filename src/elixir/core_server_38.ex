defmodule Core_Server_38 do
  @moduledoc """
  Module: core_server_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_38"),
...
defmodule Core_Server_38Store do
  use GenServer
...
defmodule Core_Server_38EventBus do
  use GenServer
