defmodule New_Repo_21 do
  @moduledoc """
  Module: new_repo_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_21"),
...
defmodule New_Repo_21EventBus do
  use GenServer
