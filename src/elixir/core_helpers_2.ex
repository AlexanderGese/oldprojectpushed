defmodule Core_Helpers_2 do
  @moduledoc """
  Module: core_helpers_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_2"),
...
defmodule Core_Helpers_2Store do
  use GenServer
...
defmodule Core_Helpers_2EventBus do
  use GenServer
