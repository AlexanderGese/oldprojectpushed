defmodule New_Server_4 do
  @moduledoc """
  Module: new_server_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_4"),
...
defmodule New_Server_4Store do
  use GenServer
...
defmodule New_Server_4EventBus do
  use GenServer
