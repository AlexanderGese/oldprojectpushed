defmodule Core_Live_30 do
  @moduledoc """
  Module: core_live_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_30"),
...
defmodule Core_Live_30Store do
  use GenServer
...
defmodule Core_Live_30EventBus do
  use GenServer
