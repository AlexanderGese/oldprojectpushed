defmodule New_Server_91 do
  @moduledoc """
  Module: new_server_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_91"),
...
defmodule New_Server_91Store do
  use GenServer
...
defmodule New_Server_91EventBus do
  use GenServer
