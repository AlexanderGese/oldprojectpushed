defmodule New_Live_71 do
  @moduledoc """
  Module: new_live_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_71"),
...
defmodule New_Live_71EventBus do
  use GenServer
