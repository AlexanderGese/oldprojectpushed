defmodule V2_Server_27 do
  @moduledoc """
  Module: v2_server_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_27"),
...
defmodule V2_Server_27Store do
  use GenServer
...
defmodule V2_Server_27EventBus do
  use GenServer
