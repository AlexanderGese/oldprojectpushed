defmodule Core_Application_47 do
  @moduledoc """
  Module: core_application_47.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_47"),
...
defmodule Core_Application_47Store do
  use GenServer
...
defmodule Core_Application_47EventBus do
  use GenServer
