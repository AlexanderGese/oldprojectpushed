defmodule V2_Worker_26 do
  @moduledoc """
  Module: v2_worker_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_worker_26"),
...
defmodule V2_Worker_26Store do
  use GenServer
...
defmodule V2_Worker_26EventBus do
  use GenServer
