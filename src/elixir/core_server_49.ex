defmodule Core_Server_49 do
  @moduledoc """
  Module: core_server_49.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_49"),
...
defmodule Core_Server_49Store do
  use GenServer
...
defmodule Core_Server_49EventBus do
  use GenServer
