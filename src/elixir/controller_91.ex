defmodule Controller_91 do
  @moduledoc """
  Module: controller_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_91"),
...
defmodule Controller_91Store do
  use GenServer
...
defmodule Controller_91EventBus do
  use GenServer
