defmodule Base_Repo_66 do
  @moduledoc """
  Module: base_repo_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_66"),
...
defmodule Base_Repo_66Store do
  use GenServer
...
defmodule Base_Repo_66EventBus do
  use GenServer
