defmodule New_Live_46 do
  @moduledoc """
  Module: new_live_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_46"),
...
defmodule New_Live_46EventBus do
  use GenServer
