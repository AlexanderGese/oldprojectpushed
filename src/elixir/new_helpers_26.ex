defmodule New_Helpers_26 do
  @moduledoc """
  Module: new_helpers_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_26"),
...
defmodule New_Helpers_26Store do
  use GenServer
...
defmodule New_Helpers_26EventBus do
  use GenServer
