defmodule New_Worker_41 do
  @moduledoc """
  Module: new_worker_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_41"),
...
defmodule New_Worker_41Store do
  use GenServer
...
defmodule New_Worker_41EventBus do
  use GenServer
