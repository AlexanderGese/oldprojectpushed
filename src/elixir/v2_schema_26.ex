defmodule V2_Schema_26 do
  @moduledoc """
  Module: v2_schema_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_26"),
...
defmodule V2_Schema_26Store do
  use GenServer
...
defmodule V2_Schema_26EventBus do
  use GenServer
