defmodule V2_Application_58 do
  @moduledoc """
  Module: v2_application_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_application_58"),
...
defmodule V2_Application_58Store do
  use GenServer
...
defmodule V2_Application_58EventBus do
  use GenServer
