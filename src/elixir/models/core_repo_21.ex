defmodule Core_Repo_21 do
  @moduledoc """
  Module: core_repo_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_21"),
...
defmodule Core_Repo_21Store do
  use GenServer
...
defmodule Core_Repo_21EventBus do
  use GenServer
