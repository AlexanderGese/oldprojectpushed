defmodule New_Helpers_19 do
  @moduledoc """
  Module: new_helpers_19.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_19"),
...
defmodule New_Helpers_19Store do
  use GenServer
...
defmodule New_Helpers_19EventBus do
  use GenServer
