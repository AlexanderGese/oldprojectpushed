defmodule Impl_Application_1 do
  @moduledoc """
  Module: impl_application_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_1"),
...
defmodule Impl_Application_1Store do
  use GenServer
...
defmodule Impl_Application_1EventBus do
  use GenServer
