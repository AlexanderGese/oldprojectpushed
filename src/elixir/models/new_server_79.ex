defmodule New_Server_79 do
  @moduledoc """
  Module: new_server_79.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_79"),
...
defmodule New_Server_79Store do
  use GenServer
...
defmodule New_Server_79EventBus do
  use GenServer
