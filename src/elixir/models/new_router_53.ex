defmodule New_Router_53 do
  @moduledoc """
  Module: new_router_53.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_53"),
...
defmodule New_Router_53Store do
  use GenServer
...
defmodule New_Router_53EventBus do
  use GenServer
