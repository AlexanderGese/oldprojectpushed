defmodule Core_Live_92 do
  @moduledoc """
  Module: core_live_92.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_92"),
...
defmodule Core_Live_92Store do
  use GenServer
...
defmodule Core_Live_92EventBus do
  use GenServer
