defmodule New_Worker_91 do
  @moduledoc """
  Module: new_worker_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_91"),
...
defmodule New_Worker_91Store do
  use GenServer
...
defmodule New_Worker_91EventBus do
  use GenServer
