defmodule New_Repo_78 do
  @moduledoc """
  Module: new_repo_78.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_78"),
...
defmodule New_Repo_78EventBus do
  use GenServer
