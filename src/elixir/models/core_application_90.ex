defmodule Core_Application_90 do
  @moduledoc """
  Module: core_application_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_90"),
...
defmodule Core_Application_90Store do
  use GenServer
...
defmodule Core_Application_90EventBus do
  use GenServer
