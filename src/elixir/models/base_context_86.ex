defmodule Base_Context_86 do
  @moduledoc """
  Module: base_context_86.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_86"),
...
defmodule Base_Context_86Store do
  use GenServer
...
defmodule Base_Context_86EventBus do
  use GenServer
