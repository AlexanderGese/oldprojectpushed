defmodule Core_Helpers_92 do
  @moduledoc """
  Module: core_helpers_92.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_92"),
...
defmodule Core_Helpers_92Store do
  use GenServer
...
defmodule Core_Helpers_92EventBus do
  use GenServer
