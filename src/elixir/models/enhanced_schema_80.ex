defmodule Enhanced_Schema_80 do
  @moduledoc """
  Module: enhanced_schema_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_schema_80"),
...
defmodule Enhanced_Schema_80Store do
  use GenServer
...
defmodule Enhanced_Schema_80EventBus do
  use GenServer
