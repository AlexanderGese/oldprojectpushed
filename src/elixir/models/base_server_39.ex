defmodule Base_Server_39 do
  @moduledoc """
  Module: base_server_39.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_39"),
...
defmodule Base_Server_39Store do
  use GenServer
...
defmodule Base_Server_39EventBus do
  use GenServer
