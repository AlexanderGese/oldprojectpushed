defmodule Core_Context_65 do
  @moduledoc """
  Module: core_context_65.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_65"),
...
defmodule Core_Context_65Store do
  use GenServer
...
defmodule Core_Context_65EventBus do
  use GenServer
