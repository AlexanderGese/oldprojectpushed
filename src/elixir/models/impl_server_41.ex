defmodule Impl_Server_41 do
  @moduledoc """
  Module: impl_server_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_41"),
...
defmodule Impl_Server_41Store do
  use GenServer
...
defmodule Impl_Server_41EventBus do
  use GenServer
