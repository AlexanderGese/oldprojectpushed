defmodule Impl_Server_76 do
  @moduledoc """
  Module: impl_server_76.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_76"),
...
defmodule Impl_Server_76Store do
  use GenServer
...
defmodule Impl_Server_76EventBus do
  use GenServer
