defmodule Base_Worker_80 do
  @moduledoc """
  Module: base_worker_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_80"),
...
defmodule Base_Worker_80Store do
  use GenServer
...
defmodule Base_Worker_80EventBus do
  use GenServer
