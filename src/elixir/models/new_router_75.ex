defmodule New_Router_75 do
  @moduledoc """
  Module: new_router_75.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_75"),
...
defmodule New_Router_75Store do
  use GenServer
...
defmodule New_Router_75EventBus do
  use GenServer
