defmodule Base_Server_2 do
  @moduledoc """
  Module: base_server_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_2"),
...
defmodule Base_Server_2Store do
  use GenServer
...
defmodule Base_Server_2EventBus do
  use GenServer
