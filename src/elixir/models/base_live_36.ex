defmodule Base_Live_36 do
  @moduledoc """
  Module: base_live_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_36"),
...
defmodule Base_Live_36Store do
  use GenServer
...
defmodule Base_Live_36EventBus do
  use GenServer
