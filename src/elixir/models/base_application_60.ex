defmodule Base_Application_60 do
  @moduledoc """
  Module: base_application_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_60"),
...
defmodule Base_Application_60Store do
  use GenServer
...
defmodule Base_Application_60EventBus do
  use GenServer
