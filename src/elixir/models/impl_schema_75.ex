defmodule Impl_Schema_75 do
  @moduledoc """
  Module: impl_schema_75.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_75"),
...
defmodule Impl_Schema_75Store do
  use GenServer
...
defmodule Impl_Schema_75EventBus do
  use GenServer
