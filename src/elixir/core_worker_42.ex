defmodule Core_Worker_42 do
  @moduledoc """
  Module: core_worker_42.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_42"),
...
defmodule Core_Worker_42Store do
  use GenServer
...
defmodule Core_Worker_42EventBus do
  use GenServer
