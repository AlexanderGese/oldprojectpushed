defmodule Impl_Live_4 do
  @moduledoc """
  Module: impl_live_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_4"),
...
defmodule Impl_Live_4EventBus do
  use GenServer
