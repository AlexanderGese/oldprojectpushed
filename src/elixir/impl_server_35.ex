defmodule Impl_Server_35 do
  @moduledoc """
  Module: impl_server_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_35"),
...
defmodule Impl_Server_35Store do
  use GenServer
...
defmodule Impl_Server_35EventBus do
  use GenServer
