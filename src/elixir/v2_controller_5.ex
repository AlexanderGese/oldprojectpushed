defmodule V2_Controller_5 do
  @moduledoc """
  Module: v2_controller_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_controller_5"),
...
defmodule V2_Controller_5Store do
  use GenServer
...
defmodule V2_Controller_5EventBus do
  use GenServer
