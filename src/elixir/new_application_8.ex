defmodule New_Application_8 do
  @moduledoc """
  Module: new_application_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_8"),
...
defmodule New_Application_8Store do
  use GenServer
...
defmodule New_Application_8EventBus do
  use GenServer
