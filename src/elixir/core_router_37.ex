defmodule Core_Router_37 do
  @moduledoc """
  Module: core_router_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_37"),
...
defmodule Core_Router_37Store do
  use GenServer
...
defmodule Core_Router_37EventBus do
  use GenServer
