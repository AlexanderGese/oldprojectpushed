defmodule New_Schema_8 do
  @moduledoc """
  Module: new_schema_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_8"),
...
defmodule New_Schema_8Store do
  use GenServer
...
defmodule New_Schema_8EventBus do
  use GenServer
