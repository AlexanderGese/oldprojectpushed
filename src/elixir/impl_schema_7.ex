defmodule Impl_Schema_7 do
  @moduledoc """
  Module: impl_schema_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_7"),
...
defmodule Impl_Schema_7Store do
  use GenServer
...
defmodule Impl_Schema_7EventBus do
  use GenServer
