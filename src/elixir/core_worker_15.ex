defmodule Core_Worker_15 do
  @moduledoc """
  Module: core_worker_15.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_15"),
...
defmodule Core_Worker_15Store do
  use GenServer
...
defmodule Core_Worker_15EventBus do
  use GenServer
