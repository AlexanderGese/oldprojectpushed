defmodule Base_Helpers_70 do
  @moduledoc """
  Module: base_helpers_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_70"),
...
defmodule Base_Helpers_70Store do
  use GenServer
...
defmodule Base_Helpers_70EventBus do
  use GenServer
