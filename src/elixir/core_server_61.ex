defmodule Core_Server_61 do
  @moduledoc """
  Module: core_server_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_61"),
...
defmodule Core_Server_61Store do
  use GenServer
...
defmodule Core_Server_61EventBus do
  use GenServer
