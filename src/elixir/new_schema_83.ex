defmodule New_Schema_83 do
  @moduledoc """
  Module: new_schema_83.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_83"),
...
defmodule New_Schema_83Store do
  use GenServer
...
defmodule New_Schema_83EventBus do
  use GenServer
