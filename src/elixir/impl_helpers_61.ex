defmodule Impl_Helpers_61 do
  @moduledoc """
  Module: impl_helpers_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_61"),
...
defmodule Impl_Helpers_61Store do
  use GenServer
...
defmodule Impl_Helpers_61EventBus do
  use GenServer
