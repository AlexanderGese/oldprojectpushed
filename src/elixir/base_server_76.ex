defmodule Base_Server_76 do
  @moduledoc """
  Module: base_server_76.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_76"),
...
defmodule Base_Server_76Store do
  use GenServer
...
defmodule Base_Server_76EventBus do
  use GenServer
