defmodule New_Controller_40 do
  @moduledoc """
  Module: new_controller_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_40"),
...
defmodule New_Controller_40Store do
  use GenServer
...
defmodule New_Controller_40EventBus do
  use GenServer
