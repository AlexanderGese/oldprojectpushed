defmodule Core_Server_80 do
  @moduledoc """
  Module: core_server_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_80"),
...
defmodule Core_Server_80Store do
  use GenServer
...
defmodule Core_Server_80EventBus do
  use GenServer
