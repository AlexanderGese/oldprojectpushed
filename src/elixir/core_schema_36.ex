defmodule Core_Schema_36 do
  @moduledoc """
  Module: core_schema_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_36"),
...
defmodule Core_Schema_36Store do
  use GenServer
...
defmodule Core_Schema_36EventBus do
  use GenServer
