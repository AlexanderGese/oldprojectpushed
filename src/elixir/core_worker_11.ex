defmodule Core_Worker_11 do
  @moduledoc """
  Module: core_worker_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_11"),
...
defmodule Core_Worker_11Store do
  use GenServer
...
defmodule Core_Worker_11EventBus do
  use GenServer
