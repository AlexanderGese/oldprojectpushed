defmodule Base_Router_60 do
  @moduledoc """
  Module: base_router_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_60"),
...
defmodule Base_Router_60Store do
  use GenServer
...
defmodule Base_Router_60EventBus do
  use GenServer
