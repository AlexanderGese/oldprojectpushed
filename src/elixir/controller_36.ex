defmodule Controller_36 do
  @moduledoc """
  Module: controller_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_36"),
...
defmodule Controller_36Store do
  use GenServer
...
defmodule Controller_36EventBus do
  use GenServer
