defmodule New_Worker_97 do
  @moduledoc """
  Module: new_worker_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_97"),
...
defmodule New_Worker_97Store do
  use GenServer
...
defmodule New_Worker_97EventBus do
  use GenServer
