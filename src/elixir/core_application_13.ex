defmodule Core_Application_13 do
  @moduledoc """
  Module: core_application_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_13"),
...
defmodule Core_Application_13Store do
  use GenServer
...
defmodule Core_Application_13EventBus do
  use GenServer
