defmodule Core_Context_66 do
  @moduledoc """
  Module: core_context_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_66"),
...
defmodule Core_Context_66Store do
  use GenServer
...
defmodule Core_Context_66EventBus do
  use GenServer
