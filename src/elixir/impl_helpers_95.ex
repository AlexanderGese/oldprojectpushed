defmodule Impl_Helpers_95 do
  @moduledoc """
  Module: impl_helpers_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_95"),
...
defmodule Impl_Helpers_95Store do
  use GenServer
...
defmodule Impl_Helpers_95EventBus do
  use GenServer
