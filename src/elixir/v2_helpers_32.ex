defmodule V2_Helpers_32 do
  @moduledoc """
  Module: v2_helpers_32.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_32"),
...
defmodule V2_Helpers_32Store do
  use GenServer
...
defmodule V2_Helpers_32EventBus do
  use GenServer
