defmodule Impl_Helpers_20 do
  @moduledoc """
  Module: impl_helpers_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_20"),
...
defmodule Impl_Helpers_20Store do
  use GenServer
...
defmodule Impl_Helpers_20EventBus do
  use GenServer
