defmodule New_Server_99 do
  @moduledoc """
  Module: new_server_99.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_99"),
...
defmodule New_Server_99Store do
  use GenServer
...
defmodule New_Server_99EventBus do
  use GenServer
