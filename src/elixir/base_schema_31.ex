defmodule Base_Schema_31 do
  @moduledoc """
  Module: base_schema_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_31"),
...
defmodule Base_Schema_31Store do
  use GenServer
...
defmodule Base_Schema_31EventBus do
  use GenServer
