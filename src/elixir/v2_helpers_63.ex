defmodule V2_Helpers_63 do
  @moduledoc """
  Module: v2_helpers_63.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_63"),
...
defmodule V2_Helpers_63Store do
  use GenServer
...
defmodule V2_Helpers_63EventBus do
  use GenServer
