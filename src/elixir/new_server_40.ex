defmodule New_Server_40 do
  @moduledoc """
  Module: new_server_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_40"),
...
defmodule New_Server_40Store do
  use GenServer
...
defmodule New_Server_40EventBus do
  use GenServer
