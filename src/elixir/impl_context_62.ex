defmodule Impl_Context_62 do
  @moduledoc """
  Module: impl_context_62.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_62"),
...
defmodule Impl_Context_62Store do
  use GenServer
...
defmodule Impl_Context_62EventBus do
  use GenServer
