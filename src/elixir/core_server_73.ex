defmodule Core_Server_73 do
  @moduledoc """
  Module: core_server_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_73"),
...
defmodule Core_Server_73Store do
  use GenServer
...
defmodule Core_Server_73EventBus do
  use GenServer
