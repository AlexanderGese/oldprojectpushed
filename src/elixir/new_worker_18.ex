defmodule New_Worker_18 do
  @moduledoc """
  Module: new_worker_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_18"),
...
defmodule New_Worker_18Store do
  use GenServer
...
defmodule New_Worker_18EventBus do
  use GenServer
