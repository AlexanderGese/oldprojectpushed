defmodule New_Worker_63 do
  @moduledoc """
  Module: new_worker_63.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_63"),
...
defmodule New_Worker_63Store do
  use GenServer
...
defmodule New_Worker_63EventBus do
  use GenServer
