defmodule V2_Context_83 do
  @moduledoc """
  Module: v2_context_83.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_83"),
...
defmodule V2_Context_83Store do
  use GenServer
...
defmodule V2_Context_83EventBus do
  use GenServer
