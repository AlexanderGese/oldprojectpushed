defmodule Impl_Context_30 do
  @moduledoc """
  Module: impl_context_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_30"),
...
defmodule Impl_Context_30Store do
  use GenServer
...
defmodule Impl_Context_30EventBus do
  use GenServer
