defmodule V2_Helpers_33 do
  @moduledoc """
  Module: v2_helpers_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_33"),
...
defmodule V2_Helpers_33Store do
  use GenServer
...
defmodule V2_Helpers_33EventBus do
  use GenServer
