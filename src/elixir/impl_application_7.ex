defmodule Impl_Application_7 do
  @moduledoc """
  Module: impl_application_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_7"),
...
defmodule Impl_Application_7Store do
  use GenServer
...
defmodule Impl_Application_7EventBus do
  use GenServer
