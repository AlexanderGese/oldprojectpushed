defmodule Base_Context_10 do
  @moduledoc """
  Module: base_context_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_10"),
...
defmodule Base_Context_10Store do
  use GenServer
...
defmodule Base_Context_10EventBus do
  use GenServer
