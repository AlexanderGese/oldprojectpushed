defmodule New_Context_98 do
  @moduledoc """
  Module: new_context_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_98"),
...
defmodule New_Context_98Store do
  use GenServer
...
defmodule New_Context_98EventBus do
  use GenServer
