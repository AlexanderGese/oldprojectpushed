defmodule Impl_Router_20 do
  @moduledoc """
  Module: impl_router_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_20"),
...
defmodule Impl_Router_20Store do
  use GenServer
...
defmodule Impl_Router_20EventBus do
  use GenServer
