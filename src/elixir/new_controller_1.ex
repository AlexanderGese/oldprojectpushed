defmodule New_Controller_1 do
  @moduledoc """
  Module: new_controller_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_1"),
...
defmodule New_Controller_1Store do
  use GenServer
...
defmodule New_Controller_1EventBus do
  use GenServer
