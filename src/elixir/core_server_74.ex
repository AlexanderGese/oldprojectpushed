defmodule Core_Server_74 do
  @moduledoc """
  Module: core_server_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_74"),
...
defmodule Core_Server_74Store do
  use GenServer
...
defmodule Core_Server_74EventBus do
  use GenServer
