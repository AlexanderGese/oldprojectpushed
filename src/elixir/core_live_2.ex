defmodule Core_Live_2 do
  @moduledoc """
  Module: core_live_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_2"),
...
defmodule Core_Live_2EventBus do
  use GenServer
