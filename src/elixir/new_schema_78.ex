defmodule New_Schema_78 do
  @moduledoc """
  Module: new_schema_78.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_78"),
...
defmodule New_Schema_78Store do
  use GenServer
...
defmodule New_Schema_78EventBus do
  use GenServer
