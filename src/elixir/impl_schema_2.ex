defmodule Impl_Schema_2 do
  @moduledoc """
  Module: impl_schema_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_2"),
...
defmodule Impl_Schema_2Store do
  use GenServer
...
defmodule Impl_Schema_2EventBus do
  use GenServer
