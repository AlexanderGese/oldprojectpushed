defmodule New_Repo_24 do
  @moduledoc """
  Module: new_repo_24.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_24"),
...
defmodule New_Repo_24EventBus do
  use GenServer
