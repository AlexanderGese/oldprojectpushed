defmodule V2_Helpers_7 do
  @moduledoc """
  Module: v2_helpers_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_7"),
...
defmodule V2_Helpers_7Store do
  use GenServer
...
defmodule V2_Helpers_7EventBus do
  use GenServer
