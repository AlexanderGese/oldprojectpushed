defmodule New_Worker_96 do
  @moduledoc """
  Module: new_worker_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_96"),
...
defmodule New_Worker_96Store do
  use GenServer
...
defmodule New_Worker_96EventBus do
  use GenServer
