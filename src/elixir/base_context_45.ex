defmodule Base_Context_45 do
  @moduledoc """
  Module: base_context_45.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_45"),
...
defmodule Base_Context_45Store do
  use GenServer
...
defmodule Base_Context_45EventBus do
  use GenServer
