defmodule Controller_10 do
  @moduledoc """
  Module: controller_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_10"),
...
defmodule Controller_10Store do
  use GenServer
...
defmodule Controller_10EventBus do
  use GenServer
