defmodule Core_Helpers_88 do
  @moduledoc """
  Module: core_helpers_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_88"),
...
defmodule Core_Helpers_88Store do
  use GenServer
...
defmodule Core_Helpers_88EventBus do
  use GenServer
