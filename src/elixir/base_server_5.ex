defmodule Base_Server_5 do
  @moduledoc """
  Module: base_server_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_5"),
...
defmodule Base_Server_5Store do
  use GenServer
...
defmodule Base_Server_5EventBus do
  use GenServer
