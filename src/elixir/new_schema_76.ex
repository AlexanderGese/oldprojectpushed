defmodule New_Schema_76 do
  @moduledoc """
  Module: new_schema_76.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_76"),
...
defmodule New_Schema_76Store do
  use GenServer
...
defmodule New_Schema_76EventBus do
  use GenServer
