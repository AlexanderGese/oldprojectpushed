defmodule New_Schema_82 do
  @moduledoc """
  Module: new_schema_82.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_82"),
...
defmodule New_Schema_82Store do
  use GenServer
...
defmodule New_Schema_82EventBus do
  use GenServer
