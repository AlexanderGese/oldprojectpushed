defmodule V2_Helpers_10 do
  @moduledoc """
  Module: v2_helpers_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_10"),
...
defmodule V2_Helpers_10Store do
  use GenServer
...
defmodule V2_Helpers_10EventBus do
  use GenServer
