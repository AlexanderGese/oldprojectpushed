defmodule New_Schema_29 do
  @moduledoc """
  Module: new_schema_29.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_29"),
...
defmodule New_Schema_29Store do
  use GenServer
...
defmodule New_Schema_29EventBus do
  use GenServer
