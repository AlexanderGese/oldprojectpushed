defmodule Core_Server_84 do
  @moduledoc """
  Module: core_server_84.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_84"),
...
defmodule Core_Server_84Store do
  use GenServer
...
defmodule Core_Server_84EventBus do
  use GenServer
