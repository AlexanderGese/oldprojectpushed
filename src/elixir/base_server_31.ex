defmodule Base_Server_31 do
  @moduledoc """
  Module: base_server_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_31"),
...
defmodule Base_Server_31Store do
  use GenServer
...
defmodule Base_Server_31EventBus do
  use GenServer
