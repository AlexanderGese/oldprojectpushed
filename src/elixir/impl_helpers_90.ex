defmodule Impl_Helpers_90 do
  @moduledoc """
  Module: impl_helpers_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_90"),
...
defmodule Impl_Helpers_90Store do
  use GenServer
...
defmodule Impl_Helpers_90EventBus do
  use GenServer
