defmodule Enhanced_Context_1 do
  @moduledoc """
  Module: enhanced_context_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_context_1"),
...
defmodule Enhanced_Context_1Store do
  use GenServer
...
defmodule Enhanced_Context_1EventBus do
  use GenServer
