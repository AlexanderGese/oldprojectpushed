defmodule Core_Schema_70 do
  @moduledoc """
  Module: core_schema_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_70"),
...
defmodule Core_Schema_70Store do
  use GenServer
...
defmodule Core_Schema_70EventBus do
  use GenServer
