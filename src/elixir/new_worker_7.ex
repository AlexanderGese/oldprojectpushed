defmodule New_Worker_7 do
  @moduledoc """
  Module: new_worker_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_7"),
...
defmodule New_Worker_7Store do
  use GenServer
...
defmodule New_Worker_7EventBus do
  use GenServer
