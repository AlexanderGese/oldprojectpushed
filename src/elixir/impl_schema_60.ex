defmodule Impl_Schema_60 do
  @moduledoc """
  Module: impl_schema_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_60"),
...
defmodule Impl_Schema_60Store do
  use GenServer
...
defmodule Impl_Schema_60EventBus do
  use GenServer
