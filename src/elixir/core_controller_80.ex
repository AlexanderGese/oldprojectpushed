defmodule Core_Controller_80 do
  @moduledoc """
  Module: core_controller_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_80"),
...
defmodule Core_Controller_80Store do
  use GenServer
...
defmodule Core_Controller_80EventBus do
  use GenServer
