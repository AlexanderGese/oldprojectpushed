defmodule Impl_Helpers_78 do
  @moduledoc """
  Module: impl_helpers_78.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_78"),
...
defmodule Impl_Helpers_78Store do
  use GenServer
...
defmodule Impl_Helpers_78EventBus do
  use GenServer
