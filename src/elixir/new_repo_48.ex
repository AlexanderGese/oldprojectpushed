defmodule New_Repo_48 do
  @moduledoc """
  Module: new_repo_48.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_48"),
...
defmodule New_Repo_48EventBus do
  use GenServer
