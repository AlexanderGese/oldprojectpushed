defmodule Base_Helpers_94 do
  @moduledoc """
  Module: base_helpers_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_94"),
...
defmodule Base_Helpers_94Store do
  use GenServer
...
defmodule Base_Helpers_94EventBus do
  use GenServer
