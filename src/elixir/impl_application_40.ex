defmodule Impl_Application_40 do
  @moduledoc """
  Module: impl_application_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_40"),
...
defmodule Impl_Application_40Store do
  use GenServer
...
defmodule Impl_Application_40EventBus do
  use GenServer
