defmodule New_Live_83 do
  @moduledoc """
  Module: new_live_83.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_83"),
...
defmodule New_Live_83EventBus do
  use GenServer
