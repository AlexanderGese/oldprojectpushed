defmodule Base_Context_52 do
  @moduledoc """
  Module: base_context_52.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_52"),
...
defmodule Base_Context_52Store do
  use GenServer
...
defmodule Base_Context_52EventBus do
  use GenServer
