defmodule Impl_Worker_78 do
  @moduledoc """
  Module: impl_worker_78.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_78"),
...
defmodule Impl_Worker_78Store do
  use GenServer
...
defmodule Impl_Worker_78EventBus do
  use GenServer
