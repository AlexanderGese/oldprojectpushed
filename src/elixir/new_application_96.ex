defmodule New_Application_96 do
  @moduledoc """
  Module: new_application_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_96"),
...
defmodule New_Application_96Store do
  use GenServer
...
defmodule New_Application_96EventBus do
  use GenServer
