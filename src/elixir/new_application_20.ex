defmodule New_Application_20 do
  @moduledoc """
  Module: new_application_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_20"),
...
defmodule New_Application_20Store do
  use GenServer
...
defmodule New_Application_20EventBus do
  use GenServer
