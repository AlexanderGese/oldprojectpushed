defmodule Base_Helpers_22 do
  @moduledoc """
  Module: base_helpers_22.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_22"),
...
defmodule Base_Helpers_22Store do
  use GenServer
...
defmodule Base_Helpers_22EventBus do
  use GenServer
