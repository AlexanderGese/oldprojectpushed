defmodule V2_Helpers_16 do
  @moduledoc """
  Module: v2_helpers_16.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_16"),
...
defmodule V2_Helpers_16Store do
  use GenServer
...
defmodule V2_Helpers_16EventBus do
  use GenServer
