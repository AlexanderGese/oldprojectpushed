defmodule V2_Context_7 do
  @moduledoc """
  Module: v2_context_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_7"),
...
defmodule V2_Context_7Store do
  use GenServer
...
defmodule V2_Context_7EventBus do
  use GenServer
