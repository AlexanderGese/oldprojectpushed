defmodule Base_Controller_37 do
  @moduledoc """
  Module: base_controller_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_37"),
...
defmodule Base_Controller_37Store do
  use GenServer
...
defmodule Base_Controller_37EventBus do
  use GenServer
