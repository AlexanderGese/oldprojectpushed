defmodule New_Router_66 do
  @moduledoc """
  Module: new_router_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_66"),
...
defmodule New_Router_66Store do
  use GenServer
...
defmodule New_Router_66EventBus do
  use GenServer
