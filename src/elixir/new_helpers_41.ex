defmodule New_Helpers_41 do
  @moduledoc """
  Module: new_helpers_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_41"),
...
defmodule New_Helpers_41Store do
  use GenServer
...
defmodule New_Helpers_41EventBus do
  use GenServer
