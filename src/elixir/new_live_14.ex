defmodule New_Live_14 do
  @moduledoc """
  Module: new_live_14.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_14"),
...
defmodule New_Live_14EventBus do
  use GenServer
