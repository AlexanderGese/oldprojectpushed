defmodule Base_Context_80 do
  @moduledoc """
  Module: base_context_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_80"),
...
defmodule Base_Context_80Store do
  use GenServer
...
defmodule Base_Context_80EventBus do
  use GenServer
