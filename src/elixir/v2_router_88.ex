defmodule V2_Router_88 do
  @moduledoc """
  Module: v2_router_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_router_88"),
...
defmodule V2_Router_88Store do
  use GenServer
...
defmodule V2_Router_88EventBus do
  use GenServer
