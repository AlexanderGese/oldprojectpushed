defmodule New_Live_85 do
  @moduledoc """
  Module: new_live_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_85"),
...
defmodule New_Live_85EventBus do
  use GenServer
