defmodule Base_Helpers_65 do
  @moduledoc """
  Module: base_helpers_65.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_65"),
...
defmodule Base_Helpers_65Store do
  use GenServer
...
defmodule Base_Helpers_65EventBus do
  use GenServer
