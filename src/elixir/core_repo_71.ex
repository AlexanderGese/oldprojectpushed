defmodule Core_Repo_71 do
  @moduledoc """
  Module: core_repo_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_71"),
...
defmodule Core_Repo_71Store do
  use GenServer
...
defmodule Core_Repo_71EventBus do
  use GenServer
