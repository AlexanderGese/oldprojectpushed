defmodule Base_Router_33 do
  @moduledoc """
  Module: base_router_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_33"),
...
defmodule Base_Router_33Store do
  use GenServer
...
defmodule Base_Router_33EventBus do
  use GenServer
