defmodule Core_Controller_5 do
  @moduledoc """
  Module: core_controller_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_5"),
...
defmodule Core_Controller_5Store do
  use GenServer
...
defmodule Core_Controller_5EventBus do
  use GenServer
