defmodule Impl_Helpers_25 do
  @moduledoc """
  Module: impl_helpers_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_25"),
...
defmodule Impl_Helpers_25Store do
  use GenServer
...
defmodule Impl_Helpers_25EventBus do
  use GenServer
