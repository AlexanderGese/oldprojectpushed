defmodule New_Helpers_15 do
  @moduledoc """
  Module: new_helpers_15.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_15"),
...
defmodule New_Helpers_15Store do
  use GenServer
...
defmodule New_Helpers_15EventBus do
  use GenServer
