defmodule Base_Router_37 do
  @moduledoc """
  Module: base_router_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_37"),
...
defmodule Base_Router_37Store do
  use GenServer
...
defmodule Base_Router_37EventBus do
  use GenServer
