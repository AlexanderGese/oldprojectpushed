defmodule Core_Router_10 do
  @moduledoc """
  Module: core_router_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_10"),
...
defmodule Core_Router_10Store do
  use GenServer
...
defmodule Core_Router_10EventBus do
  use GenServer
