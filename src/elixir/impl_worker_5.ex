defmodule Impl_Worker_5 do
  @moduledoc """
  Module: impl_worker_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_5"),
...
defmodule Impl_Worker_5Store do
  use GenServer
...
defmodule Impl_Worker_5EventBus do
  use GenServer
