defmodule Base_Live_81 do
  @moduledoc """
  Module: base_live_81.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_81"),
...
defmodule Base_Live_81Store do
  use GenServer
...
defmodule Base_Live_81EventBus do
  use GenServer
