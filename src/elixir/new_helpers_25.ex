defmodule New_Helpers_25 do
  @moduledoc """
  Module: new_helpers_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_25"),
...
defmodule New_Helpers_25Store do
  use GenServer
...
defmodule New_Helpers_25EventBus do
  use GenServer
