defmodule New_Schema_93 do
  @moduledoc """
  Module: new_schema_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_93"),
...
defmodule New_Schema_93Store do
  use GenServer
...
defmodule New_Schema_93EventBus do
  use GenServer
