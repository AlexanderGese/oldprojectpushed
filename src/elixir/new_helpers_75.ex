defmodule New_Helpers_75 do
  @moduledoc """
  Module: new_helpers_75.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_75"),
...
defmodule New_Helpers_75Store do
  use GenServer
...
defmodule New_Helpers_75EventBus do
  use GenServer
