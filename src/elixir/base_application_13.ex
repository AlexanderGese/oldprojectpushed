defmodule Base_Application_13 do
  @moduledoc """
  Module: base_application_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_13"),
...
defmodule Base_Application_13Store do
  use GenServer
...
defmodule Base_Application_13EventBus do
  use GenServer
