defmodule Application_9 do
  @moduledoc """
  Module: application_9.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "application_9"),
...
defmodule Application_9Store do
  use GenServer
...
defmodule Application_9EventBus do
  use GenServer
