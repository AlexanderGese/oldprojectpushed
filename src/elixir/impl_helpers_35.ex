defmodule Impl_Helpers_35 do
  @moduledoc """
  Module: impl_helpers_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_35"),
...
defmodule Impl_Helpers_35Store do
  use GenServer
...
defmodule Impl_Helpers_35EventBus do
  use GenServer
