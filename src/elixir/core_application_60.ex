defmodule Core_Application_60 do
  @moduledoc """
  Module: core_application_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_60"),
...
defmodule Core_Application_60Store do
  use GenServer
...
defmodule Core_Application_60EventBus do
  use GenServer
