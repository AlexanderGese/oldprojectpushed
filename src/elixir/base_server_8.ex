defmodule Base_Server_8 do
  @moduledoc """
  Module: base_server_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_8"),
...
defmodule Base_Server_8Store do
  use GenServer
...
defmodule Base_Server_8EventBus do
  use GenServer
