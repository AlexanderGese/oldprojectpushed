defmodule Core_Server_96 do
  @moduledoc """
  Module: core_server_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_96"),
...
defmodule Core_Server_96Store do
  use GenServer
...
defmodule Core_Server_96EventBus do
  use GenServer
