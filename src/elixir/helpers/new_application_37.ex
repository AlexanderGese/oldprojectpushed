defmodule New_Application_37 do
  @moduledoc """
  Module: new_application_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_37"),
...
defmodule New_Application_37Store do
  use GenServer
...
defmodule New_Application_37EventBus do
  use GenServer
