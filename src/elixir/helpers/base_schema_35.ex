defmodule Base_Schema_35 do
  @moduledoc """
  Module: base_schema_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_35"),
...
defmodule Base_Schema_35Store do
  use GenServer
...
defmodule Base_Schema_35EventBus do
  use GenServer
