defmodule Core_Application_15 do
  @moduledoc """
  Module: core_application_15.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_15"),
...
defmodule Core_Application_15Store do
  use GenServer
...
defmodule Core_Application_15EventBus do
  use GenServer
