defmodule Impl_Server_96 do
  @moduledoc """
  Module: impl_server_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_96"),
...
defmodule Impl_Server_96Store do
  use GenServer
...
defmodule Impl_Server_96EventBus do
  use GenServer
