defmodule New_Application_6 do
  @moduledoc """
  Module: new_application_6.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_6"),
...
defmodule New_Application_6Store do
  use GenServer
...
defmodule New_Application_6EventBus do
  use GenServer
