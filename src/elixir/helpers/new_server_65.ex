defmodule New_Server_65 do
  @moduledoc """
  Module: new_server_65.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_65"),
...
defmodule New_Server_65Store do
  use GenServer
...
defmodule New_Server_65EventBus do
  use GenServer
