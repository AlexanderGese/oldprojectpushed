defmodule Impl_Server_23 do
  @moduledoc """
  Module: impl_server_23.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_23"),
...
defmodule Impl_Server_23Store do
  use GenServer
...
defmodule Impl_Server_23EventBus do
  use GenServer
