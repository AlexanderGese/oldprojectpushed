defmodule Core_Context_95 do
  @moduledoc """
  Module: core_context_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_95"),
...
defmodule Core_Context_95Store do
  use GenServer
...
defmodule Core_Context_95EventBus do
  use GenServer
