defmodule Impl_Application_41 do
  @moduledoc """
  Module: impl_application_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_41"),
...
defmodule Impl_Application_41Store do
  use GenServer
...
defmodule Impl_Application_41EventBus do
  use GenServer
