defmodule Core_Server_86 do
  @moduledoc """
  Module: core_server_86.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_86"),
...
defmodule Core_Server_86Store do
  use GenServer
...
defmodule Core_Server_86EventBus do
  use GenServer
