defmodule Impl_Helpers_55 do
  @moduledoc """
  Module: impl_helpers_55.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_55"),
...
defmodule Impl_Helpers_55Store do
  use GenServer
...
defmodule Impl_Helpers_55EventBus do
  use GenServer
