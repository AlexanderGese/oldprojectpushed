defmodule New_Controller_18 do
  @moduledoc """
  Module: new_controller_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_18"),
...
defmodule New_Controller_18Store do
  use GenServer
...
defmodule New_Controller_18EventBus do
  use GenServer
