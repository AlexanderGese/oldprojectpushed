defmodule Impl_Worker_74 do
  @moduledoc """
  Module: impl_worker_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_74"),
...
defmodule Impl_Worker_74Store do
  use GenServer
...
defmodule Impl_Worker_74EventBus do
  use GenServer
