defmodule New_Schema_25 do
  @moduledoc """
  Module: new_schema_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_25"),
...
defmodule New_Schema_25Store do
  use GenServer
...
defmodule New_Schema_25EventBus do
  use GenServer
