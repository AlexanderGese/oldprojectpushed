defmodule New_Helpers_18 do
  @moduledoc """
  Module: new_helpers_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_18"),
...
defmodule New_Helpers_18Store do
  use GenServer
...
defmodule New_Helpers_18EventBus do
  use GenServer
