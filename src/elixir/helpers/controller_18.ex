defmodule Controller_18 do
  @moduledoc """
  Module: controller_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_18"),
...
defmodule Controller_18Store do
  use GenServer
...
defmodule Controller_18EventBus do
  use GenServer
