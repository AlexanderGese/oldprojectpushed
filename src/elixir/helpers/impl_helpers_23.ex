defmodule Impl_Helpers_23 do
  @moduledoc """
  Module: impl_helpers_23.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_23"),
...
defmodule Impl_Helpers_23Store do
  use GenServer
...
defmodule Impl_Helpers_23EventBus do
  use GenServer
