defmodule Enhanced_Live_91 do
  @moduledoc """
  Module: enhanced_live_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_live_91"),
...
defmodule Enhanced_Live_91Store do
  use GenServer
...
defmodule Enhanced_Live_91EventBus do
  use GenServer
