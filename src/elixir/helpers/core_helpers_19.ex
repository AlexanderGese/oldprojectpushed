defmodule Core_Helpers_19 do
  @moduledoc """
  Module: core_helpers_19.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_19"),
...
defmodule Core_Helpers_19Store do
  use GenServer
...
defmodule Core_Helpers_19EventBus do
  use GenServer
