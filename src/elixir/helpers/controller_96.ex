defmodule Controller_96 do
  @moduledoc """
  Module: controller_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_96"),
...
defmodule Controller_96Store do
  use GenServer
...
defmodule Controller_96EventBus do
  use GenServer
