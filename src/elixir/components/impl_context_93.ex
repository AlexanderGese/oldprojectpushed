defmodule Impl_Context_93 do
  @moduledoc """
  Module: impl_context_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_93"),
...
defmodule Impl_Context_93Store do
  use GenServer
...
defmodule Impl_Context_93EventBus do
  use GenServer
