defmodule Base_Server_87 do
  @moduledoc """
  Module: base_server_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_87"),
...
defmodule Base_Server_87Store do
  use GenServer
...
defmodule Base_Server_87EventBus do
  use GenServer
