defmodule Core_Router_18 do
  @moduledoc """
  Module: core_router_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_18"),
...
defmodule Core_Router_18Store do
  use GenServer
...
defmodule Core_Router_18EventBus do
  use GenServer
