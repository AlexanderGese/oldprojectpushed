defmodule Base_Server_52 do
  @moduledoc """
  Module: base_server_52.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_52"),
...
defmodule Base_Server_52Store do
  use GenServer
...
defmodule Base_Server_52EventBus do
  use GenServer
