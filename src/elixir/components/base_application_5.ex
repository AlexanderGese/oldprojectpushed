defmodule Base_Application_5 do
  @moduledoc """
  Module: base_application_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_5"),
...
defmodule Base_Application_5Store do
  use GenServer
...
defmodule Base_Application_5EventBus do
  use GenServer
