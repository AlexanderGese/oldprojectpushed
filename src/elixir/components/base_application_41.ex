defmodule Base_Application_41 do
  @moduledoc """
  Module: base_application_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_41"),
...
defmodule Base_Application_41Store do
  use GenServer
...
defmodule Base_Application_41EventBus do
  use GenServer
