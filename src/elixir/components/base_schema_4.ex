defmodule Base_Schema_4 do
  @moduledoc """
  Module: base_schema_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_4"),
...
defmodule Base_Schema_4Store do
  use GenServer
...
defmodule Base_Schema_4EventBus do
  use GenServer
