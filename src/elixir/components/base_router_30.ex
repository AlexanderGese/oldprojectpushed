defmodule Base_Router_30 do
  @moduledoc """
  Module: base_router_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_30"),
...
defmodule Base_Router_30Store do
  use GenServer
...
defmodule Base_Router_30EventBus do
  use GenServer
