defmodule Impl_Router_97 do
  @moduledoc """
  Module: impl_router_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_97"),
...
defmodule Impl_Router_97Store do
  use GenServer
...
defmodule Impl_Router_97EventBus do
  use GenServer
