defmodule Base_Context_20 do
  @moduledoc """
  Module: base_context_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_20"),
...
defmodule Base_Context_20Store do
  use GenServer
...
defmodule Base_Context_20EventBus do
  use GenServer
