defmodule New_Controller_52 do
  @moduledoc """
  Module: new_controller_52.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_52"),
...
defmodule New_Controller_52Store do
  use GenServer
...
defmodule New_Controller_52EventBus do
  use GenServer
