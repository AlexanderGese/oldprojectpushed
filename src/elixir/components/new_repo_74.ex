defmodule New_Repo_74 do
  @moduledoc """
  Module: new_repo_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_74"),
...
defmodule New_Repo_74EventBus do
  use GenServer
