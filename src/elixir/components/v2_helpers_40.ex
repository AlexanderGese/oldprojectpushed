defmodule V2_Helpers_40 do
  @moduledoc """
  Module: v2_helpers_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_40"),
...
defmodule V2_Helpers_40Store do
  use GenServer
...
defmodule V2_Helpers_40EventBus do
  use GenServer
