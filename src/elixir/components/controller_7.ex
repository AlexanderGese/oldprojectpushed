defmodule Controller_7 do
  @moduledoc """
  Module: controller_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_7"),
...
defmodule Controller_7Store do
  use GenServer
...
defmodule Controller_7EventBus do
  use GenServer
