defmodule V2_Server_96 do
  @moduledoc """
  Module: v2_server_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_96"),
...
defmodule V2_Server_96Store do
  use GenServer
...
defmodule V2_Server_96EventBus do
  use GenServer
