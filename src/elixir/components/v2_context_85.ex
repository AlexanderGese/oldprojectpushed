defmodule V2_Context_85 do
  @moduledoc """
  Module: v2_context_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_85"),
...
defmodule V2_Context_85Store do
  use GenServer
...
defmodule V2_Context_85EventBus do
  use GenServer
