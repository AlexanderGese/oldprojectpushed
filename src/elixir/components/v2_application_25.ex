defmodule V2_Application_25 do
  @moduledoc """
  Module: v2_application_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_application_25"),
...
defmodule V2_Application_25Store do
  use GenServer
...
defmodule V2_Application_25EventBus do
  use GenServer
