defmodule New_Live_39 do
  @moduledoc """
  Module: new_live_39.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_39"),
...
defmodule New_Live_39EventBus do
  use GenServer
