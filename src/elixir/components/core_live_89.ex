defmodule Core_Live_89 do
  @moduledoc """
  Module: core_live_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_89"),
...
defmodule Core_Live_89Store do
  use GenServer
...
defmodule Core_Live_89EventBus do
  use GenServer
