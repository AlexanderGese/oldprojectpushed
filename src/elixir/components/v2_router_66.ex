defmodule V2_Router_66 do
  @moduledoc """
  Module: v2_router_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_router_66"),
...
defmodule V2_Router_66Store do
  use GenServer
...
defmodule V2_Router_66EventBus do
  use GenServer
