defmodule Base_Worker_74 do
  @moduledoc """
  Module: base_worker_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_74"),
...
defmodule Base_Worker_74Store do
  use GenServer
...
defmodule Base_Worker_74EventBus do
  use GenServer
