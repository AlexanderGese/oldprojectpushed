defmodule Core_Router_20 do
  @moduledoc """
  Module: core_router_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_20"),
...
defmodule Core_Router_20Store do
  use GenServer
...
defmodule Core_Router_20EventBus do
  use GenServer
