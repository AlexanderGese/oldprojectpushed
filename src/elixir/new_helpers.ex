defmodule New_Helpers do
  @moduledoc """
  Module: new_helpers.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers"),
...
defmodule New_HelpersEventBus do
  use GenServer
