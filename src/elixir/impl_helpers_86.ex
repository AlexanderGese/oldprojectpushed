defmodule Impl_Helpers_86 do
  @moduledoc """
  Module: impl_helpers_86.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_86"),
...
defmodule Impl_Helpers_86Store do
  use GenServer
...
defmodule Impl_Helpers_86EventBus do
  use GenServer
