defmodule New_Router_96 do
  @moduledoc """
  Module: new_router_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_96"),
...
defmodule New_Router_96Store do
  use GenServer
...
defmodule New_Router_96EventBus do
  use GenServer
