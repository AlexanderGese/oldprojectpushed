defmodule Base_Controller_36 do
  @moduledoc """
  Module: base_controller_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_36"),
...
defmodule Base_Controller_36Store do
  use GenServer
...
defmodule Base_Controller_36EventBus do
  use GenServer
