...
# Module: enhanced_controllers_16.rb
...
module EnhancedControllers16
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_16")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers16::Application.new
  app.start
end
