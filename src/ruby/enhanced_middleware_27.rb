...
# Module: enhanced_middleware_27.rb
...
module EnhancedMiddleware27
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_27")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware27::Application.new
  app.start
end
