...
# Module: enhanced_middleware_90.rb
...
module EnhancedMiddleware90
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_90")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware90::Application.new
  app.start
end
