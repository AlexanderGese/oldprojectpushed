...
# Module: enhanced_middleware_85.rb
...
module EnhancedMiddleware85
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_85")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware85::Application.new
  app.start
end
