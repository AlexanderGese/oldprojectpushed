...
# Module: enhanced_validators_71.rb
...
module EnhancedValidators71
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_71")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators71::Application.new
  app.start
end
