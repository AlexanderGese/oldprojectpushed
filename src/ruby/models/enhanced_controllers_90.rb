...
# Module: enhanced_controllers_90.rb
...
module EnhancedControllers90
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_90")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers90::Application.new
  app.start
end
