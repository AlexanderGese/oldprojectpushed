...
# Module: enhanced_validators_11.rb
...
module EnhancedValidators11
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_11")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators11::Application.new
  app.start
end
