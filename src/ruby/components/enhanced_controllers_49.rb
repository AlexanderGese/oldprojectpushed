...
# Module: enhanced_controllers_49.rb
...
module EnhancedControllers49
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_49")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers49::Application.new
  app.start
end
