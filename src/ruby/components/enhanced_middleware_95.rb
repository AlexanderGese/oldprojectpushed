...
# Module: enhanced_middleware_95.rb
...
module EnhancedMiddleware95
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_95")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware95::Application.new
  app.start
end
