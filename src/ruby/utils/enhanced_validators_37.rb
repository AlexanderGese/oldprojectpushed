...
# Module: enhanced_validators_37.rb
...
module EnhancedValidators37
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_37")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators37::Application.new
  app.start
end
