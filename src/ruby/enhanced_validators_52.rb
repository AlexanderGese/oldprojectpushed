...
# Module: enhanced_validators_52.rb
...
module EnhancedValidators52
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_52")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators52::Application.new
  app.start
end
