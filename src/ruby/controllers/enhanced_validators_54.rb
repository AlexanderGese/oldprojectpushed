...
# Module: enhanced_validators_54.rb
...
module EnhancedValidators54
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_54")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators54::Application.new
  app.start
end
