...
# Module: enhanced_middleware_61.rb
...
module EnhancedMiddleware61
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_61")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware61::Application.new
  app.start
end
