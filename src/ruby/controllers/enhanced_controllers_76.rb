...
# Module: enhanced_controllers_76.rb
...
module EnhancedControllers76
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_76")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers76::Application.new
  app.start
end
