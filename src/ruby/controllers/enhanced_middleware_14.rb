...
# Module: enhanced_middleware_14.rb
...
module EnhancedMiddleware14
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_14")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware14::Application.new
  app.start
end
