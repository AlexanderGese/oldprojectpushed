...
# Module: enhanced_controllers_67.rb
...
module EnhancedControllers67
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_67")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers67::Application.new
  app.start
end
