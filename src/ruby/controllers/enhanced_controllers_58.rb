...
# Module: enhanced_controllers_58.rb
...
module EnhancedControllers58
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_58")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers58::Application.new
  app.start
end
