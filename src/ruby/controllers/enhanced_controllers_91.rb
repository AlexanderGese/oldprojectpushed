...
# Module: enhanced_controllers_91.rb
...
module EnhancedControllers91
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_91")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers91::Application.new
  app.start
end
