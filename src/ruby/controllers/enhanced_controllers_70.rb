...
# Module: enhanced_controllers_70.rb
...
module EnhancedControllers70
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_70")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers70::Application.new
  app.start
end
