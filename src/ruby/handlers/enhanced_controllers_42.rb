...
# Module: enhanced_controllers_42.rb
...
module EnhancedControllers42
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_42")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers42::Application.new
  app.start
end
