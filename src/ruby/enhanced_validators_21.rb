...
# Module: enhanced_validators_21.rb
...
module EnhancedValidators21
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_21")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators21::Application.new
  app.start
end
