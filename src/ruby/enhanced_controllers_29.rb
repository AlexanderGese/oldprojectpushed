...
# Module: enhanced_controllers_29.rb
...
module EnhancedControllers29
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_29")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers29::Application.new
  app.start
end
