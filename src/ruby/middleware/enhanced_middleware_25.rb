...
# Module: enhanced_middleware_25.rb
...
module EnhancedMiddleware25
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_25")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware25::Application.new
  app.start
end
