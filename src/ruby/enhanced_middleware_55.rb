...
# Module: enhanced_middleware_55.rb
...
module EnhancedMiddleware55
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_55")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware55::Application.new
  app.start
end
