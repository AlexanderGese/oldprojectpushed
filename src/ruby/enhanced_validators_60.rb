...
# Module: enhanced_validators_60.rb
...
module EnhancedValidators60
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_60")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators60::Application.new
  app.start
end
