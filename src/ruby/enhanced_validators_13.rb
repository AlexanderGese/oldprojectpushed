...
# Module: enhanced_validators_13.rb
...
module EnhancedValidators13
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_13")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators13::Application.new
  app.start
end
