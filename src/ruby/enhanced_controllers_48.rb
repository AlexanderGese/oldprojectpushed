...
# Module: enhanced_controllers_48.rb
...
module EnhancedControllers48
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_48")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers48::Application.new
  app.start
end
