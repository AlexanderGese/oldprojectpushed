...
# Module: enhanced_middleware_32.rb
...
module EnhancedMiddleware32
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_32")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware32::Application.new
  app.start
end
