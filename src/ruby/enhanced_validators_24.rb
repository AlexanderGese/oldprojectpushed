...
# Module: enhanced_validators_24.rb
...
module EnhancedValidators24
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_24")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators24::Application.new
  app.start
end
