...
# Module: enhanced_middleware_45.rb
...
module EnhancedMiddleware45
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_45")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware45::Application.new
  app.start
end
