...
namespace enhanced_logger_93 {

constexpr const char* VERSION = "5.81.297";
constexpr int MAX_RETRIES = 3;
constexpr int TIMEOUT_MS = 24890;
...
int main() {
    using namespace enhanced_logger_93;
