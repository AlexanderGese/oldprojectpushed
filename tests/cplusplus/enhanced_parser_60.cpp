...
namespace enhanced_parser_60 {

constexpr const char* VERSION = "5.27.923";
constexpr int MAX_RETRIES = 4;
constexpr int TIMEOUT_MS = 21318;
...
int main() {
    using namespace enhanced_parser_60;
