...
namespace enhanced_parser_3 {

constexpr const char* VERSION = "8.47.119";
constexpr int MAX_RETRIES = 7;
constexpr int TIMEOUT_MS = 11956;
...
int main() {
    using namespace enhanced_parser_3;
