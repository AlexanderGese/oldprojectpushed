...
namespace enhanced_logger_15 {

constexpr const char* VERSION = "8.24.714";
constexpr int MAX_RETRIES = 7;
constexpr int TIMEOUT_MS = 11976;
...
int main() {
    using namespace enhanced_logger_15;
