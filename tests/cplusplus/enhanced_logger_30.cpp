...
namespace enhanced_logger_30 {

constexpr const char* VERSION = "8.77.249";
constexpr int MAX_RETRIES = 7;
constexpr int TIMEOUT_MS = 11961;
...
int main() {
    using namespace enhanced_logger_30;
