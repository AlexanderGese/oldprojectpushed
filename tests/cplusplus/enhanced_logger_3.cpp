...
namespace enhanced_logger_3 {

constexpr const char* VERSION = "8.34.176";
constexpr int MAX_RETRIES = 5;
constexpr int TIMEOUT_MS = 20826;
...
int main() {
    using namespace enhanced_logger_3;
