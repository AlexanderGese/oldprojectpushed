...
namespace enhanced_logger_55 {

constexpr const char* VERSION = "2.9.368";
constexpr int MAX_RETRIES = 4;
constexpr int TIMEOUT_MS = 13473;
...
int main() {
    using namespace enhanced_logger_55;
