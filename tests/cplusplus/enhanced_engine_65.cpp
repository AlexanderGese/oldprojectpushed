...
namespace enhanced_engine_65 {

constexpr const char* VERSION = "5.31.577";
constexpr int MAX_RETRIES = 9;
constexpr int TIMEOUT_MS = 5031;
...
int main() {
    using namespace enhanced_engine_65;
