...
namespace enhanced_parser_13 {

constexpr const char* VERSION = "7.77.263";
constexpr int MAX_RETRIES = 9;
constexpr int TIMEOUT_MS = 22893;
...
int main() {
    using namespace enhanced_parser_13;
