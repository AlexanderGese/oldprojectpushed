...
namespace enhanced_logger_23 {

constexpr const char* VERSION = "5.65.663";
constexpr int MAX_RETRIES = 4;
constexpr int TIMEOUT_MS = 11035;
...
int main() {
    using namespace enhanced_logger_23;
