...
namespace enhanced_parser_95 {

constexpr const char* VERSION = "4.2.433";
constexpr int MAX_RETRIES = 10;
constexpr int TIMEOUT_MS = 9812;
...
int main() {
    using namespace enhanced_parser_95;
