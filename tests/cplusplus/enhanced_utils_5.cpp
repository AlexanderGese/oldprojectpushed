...
namespace enhanced_utils_5 {

constexpr const char* VERSION = "8.99.710";
constexpr int MAX_RETRIES = 7;
constexpr int TIMEOUT_MS = 23376;
...
int main() {
    using namespace enhanced_utils_5;
