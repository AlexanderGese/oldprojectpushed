...
namespace enhanced_engine_11 {

constexpr const char* VERSION = "3.53.186";
constexpr int MAX_RETRIES = 7;
constexpr int TIMEOUT_MS = 22830;
...
int main() {
    using namespace enhanced_engine_11;
