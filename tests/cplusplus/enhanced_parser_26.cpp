...
namespace enhanced_parser_26 {

constexpr const char* VERSION = "5.17.240";
constexpr int MAX_RETRIES = 10;
constexpr int TIMEOUT_MS = 10918;
...
int main() {
    using namespace enhanced_parser_26;
