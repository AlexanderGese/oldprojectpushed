...
namespace enhanced_logger_95 {

constexpr const char* VERSION = "4.90.304";
constexpr int MAX_RETRIES = 8;
constexpr int TIMEOUT_MS = 5414;
...
int main() {
    using namespace enhanced_logger_95;
