...
namespace enhanced_utils_95 {

constexpr const char* VERSION = "3.54.404";
constexpr int MAX_RETRIES = 5;
constexpr int TIMEOUT_MS = 11968;
...
int main() {
    using namespace enhanced_utils_95;
