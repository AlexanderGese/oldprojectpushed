...
# Module: enhanced_validators_39.rb
...
module EnhancedValidators39
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_39")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators39::Application.new
  app.start
end
