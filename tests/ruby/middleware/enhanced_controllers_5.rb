...
# Module: enhanced_controllers_5.rb
...
module EnhancedControllers5
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_5")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers5::Application.new
  app.start
end
