...
# Module: enhanced_validators_12.rb
...
module EnhancedValidators12
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_12")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators12::Application.new
  app.start
end
