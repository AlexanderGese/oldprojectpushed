...
# Module: enhanced_controllers_99.rb
...
module EnhancedControllers99
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_99")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers99::Application.new
  app.start
end
