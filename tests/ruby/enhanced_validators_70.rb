...
# Module: enhanced_validators_70.rb
...
module EnhancedValidators70
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_70")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators70::Application.new
  app.start
end
