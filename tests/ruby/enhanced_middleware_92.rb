...
# Module: enhanced_middleware_92.rb
...
module EnhancedMiddleware92
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_92")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware92::Application.new
  app.start
end
