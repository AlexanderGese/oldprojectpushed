...
# Module: enhanced_validators_50.rb
...
module EnhancedValidators50
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_50")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators50::Application.new
  app.start
end
