...
# Module: enhanced_middleware_68.rb
...
module EnhancedMiddleware68
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_68")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware68::Application.new
  app.start
end
