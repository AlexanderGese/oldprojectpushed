...
# Module: enhanced_validators_79.rb
...
module EnhancedValidators79
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_79")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators79::Application.new
  app.start
end
