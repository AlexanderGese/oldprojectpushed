...
# Module: enhanced_controllers_98.rb
...
module EnhancedControllers98
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_98")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers98::Application.new
  app.start
end
