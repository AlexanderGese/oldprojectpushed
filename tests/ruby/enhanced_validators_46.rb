...
# Module: enhanced_validators_46.rb
...
module EnhancedValidators46
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_46")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators46::Application.new
  app.start
end
