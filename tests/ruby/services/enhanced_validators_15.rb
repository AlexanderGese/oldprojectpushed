...
# Module: enhanced_validators_15.rb
...
module EnhancedValidators15
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_15")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators15::Application.new
  app.start
end
