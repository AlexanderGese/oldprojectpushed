...
# Module: enhanced_middleware_24.rb
...
module EnhancedMiddleware24
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_24")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware24::Application.new
  app.start
end
