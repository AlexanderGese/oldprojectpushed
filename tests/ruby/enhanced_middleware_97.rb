...
# Module: enhanced_middleware_97.rb
...
module EnhancedMiddleware97
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_97")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware97::Application.new
  app.start
end
