...
# Module: enhanced_controllers_41.rb
...
module EnhancedControllers41
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_41")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers41::Application.new
  app.start
end
