...
# Module: enhanced_validators_18.rb
...
module EnhancedValidators18
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_18")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators18::Application.new
  app.start
end
