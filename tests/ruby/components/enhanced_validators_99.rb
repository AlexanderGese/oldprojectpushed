...
# Module: enhanced_validators_99.rb
...
module EnhancedValidators99
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_99")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators99::Application.new
  app.start
end
