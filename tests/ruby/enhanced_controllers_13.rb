...
# Module: enhanced_controllers_13.rb
...
module EnhancedControllers13
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_13")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers13::Application.new
  app.start
end
