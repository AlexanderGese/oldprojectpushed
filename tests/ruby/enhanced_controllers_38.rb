...
# Module: enhanced_controllers_38.rb
...
module EnhancedControllers38
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_38")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers38::Application.new
  app.start
end
