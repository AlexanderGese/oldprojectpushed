...
# Module: enhanced_validators_55.rb
...
module EnhancedValidators55
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_55")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators55::Application.new
  app.start
end
