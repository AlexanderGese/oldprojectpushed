...
# Module: enhanced_middleware_20.rb
...
module EnhancedMiddleware20
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_20")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware20::Application.new
  app.start
end
