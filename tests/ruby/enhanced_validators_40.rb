...
# Module: enhanced_validators_40.rb
...
module EnhancedValidators40
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_40")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators40::Application.new
  app.start
end
