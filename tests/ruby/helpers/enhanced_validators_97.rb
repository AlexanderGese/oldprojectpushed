...
# Module: enhanced_validators_97.rb
...
module EnhancedValidators97
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_97")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators97::Application.new
  app.start
end
