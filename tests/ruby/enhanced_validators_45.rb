...
# Module: enhanced_validators_45.rb
...
module EnhancedValidators45
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_validators_45")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedValidators45::Application.new
  app.start
end
