...
# Module: enhanced_middleware_82.rb
...
module EnhancedMiddleware82
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_82")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware82::Application.new
  app.start
end
