...
# Module: enhanced_middleware_35.rb
...
module EnhancedMiddleware35
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_35")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware35::Application.new
  app.start
end
