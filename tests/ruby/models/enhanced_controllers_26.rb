...
# Module: enhanced_controllers_26.rb
...
module EnhancedControllers26
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_26")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers26::Application.new
  app.start
end
