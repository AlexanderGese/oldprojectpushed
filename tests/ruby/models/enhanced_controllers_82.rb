...
# Module: enhanced_controllers_82.rb
...
module EnhancedControllers82
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_controllers_82")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedControllers82::Application.new
  app.start
end
