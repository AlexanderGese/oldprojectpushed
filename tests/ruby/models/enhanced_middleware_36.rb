...
# Module: enhanced_middleware_36.rb
...
module EnhancedMiddleware36
  ...
  class Config
    ...
    def initialize(opts = {})
      @app_name = opts.fetch(:app_name, "enhanced_middleware_36")
...
if __FILE__ == $PROGRAM_NAME
  app = EnhancedMiddleware36::Application.new
  app.start
end
