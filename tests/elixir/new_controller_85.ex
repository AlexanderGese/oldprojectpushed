defmodule New_Controller_85 do
  @moduledoc """
  Module: new_controller_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_85"),
...
defmodule New_Controller_85Store do
  use GenServer
...
defmodule New_Controller_85EventBus do
  use GenServer
