defmodule New_Schema_94 do
  @moduledoc """
  Module: new_schema_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_94"),
...
defmodule New_Schema_94Store do
  use GenServer
...
defmodule New_Schema_94EventBus do
  use GenServer
