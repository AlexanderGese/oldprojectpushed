defmodule Core_Live_44 do
  @moduledoc """
  Module: core_live_44.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_44"),
...
defmodule Core_Live_44Store do
  use GenServer
...
defmodule Core_Live_44EventBus do
  use GenServer
