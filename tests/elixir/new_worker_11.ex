defmodule New_Worker_11 do
  @moduledoc """
  Module: new_worker_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_11"),
...
defmodule New_Worker_11Store do
  use GenServer
...
defmodule New_Worker_11EventBus do
  use GenServer
