defmodule Core_Server_66 do
  @moduledoc """
  Module: core_server_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_66"),
...
defmodule Core_Server_66Store do
  use GenServer
...
defmodule Core_Server_66EventBus do
  use GenServer
