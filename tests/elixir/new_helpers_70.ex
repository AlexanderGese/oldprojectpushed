defmodule New_Helpers_70 do
  @moduledoc """
  Module: new_helpers_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_70"),
...
defmodule New_Helpers_70Store do
  use GenServer
...
defmodule New_Helpers_70EventBus do
  use GenServer
