defmodule New_Application_24 do
  @moduledoc """
  Module: new_application_24.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_24"),
...
defmodule New_Application_24Store do
  use GenServer
...
defmodule New_Application_24EventBus do
  use GenServer
