defmodule Base_Server_91 do
  @moduledoc """
  Module: base_server_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_91"),
...
defmodule Base_Server_91Store do
  use GenServer
...
defmodule Base_Server_91EventBus do
  use GenServer
