defmodule Impl_Helpers_98 do
  @moduledoc """
  Module: impl_helpers_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_98"),
...
defmodule Impl_Helpers_98Store do
  use GenServer
...
defmodule Impl_Helpers_98EventBus do
  use GenServer
