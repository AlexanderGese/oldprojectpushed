defmodule New_Server_82 do
  @moduledoc """
  Module: new_server_82.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_82"),
...
defmodule New_Server_82Store do
  use GenServer
...
defmodule New_Server_82EventBus do
  use GenServer
