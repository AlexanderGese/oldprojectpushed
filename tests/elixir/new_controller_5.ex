defmodule New_Controller_5 do
  @moduledoc """
  Module: new_controller_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_5"),
...
defmodule New_Controller_5Store do
  use GenServer
...
defmodule New_Controller_5EventBus do
  use GenServer
