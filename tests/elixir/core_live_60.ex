defmodule Core_Live_60 do
  @moduledoc """
  Module: core_live_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_60"),
...
defmodule Core_Live_60Store do
  use GenServer
...
defmodule Core_Live_60EventBus do
  use GenServer
