defmodule Base_Application_90 do
  @moduledoc """
  Module: base_application_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_90"),
...
defmodule Base_Application_90Store do
  use GenServer
...
defmodule Base_Application_90EventBus do
  use GenServer
