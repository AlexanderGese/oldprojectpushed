defmodule Base_Schema_12 do
  @moduledoc """
  Module: base_schema_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_12"),
...
defmodule Base_Schema_12Store do
  use GenServer
...
defmodule Base_Schema_12EventBus do
  use GenServer
