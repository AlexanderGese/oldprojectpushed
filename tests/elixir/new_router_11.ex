defmodule New_Router_11 do
  @moduledoc """
  Module: new_router_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_11"),
...
defmodule New_Router_11Store do
  use GenServer
...
defmodule New_Router_11EventBus do
  use GenServer
