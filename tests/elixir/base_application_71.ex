defmodule Base_Application_71 do
  @moduledoc """
  Module: base_application_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_71"),
...
defmodule Base_Application_71Store do
  use GenServer
...
defmodule Base_Application_71EventBus do
  use GenServer
