defmodule Base_Application_15 do
  @moduledoc """
  Module: base_application_15.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_15"),
...
defmodule Base_Application_15Store do
  use GenServer
...
defmodule Base_Application_15EventBus do
  use GenServer
