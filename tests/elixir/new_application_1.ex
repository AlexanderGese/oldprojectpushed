defmodule New_Application_1 do
  @moduledoc """
  Module: new_application_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_1"),
...
defmodule New_Application_1Store do
  use GenServer
...
defmodule New_Application_1EventBus do
  use GenServer
