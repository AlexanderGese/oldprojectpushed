defmodule Core_Worker_35 do
  @moduledoc """
  Module: core_worker_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_35"),
...
defmodule Core_Worker_35Store do
  use GenServer
...
defmodule Core_Worker_35EventBus do
  use GenServer
