defmodule New_Schema_22 do
  @moduledoc """
  Module: new_schema_22.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_22"),
...
defmodule New_Schema_22Store do
  use GenServer
...
defmodule New_Schema_22EventBus do
  use GenServer
