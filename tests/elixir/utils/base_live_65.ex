defmodule Base_Live_65 do
  @moduledoc """
  Module: base_live_65.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_65"),
...
defmodule Base_Live_65Store do
  use GenServer
...
defmodule Base_Live_65EventBus do
  use GenServer
