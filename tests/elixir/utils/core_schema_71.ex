defmodule Core_Schema_71 do
  @moduledoc """
  Module: core_schema_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_71"),
...
defmodule Core_Schema_71Store do
  use GenServer
...
defmodule Core_Schema_71EventBus do
  use GenServer
