defmodule Core_Schema_56 do
  @moduledoc """
  Module: core_schema_56.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_56"),
...
defmodule Core_Schema_56Store do
  use GenServer
...
defmodule Core_Schema_56EventBus do
  use GenServer
