defmodule New_Application_26 do
  @moduledoc """
  Module: new_application_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_26"),
...
defmodule New_Application_26Store do
  use GenServer
...
defmodule New_Application_26EventBus do
  use GenServer
