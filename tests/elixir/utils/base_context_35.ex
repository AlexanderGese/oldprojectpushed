defmodule Base_Context_35 do
  @moduledoc """
  Module: base_context_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_35"),
...
defmodule Base_Context_35Store do
  use GenServer
...
defmodule Base_Context_35EventBus do
  use GenServer
