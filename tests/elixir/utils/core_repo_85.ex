defmodule Core_Repo_85 do
  @moduledoc """
  Module: core_repo_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_85"),
...
defmodule Core_Repo_85Store do
  use GenServer
...
defmodule Core_Repo_85EventBus do
  use GenServer
