defmodule Impl_Context_3 do
  @moduledoc """
  Module: impl_context_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_3"),
...
defmodule Impl_Context_3Store do
  use GenServer
...
defmodule Impl_Context_3EventBus do
  use GenServer
