defmodule Base_Worker_53 do
  @moduledoc """
  Module: base_worker_53.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_53"),
...
defmodule Base_Worker_53Store do
  use GenServer
...
defmodule Base_Worker_53EventBus do
  use GenServer
