defmodule Impl_Router_2 do
  @moduledoc """
  Module: impl_router_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_2"),
...
defmodule Impl_Router_2Store do
  use GenServer
...
defmodule Impl_Router_2EventBus do
  use GenServer
