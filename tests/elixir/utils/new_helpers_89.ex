defmodule New_Helpers_89 do
  @moduledoc """
  Module: new_helpers_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_89"),
...
defmodule New_Helpers_89Store do
  use GenServer
...
defmodule New_Helpers_89EventBus do
  use GenServer
