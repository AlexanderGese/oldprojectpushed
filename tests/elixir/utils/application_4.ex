defmodule Application_4 do
  @moduledoc """
  Module: application_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "application_4"),
...
defmodule Application_4Store do
  use GenServer
...
defmodule Application_4EventBus do
  use GenServer
