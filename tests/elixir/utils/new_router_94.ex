defmodule New_Router_94 do
  @moduledoc """
  Module: new_router_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_94"),
...
defmodule New_Router_94Store do
  use GenServer
...
defmodule New_Router_94EventBus do
  use GenServer
