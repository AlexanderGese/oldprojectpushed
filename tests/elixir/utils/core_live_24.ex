defmodule Core_Live_24 do
  @moduledoc """
  Module: core_live_24.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_24"),
...
defmodule Core_Live_24Store do
  use GenServer
...
defmodule Core_Live_24EventBus do
  use GenServer
