defmodule Impl_Live_31 do
  @moduledoc """
  Module: impl_live_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_31"),
...
defmodule Impl_Live_31Store do
  use GenServer
...
defmodule Impl_Live_31EventBus do
  use GenServer
