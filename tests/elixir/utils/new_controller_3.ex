defmodule New_Controller_3 do
  @moduledoc """
  Module: new_controller_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_3"),
...
defmodule New_Controller_3Store do
  use GenServer
...
defmodule New_Controller_3EventBus do
  use GenServer
