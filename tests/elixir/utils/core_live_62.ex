defmodule Core_Live_62 do
  @moduledoc """
  Module: core_live_62.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_62"),
...
defmodule Core_Live_62Store do
  use GenServer
...
defmodule Core_Live_62EventBus do
  use GenServer
