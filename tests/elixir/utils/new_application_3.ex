defmodule New_Application_3 do
  @moduledoc """
  Module: new_application_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_3"),
...
defmodule New_Application_3Store do
  use GenServer
...
defmodule New_Application_3EventBus do
  use GenServer
