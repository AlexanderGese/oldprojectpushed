defmodule Core_Controller_28 do
  @moduledoc """
  Module: core_controller_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_28"),
...
defmodule Core_Controller_28Store do
  use GenServer
...
defmodule Core_Controller_28EventBus do
  use GenServer
