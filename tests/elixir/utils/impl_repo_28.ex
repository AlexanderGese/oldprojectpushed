defmodule Impl_Repo_28 do
  @moduledoc """
  Module: impl_repo_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_28"),
...
defmodule Impl_Repo_28Store do
  use GenServer
...
defmodule Impl_Repo_28EventBus do
  use GenServer
