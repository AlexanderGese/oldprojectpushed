defmodule New_Controller_20 do
  @moduledoc """
  Module: new_controller_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_20"),
...
defmodule New_Controller_20Store do
  use GenServer
...
defmodule New_Controller_20EventBus do
  use GenServer
