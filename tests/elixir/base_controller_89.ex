defmodule Base_Controller_89 do
  @moduledoc """
  Module: base_controller_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_89"),
...
defmodule Base_Controller_89Store do
  use GenServer
...
defmodule Base_Controller_89EventBus do
  use GenServer
