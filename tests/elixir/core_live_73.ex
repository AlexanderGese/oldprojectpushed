defmodule Core_Live_73 do
  @moduledoc """
  Module: core_live_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_73"),
...
defmodule Core_Live_73Store do
  use GenServer
...
defmodule Core_Live_73EventBus do
  use GenServer
