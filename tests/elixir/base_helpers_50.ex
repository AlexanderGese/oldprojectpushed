defmodule Base_Helpers_50 do
  @moduledoc """
  Module: base_helpers_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_50"),
...
defmodule Base_Helpers_50Store do
  use GenServer
...
defmodule Base_Helpers_50EventBus do
  use GenServer
