defmodule Impl_Application_90 do
  @moduledoc """
  Module: impl_application_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_90"),
...
defmodule Impl_Application_90Store do
  use GenServer
...
defmodule Impl_Application_90EventBus do
  use GenServer
