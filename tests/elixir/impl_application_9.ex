defmodule Impl_Application_9 do
  @moduledoc """
  Module: impl_application_9.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_9"),
...
defmodule Impl_Application_9Store do
  use GenServer
...
defmodule Impl_Application_9EventBus do
  use GenServer
