defmodule New_Application_12 do
  @moduledoc """
  Module: new_application_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_12"),
...
defmodule New_Application_12Store do
  use GenServer
...
defmodule New_Application_12EventBus do
  use GenServer
