defmodule New_Helpers_98 do
  @moduledoc """
  Module: new_helpers_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_98"),
...
defmodule New_Helpers_98Store do
  use GenServer
...
defmodule New_Helpers_98EventBus do
  use GenServer
