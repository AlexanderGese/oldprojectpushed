defmodule Core_Schema_14 do
  @moduledoc """
  Module: core_schema_14.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_14"),
...
defmodule Core_Schema_14Store do
  use GenServer
...
defmodule Core_Schema_14EventBus do
  use GenServer
