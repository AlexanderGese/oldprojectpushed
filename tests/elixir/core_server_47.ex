defmodule Core_Server_47 do
  @moduledoc """
  Module: core_server_47.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_47"),
...
defmodule Core_Server_47Store do
  use GenServer
...
defmodule Core_Server_47EventBus do
  use GenServer
