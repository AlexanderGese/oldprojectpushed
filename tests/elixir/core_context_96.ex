defmodule Core_Context_96 do
  @moduledoc """
  Module: core_context_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_96"),
...
defmodule Core_Context_96Store do
  use GenServer
...
defmodule Core_Context_96EventBus do
  use GenServer
