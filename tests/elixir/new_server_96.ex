defmodule New_Server_96 do
  @moduledoc """
  Module: new_server_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_96"),
...
defmodule New_Server_96Store do
  use GenServer
...
defmodule New_Server_96EventBus do
  use GenServer
