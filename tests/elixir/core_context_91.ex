defmodule Core_Context_91 do
  @moduledoc """
  Module: core_context_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_91"),
...
defmodule Core_Context_91Store do
  use GenServer
...
defmodule Core_Context_91EventBus do
  use GenServer
