defmodule New_Schema_34 do
  @moduledoc """
  Module: new_schema_34.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_34"),
...
defmodule New_Schema_34Store do
  use GenServer
...
defmodule New_Schema_34EventBus do
  use GenServer
