defmodule Impl_Live_1 do
  @moduledoc """
  Module: impl_live_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_1"),
...
defmodule Impl_Live_1EventBus do
  use GenServer
