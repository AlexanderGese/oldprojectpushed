defmodule Base_Repo_61 do
  @moduledoc """
  Module: base_repo_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_61"),
...
defmodule Base_Repo_61Store do
  use GenServer
...
defmodule Base_Repo_61EventBus do
  use GenServer
