defmodule New_Context_19 do
  @moduledoc """
  Module: new_context_19.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_19"),
...
defmodule New_Context_19Store do
  use GenServer
...
defmodule New_Context_19EventBus do
  use GenServer
