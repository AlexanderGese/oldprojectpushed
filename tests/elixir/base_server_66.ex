defmodule Base_Server_66 do
  @moduledoc """
  Module: base_server_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_66"),
...
defmodule Base_Server_66Store do
  use GenServer
...
defmodule Base_Server_66EventBus do
  use GenServer
