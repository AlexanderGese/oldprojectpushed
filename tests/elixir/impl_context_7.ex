defmodule Impl_Context_7 do
  @moduledoc """
  Module: impl_context_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_7"),
...
defmodule Impl_Context_7Store do
  use GenServer
...
defmodule Impl_Context_7EventBus do
  use GenServer
