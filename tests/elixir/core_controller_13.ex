defmodule Core_Controller_13 do
  @moduledoc """
  Module: core_controller_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_13"),
...
defmodule Core_Controller_13Store do
  use GenServer
...
defmodule Core_Controller_13EventBus do
  use GenServer
