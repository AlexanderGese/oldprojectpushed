defmodule Base_Router_4 do
  @moduledoc """
  Module: base_router_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_4"),
...
defmodule Base_Router_4Store do
  use GenServer
...
defmodule Base_Router_4EventBus do
  use GenServer
