defmodule Base_Server_98 do
  @moduledoc """
  Module: base_server_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_98"),
...
defmodule Base_Server_98Store do
  use GenServer
...
defmodule Base_Server_98EventBus do
  use GenServer
