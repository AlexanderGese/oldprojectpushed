defmodule New_Server_72 do
  @moduledoc """
  Module: new_server_72.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_72"),
...
defmodule New_Server_72Store do
  use GenServer
...
defmodule New_Server_72EventBus do
  use GenServer
