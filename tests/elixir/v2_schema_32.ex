defmodule V2_Schema_32 do
  @moduledoc """
  Module: v2_schema_32.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_32"),
...
defmodule V2_Schema_32Store do
  use GenServer
...
defmodule V2_Schema_32EventBus do
  use GenServer
