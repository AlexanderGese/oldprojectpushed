defmodule Base_Helpers_74 do
  @moduledoc """
  Module: base_helpers_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_74"),
...
defmodule Base_Helpers_74Store do
  use GenServer
...
defmodule Base_Helpers_74EventBus do
  use GenServer
