defmodule Base_Controller_91 do
  @moduledoc """
  Module: base_controller_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_91"),
...
defmodule Base_Controller_91Store do
  use GenServer
...
defmodule Base_Controller_91EventBus do
  use GenServer
