defmodule New_Context_1 do
  @moduledoc """
  Module: new_context_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_1"),
...
defmodule New_Context_1Store do
  use GenServer
...
defmodule New_Context_1EventBus do
  use GenServer
