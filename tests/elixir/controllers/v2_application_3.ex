defmodule V2_Application_3 do
  @moduledoc """
  Module: v2_application_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_application_3"),
...
defmodule V2_Application_3Store do
  use GenServer
...
defmodule V2_Application_3EventBus do
  use GenServer
