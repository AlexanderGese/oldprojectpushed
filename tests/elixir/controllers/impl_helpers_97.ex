defmodule Impl_Helpers_97 do
  @moduledoc """
  Module: impl_helpers_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_97"),
...
defmodule Impl_Helpers_97Store do
  use GenServer
...
defmodule Impl_Helpers_97EventBus do
  use GenServer
