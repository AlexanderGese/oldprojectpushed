defmodule V2_Router_61 do
  @moduledoc """
  Module: v2_router_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_router_61"),
...
defmodule V2_Router_61Store do
  use GenServer
...
defmodule V2_Router_61EventBus do
  use GenServer
