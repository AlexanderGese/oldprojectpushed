defmodule New_Live_74 do
  @moduledoc """
  Module: new_live_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_74"),
...
defmodule New_Live_74EventBus do
  use GenServer
