defmodule Core_Helpers_31 do
  @moduledoc """
  Module: core_helpers_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_31"),
...
defmodule Core_Helpers_31Store do
  use GenServer
...
defmodule Core_Helpers_31EventBus do
  use GenServer
