defmodule V2_Worker_3 do
  @moduledoc """
  Module: v2_worker_3.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_worker_3"),
...
defmodule V2_Worker_3EventBus do
  use GenServer
