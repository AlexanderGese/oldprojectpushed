defmodule Base_Helpers_72 do
  @moduledoc """
  Module: base_helpers_72.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_72"),
...
defmodule Base_Helpers_72Store do
  use GenServer
...
defmodule Base_Helpers_72EventBus do
  use GenServer
