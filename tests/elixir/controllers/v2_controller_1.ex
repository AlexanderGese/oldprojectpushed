defmodule V2_Controller_1 do
  @moduledoc """
  Module: v2_controller_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_controller_1"),
...
defmodule V2_Controller_1Store do
  use GenServer
...
defmodule V2_Controller_1EventBus do
  use GenServer
