defmodule Impl_Live_29 do
  @moduledoc """
  Module: impl_live_29.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_29"),
...
defmodule Impl_Live_29Store do
  use GenServer
...
defmodule Impl_Live_29EventBus do
  use GenServer
