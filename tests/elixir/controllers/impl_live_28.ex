defmodule Impl_Live_28 do
  @moduledoc """
  Module: impl_live_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_28"),
...
defmodule Impl_Live_28Store do
  use GenServer
...
defmodule Impl_Live_28EventBus do
  use GenServer
