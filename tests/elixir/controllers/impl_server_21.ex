defmodule Impl_Server_21 do
  @moduledoc """
  Module: impl_server_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_21"),
...
defmodule Impl_Server_21Store do
  use GenServer
...
defmodule Impl_Server_21EventBus do
  use GenServer
