defmodule Core_Context_30 do
  @moduledoc """
  Module: core_context_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_30"),
...
defmodule Core_Context_30Store do
  use GenServer
...
defmodule Core_Context_30EventBus do
  use GenServer
