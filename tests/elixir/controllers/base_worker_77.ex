defmodule Base_Worker_77 do
  @moduledoc """
  Module: base_worker_77.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_77"),
...
defmodule Base_Worker_77Store do
  use GenServer
...
defmodule Base_Worker_77EventBus do
  use GenServer
