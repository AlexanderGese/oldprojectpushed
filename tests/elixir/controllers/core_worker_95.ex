defmodule Core_Worker_95 do
  @moduledoc """
  Module: core_worker_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_95"),
...
defmodule Core_Worker_95Store do
  use GenServer
...
defmodule Core_Worker_95EventBus do
  use GenServer
