defmodule Impl_Router_21 do
  @moduledoc """
  Module: impl_router_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_21"),
...
defmodule Impl_Router_21Store do
  use GenServer
...
defmodule Impl_Router_21EventBus do
  use GenServer
