defmodule Core_Controller_91 do
  @moduledoc """
  Module: core_controller_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_91"),
...
defmodule Core_Controller_91Store do
  use GenServer
...
defmodule Core_Controller_91EventBus do
  use GenServer
