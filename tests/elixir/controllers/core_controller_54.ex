defmodule Core_Controller_54 do
  @moduledoc """
  Module: core_controller_54.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_54"),
...
defmodule Core_Controller_54Store do
  use GenServer
...
defmodule Core_Controller_54EventBus do
  use GenServer
