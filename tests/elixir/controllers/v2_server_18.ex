defmodule V2_Server_18 do
  @moduledoc """
  Module: v2_server_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_18"),
...
defmodule V2_Server_18Store do
  use GenServer
...
defmodule V2_Server_18EventBus do
  use GenServer
