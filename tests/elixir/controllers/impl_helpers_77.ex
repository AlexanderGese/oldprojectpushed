defmodule Impl_Helpers_77 do
  @moduledoc """
  Module: impl_helpers_77.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_77"),
...
defmodule Impl_Helpers_77Store do
  use GenServer
...
defmodule Impl_Helpers_77EventBus do
  use GenServer
