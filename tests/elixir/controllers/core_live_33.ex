defmodule Core_Live_33 do
  @moduledoc """
  Module: core_live_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_33"),
...
defmodule Core_Live_33Store do
  use GenServer
...
defmodule Core_Live_33EventBus do
  use GenServer
