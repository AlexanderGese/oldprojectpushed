defmodule Base_Controller_62 do
  @moduledoc """
  Module: base_controller_62.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_62"),
...
defmodule Base_Controller_62Store do
  use GenServer
...
defmodule Base_Controller_62EventBus do
  use GenServer
