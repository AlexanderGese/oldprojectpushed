defmodule Core_Schema_90 do
  @moduledoc """
  Module: core_schema_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_90"),
...
defmodule Core_Schema_90Store do
  use GenServer
...
defmodule Core_Schema_90EventBus do
  use GenServer
