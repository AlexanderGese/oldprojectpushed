defmodule Base_Live_77 do
  @moduledoc """
  Module: base_live_77.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_77"),
...
defmodule Base_Live_77Store do
  use GenServer
...
defmodule Base_Live_77EventBus do
  use GenServer
