defmodule Impl_Helpers_94 do
  @moduledoc """
  Module: impl_helpers_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_94"),
...
defmodule Impl_Helpers_94Store do
  use GenServer
...
defmodule Impl_Helpers_94EventBus do
  use GenServer
