defmodule New_Server_9 do
  @moduledoc """
  Module: new_server_9.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_9"),
...
defmodule New_Server_9Store do
  use GenServer
...
defmodule New_Server_9EventBus do
  use GenServer
