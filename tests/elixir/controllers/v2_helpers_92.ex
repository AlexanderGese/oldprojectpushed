defmodule V2_Helpers_92 do
  @moduledoc """
  Module: v2_helpers_92.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_92"),
...
defmodule V2_Helpers_92Store do
  use GenServer
...
defmodule V2_Helpers_92EventBus do
  use GenServer
