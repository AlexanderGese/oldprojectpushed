defmodule Impl_Worker_9 do
  @moduledoc """
  Module: impl_worker_9.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_9"),
...
defmodule Impl_Worker_9Store do
  use GenServer
...
defmodule Impl_Worker_9EventBus do
  use GenServer
