defmodule Core_Worker_50 do
  @moduledoc """
  Module: core_worker_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_50"),
...
defmodule Core_Worker_50Store do
  use GenServer
...
defmodule Core_Worker_50EventBus do
  use GenServer
