defmodule Core_Schema_73 do
  @moduledoc """
  Module: core_schema_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_73"),
...
defmodule Core_Schema_73Store do
  use GenServer
...
defmodule Core_Schema_73EventBus do
  use GenServer
