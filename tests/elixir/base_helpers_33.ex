defmodule Base_Helpers_33 do
  @moduledoc """
  Module: base_helpers_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_33"),
...
defmodule Base_Helpers_33Store do
  use GenServer
...
defmodule Base_Helpers_33EventBus do
  use GenServer
