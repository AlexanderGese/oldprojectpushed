defmodule Impl_Server_25 do
  @moduledoc """
  Module: impl_server_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_25"),
...
defmodule Impl_Server_25Store do
  use GenServer
...
defmodule Impl_Server_25EventBus do
  use GenServer
