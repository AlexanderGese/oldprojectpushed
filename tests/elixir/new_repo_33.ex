defmodule New_Repo_33 do
  @moduledoc """
  Module: new_repo_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_33"),
...
defmodule New_Repo_33EventBus do
  use GenServer
