defmodule Impl_Helpers_10 do
  @moduledoc """
  Module: impl_helpers_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_10"),
...
defmodule Impl_Helpers_10Store do
  use GenServer
...
defmodule Impl_Helpers_10EventBus do
  use GenServer
