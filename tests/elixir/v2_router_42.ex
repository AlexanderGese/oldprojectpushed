defmodule V2_Router_42 do
  @moduledoc """
  Module: v2_router_42.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_router_42"),
...
defmodule V2_Router_42Store do
  use GenServer
...
defmodule V2_Router_42EventBus do
  use GenServer
