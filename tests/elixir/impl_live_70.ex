defmodule Impl_Live_70 do
  @moduledoc """
  Module: impl_live_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_70"),
...
defmodule Impl_Live_70Store do
  use GenServer
...
defmodule Impl_Live_70EventBus do
  use GenServer
