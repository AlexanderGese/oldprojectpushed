defmodule Impl_Server_30 do
  @moduledoc """
  Module: impl_server_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_30"),
...
defmodule Impl_Server_30Store do
  use GenServer
...
defmodule Impl_Server_30EventBus do
  use GenServer
