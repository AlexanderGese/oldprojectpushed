defmodule Impl_Live_48 do
  @moduledoc """
  Module: impl_live_48.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_48"),
...
defmodule Impl_Live_48Store do
  use GenServer
...
defmodule Impl_Live_48EventBus do
  use GenServer
