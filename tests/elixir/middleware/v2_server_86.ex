defmodule V2_Server_86 do
  @moduledoc """
  Module: v2_server_86.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_86"),
...
defmodule V2_Server_86Store do
  use GenServer
...
defmodule V2_Server_86EventBus do
  use GenServer
