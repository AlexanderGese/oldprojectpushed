defmodule V2_Helpers_6 do
  @moduledoc """
  Module: v2_helpers_6.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_6"),
...
defmodule V2_Helpers_6Store do
  use GenServer
...
defmodule V2_Helpers_6EventBus do
  use GenServer
