defmodule Core_Worker_31 do
  @moduledoc """
  Module: core_worker_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_31"),
...
defmodule Core_Worker_31Store do
  use GenServer
...
defmodule Core_Worker_31EventBus do
  use GenServer
