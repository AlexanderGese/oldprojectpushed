defmodule Base_Application_17 do
  @moduledoc """
  Module: base_application_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_17"),
...
defmodule Base_Application_17Store do
  use GenServer
...
defmodule Base_Application_17EventBus do
  use GenServer
