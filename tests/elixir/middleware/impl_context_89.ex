defmodule Impl_Context_89 do
  @moduledoc """
  Module: impl_context_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_89"),
...
defmodule Impl_Context_89Store do
  use GenServer
...
defmodule Impl_Context_89EventBus do
  use GenServer
