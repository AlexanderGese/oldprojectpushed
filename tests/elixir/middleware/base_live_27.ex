defmodule Base_Live_27 do
  @moduledoc """
  Module: base_live_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_27"),
...
defmodule Base_Live_27Store do
  use GenServer
...
defmodule Base_Live_27EventBus do
  use GenServer
