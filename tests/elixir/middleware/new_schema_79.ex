defmodule New_Schema_79 do
  @moduledoc """
  Module: new_schema_79.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_79"),
...
defmodule New_Schema_79Store do
  use GenServer
...
defmodule New_Schema_79EventBus do
  use GenServer
