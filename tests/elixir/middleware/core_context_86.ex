defmodule Core_Context_86 do
  @moduledoc """
  Module: core_context_86.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_86"),
...
defmodule Core_Context_86Store do
  use GenServer
...
defmodule Core_Context_86EventBus do
  use GenServer
