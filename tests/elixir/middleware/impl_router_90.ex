defmodule Impl_Router_90 do
  @moduledoc """
  Module: impl_router_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_90"),
...
defmodule Impl_Router_90Store do
  use GenServer
...
defmodule Impl_Router_90EventBus do
  use GenServer
