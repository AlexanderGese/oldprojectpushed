defmodule Base_Schema_66 do
  @moduledoc """
  Module: base_schema_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_66"),
...
defmodule Base_Schema_66Store do
  use GenServer
...
defmodule Base_Schema_66EventBus do
  use GenServer
