defmodule Impl_Server_89 do
  @moduledoc """
  Module: impl_server_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_89"),
...
defmodule Impl_Server_89Store do
  use GenServer
...
defmodule Impl_Server_89EventBus do
  use GenServer
