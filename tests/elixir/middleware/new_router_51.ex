defmodule New_Router_51 do
  @moduledoc """
  Module: new_router_51.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_51"),
...
defmodule New_Router_51Store do
  use GenServer
...
defmodule New_Router_51EventBus do
  use GenServer
