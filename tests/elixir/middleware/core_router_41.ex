defmodule Core_Router_41 do
  @moduledoc """
  Module: core_router_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_41"),
...
defmodule Core_Router_41Store do
  use GenServer
...
defmodule Core_Router_41EventBus do
  use GenServer
