defmodule New_Application_36 do
  @moduledoc """
  Module: new_application_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_36"),
...
defmodule New_Application_36Store do
  use GenServer
...
defmodule New_Application_36EventBus do
  use GenServer
