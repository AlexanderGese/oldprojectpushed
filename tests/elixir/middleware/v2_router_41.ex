defmodule V2_Router_41 do
  @moduledoc """
  Module: v2_router_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_router_41"),
...
defmodule V2_Router_41Store do
  use GenServer
...
defmodule V2_Router_41EventBus do
  use GenServer
