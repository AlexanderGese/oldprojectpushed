defmodule V2_Server_26 do
  @moduledoc """
  Module: v2_server_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_26"),
...
defmodule V2_Server_26Store do
  use GenServer
...
defmodule V2_Server_26EventBus do
  use GenServer
