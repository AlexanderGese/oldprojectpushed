defmodule Core_Context_13 do
  @moduledoc """
  Module: core_context_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_13"),
...
defmodule Core_Context_13Store do
  use GenServer
...
defmodule Core_Context_13EventBus do
  use GenServer
