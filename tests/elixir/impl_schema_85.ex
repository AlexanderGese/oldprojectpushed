defmodule Impl_Schema_85 do
  @moduledoc """
  Module: impl_schema_85.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_85"),
...
defmodule Impl_Schema_85Store do
  use GenServer
...
defmodule Impl_Schema_85EventBus do
  use GenServer
