defmodule Base_Repo_5 do
  @moduledoc """
  Module: base_repo_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_5"),
...
defmodule Base_Repo_5EventBus do
  use GenServer
