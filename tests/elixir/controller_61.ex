defmodule Controller_61 do
  @moduledoc """
  Module: controller_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_61"),
...
defmodule Controller_61Store do
  use GenServer
...
defmodule Controller_61EventBus do
  use GenServer
