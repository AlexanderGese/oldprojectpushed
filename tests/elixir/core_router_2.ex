defmodule Core_Router_2 do
  @moduledoc """
  Module: core_router_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_2"),
...
defmodule Core_Router_2Store do
  use GenServer
...
defmodule Core_Router_2EventBus do
  use GenServer
