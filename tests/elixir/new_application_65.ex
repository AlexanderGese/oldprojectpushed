defmodule New_Application_65 do
  @moduledoc """
  Module: new_application_65.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_65"),
...
defmodule New_Application_65Store do
  use GenServer
...
defmodule New_Application_65EventBus do
  use GenServer
