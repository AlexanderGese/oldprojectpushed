defmodule Impl_Live_36 do
  @moduledoc """
  Module: impl_live_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_36"),
...
defmodule Impl_Live_36Store do
  use GenServer
...
defmodule Impl_Live_36EventBus do
  use GenServer
