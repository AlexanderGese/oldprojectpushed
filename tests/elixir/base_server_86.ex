defmodule Base_Server_86 do
  @moduledoc """
  Module: base_server_86.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_86"),
...
defmodule Base_Server_86Store do
  use GenServer
...
defmodule Base_Server_86EventBus do
  use GenServer
