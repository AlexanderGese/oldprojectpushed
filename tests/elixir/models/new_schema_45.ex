defmodule New_Schema_45 do
  @moduledoc """
  Module: new_schema_45.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_45"),
...
defmodule New_Schema_45Store do
  use GenServer
...
defmodule New_Schema_45EventBus do
  use GenServer
