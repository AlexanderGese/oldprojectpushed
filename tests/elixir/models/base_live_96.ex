defmodule Base_Live_96 do
  @moduledoc """
  Module: base_live_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_96"),
...
defmodule Base_Live_96Store do
  use GenServer
...
defmodule Base_Live_96EventBus do
  use GenServer
