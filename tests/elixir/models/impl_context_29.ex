defmodule Impl_Context_29 do
  @moduledoc """
  Module: impl_context_29.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_29"),
...
defmodule Impl_Context_29Store do
  use GenServer
...
defmodule Impl_Context_29EventBus do
  use GenServer
