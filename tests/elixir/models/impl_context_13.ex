defmodule Impl_Context_13 do
  @moduledoc """
  Module: impl_context_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_13"),
...
defmodule Impl_Context_13Store do
  use GenServer
...
defmodule Impl_Context_13EventBus do
  use GenServer
