defmodule Core_Context_22 do
  @moduledoc """
  Module: core_context_22.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_22"),
...
defmodule Core_Context_22Store do
  use GenServer
...
defmodule Core_Context_22EventBus do
  use GenServer
