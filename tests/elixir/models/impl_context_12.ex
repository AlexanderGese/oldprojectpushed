defmodule Impl_Context_12 do
  @moduledoc """
  Module: impl_context_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_12"),
...
defmodule Impl_Context_12Store do
  use GenServer
...
defmodule Impl_Context_12EventBus do
  use GenServer
