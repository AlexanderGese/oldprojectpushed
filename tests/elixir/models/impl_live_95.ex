defmodule Impl_Live_95 do
  @moduledoc """
  Module: impl_live_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_95"),
...
defmodule Impl_Live_95Store do
  use GenServer
...
defmodule Impl_Live_95EventBus do
  use GenServer
