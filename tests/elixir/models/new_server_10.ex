defmodule New_Server_10 do
  @moduledoc """
  Module: new_server_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_10"),
...
defmodule New_Server_10Store do
  use GenServer
...
defmodule New_Server_10EventBus do
  use GenServer
