defmodule Core_Repo_42 do
  @moduledoc """
  Module: core_repo_42.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_42"),
...
defmodule Core_Repo_42Store do
  use GenServer
...
defmodule Core_Repo_42EventBus do
  use GenServer
