defmodule Base_Repo_91 do
  @moduledoc """
  Module: base_repo_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_91"),
...
defmodule Base_Repo_91Store do
  use GenServer
...
defmodule Base_Repo_91EventBus do
  use GenServer
