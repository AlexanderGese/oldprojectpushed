defmodule Core_Schema_20 do
  @moduledoc """
  Module: core_schema_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_20"),
...
defmodule Core_Schema_20Store do
  use GenServer
...
defmodule Core_Schema_20EventBus do
  use GenServer
