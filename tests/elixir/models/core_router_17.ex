defmodule Core_Router_17 do
  @moduledoc """
  Module: core_router_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_17"),
...
defmodule Core_Router_17Store do
  use GenServer
...
defmodule Core_Router_17EventBus do
  use GenServer
