defmodule Impl_Context_83 do
  @moduledoc """
  Module: impl_context_83.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_83"),
...
defmodule Impl_Context_83Store do
  use GenServer
...
defmodule Impl_Context_83EventBus do
  use GenServer
