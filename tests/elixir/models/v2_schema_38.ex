defmodule V2_Schema_38 do
  @moduledoc """
  Module: v2_schema_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_38"),
...
defmodule V2_Schema_38Store do
  use GenServer
...
defmodule V2_Schema_38EventBus do
  use GenServer
