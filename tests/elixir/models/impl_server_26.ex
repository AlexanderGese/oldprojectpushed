defmodule Impl_Server_26 do
  @moduledoc """
  Module: impl_server_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_26"),
...
defmodule Impl_Server_26Store do
  use GenServer
...
defmodule Impl_Server_26EventBus do
  use GenServer
