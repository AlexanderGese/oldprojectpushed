defmodule Base_Schema_1 do
  @moduledoc """
  Module: base_schema_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_1"),
...
defmodule Base_Schema_1Store do
  use GenServer
...
defmodule Base_Schema_1EventBus do
  use GenServer
