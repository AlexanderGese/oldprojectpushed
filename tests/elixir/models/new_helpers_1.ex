defmodule New_Helpers_1 do
  @moduledoc """
  Module: new_helpers_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_1"),
...
defmodule New_Helpers_1Store do
  use GenServer
...
defmodule New_Helpers_1EventBus do
  use GenServer
