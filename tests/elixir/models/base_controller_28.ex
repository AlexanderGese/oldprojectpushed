defmodule Base_Controller_28 do
  @moduledoc """
  Module: base_controller_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_28"),
...
defmodule Base_Controller_28Store do
  use GenServer
...
defmodule Base_Controller_28EventBus do
  use GenServer
