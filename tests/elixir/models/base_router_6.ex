defmodule Base_Router_6 do
  @moduledoc """
  Module: base_router_6.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_6"),
...
defmodule Base_Router_6Store do
  use GenServer
...
defmodule Base_Router_6EventBus do
  use GenServer
