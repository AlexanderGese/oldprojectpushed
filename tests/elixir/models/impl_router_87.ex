defmodule Impl_Router_87 do
  @moduledoc """
  Module: impl_router_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_87"),
...
defmodule Impl_Router_87Store do
  use GenServer
...
defmodule Impl_Router_87EventBus do
  use GenServer
