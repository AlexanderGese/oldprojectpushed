defmodule Core_Application_75 do
  @moduledoc """
  Module: core_application_75.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_75"),
...
defmodule Core_Application_75Store do
  use GenServer
...
defmodule Core_Application_75EventBus do
  use GenServer
