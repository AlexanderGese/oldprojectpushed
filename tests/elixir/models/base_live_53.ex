defmodule Base_Live_53 do
  @moduledoc """
  Module: base_live_53.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_53"),
...
defmodule Base_Live_53Store do
  use GenServer
...
defmodule Base_Live_53EventBus do
  use GenServer
