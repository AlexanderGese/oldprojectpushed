defmodule Core_Application_12 do
  @moduledoc """
  Module: core_application_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_12"),
...
defmodule Core_Application_12Store do
  use GenServer
...
defmodule Core_Application_12EventBus do
  use GenServer
