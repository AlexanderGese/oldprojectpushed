defmodule Impl_Helpers_17 do
  @moduledoc """
  Module: impl_helpers_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_17"),
...
defmodule Impl_Helpers_17Store do
  use GenServer
...
defmodule Impl_Helpers_17EventBus do
  use GenServer
