defmodule Core_Controller_15 do
  @moduledoc """
  Module: core_controller_15.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_15"),
...
defmodule Core_Controller_15Store do
  use GenServer
...
defmodule Core_Controller_15EventBus do
  use GenServer
