defmodule Base_Context_24 do
  @moduledoc """
  Module: base_context_24.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_24"),
...
defmodule Base_Context_24Store do
  use GenServer
...
defmodule Base_Context_24EventBus do
  use GenServer
