defmodule New_Router_99 do
  @moduledoc """
  Module: new_router_99.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_99"),
...
defmodule New_Router_99Store do
  use GenServer
...
defmodule New_Router_99EventBus do
  use GenServer
