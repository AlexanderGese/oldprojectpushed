defmodule Base_Controller_4 do
  @moduledoc """
  Module: base_controller_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_4"),
...
defmodule Base_Controller_4Store do
  use GenServer
...
defmodule Base_Controller_4EventBus do
  use GenServer
