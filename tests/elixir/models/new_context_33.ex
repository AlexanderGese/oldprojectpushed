defmodule New_Context_33 do
  @moduledoc """
  Module: new_context_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_33"),
...
defmodule New_Context_33Store do
  use GenServer
...
defmodule New_Context_33EventBus do
  use GenServer
