defmodule Core_Helpers_73 do
  @moduledoc """
  Module: core_helpers_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_73"),
...
defmodule Core_Helpers_73Store do
  use GenServer
...
defmodule Core_Helpers_73EventBus do
  use GenServer
