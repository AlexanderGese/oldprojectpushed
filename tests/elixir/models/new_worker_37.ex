defmodule New_Worker_37 do
  @moduledoc """
  Module: new_worker_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_37"),
...
defmodule New_Worker_37Store do
  use GenServer
...
defmodule New_Worker_37EventBus do
  use GenServer
