defmodule Core_Server_53 do
  @moduledoc """
  Module: core_server_53.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_53"),
...
defmodule Core_Server_53Store do
  use GenServer
...
defmodule Core_Server_53EventBus do
  use GenServer
