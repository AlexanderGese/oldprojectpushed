defmodule Core_Controller_95 do
  @moduledoc """
  Module: core_controller_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_95"),
...
defmodule Core_Controller_95Store do
  use GenServer
...
defmodule Core_Controller_95EventBus do
  use GenServer
