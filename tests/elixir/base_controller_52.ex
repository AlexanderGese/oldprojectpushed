defmodule Base_Controller_52 do
  @moduledoc """
  Module: base_controller_52.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_52"),
...
defmodule Base_Controller_52Store do
  use GenServer
...
defmodule Base_Controller_52EventBus do
  use GenServer
