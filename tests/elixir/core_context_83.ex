defmodule Core_Context_83 do
  @moduledoc """
  Module: core_context_83.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_83"),
...
defmodule Core_Context_83Store do
  use GenServer
...
defmodule Core_Context_83EventBus do
  use GenServer
