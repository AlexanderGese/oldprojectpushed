defmodule Core_Helpers_37 do
  @moduledoc """
  Module: core_helpers_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_37"),
...
defmodule Core_Helpers_37Store do
  use GenServer
...
defmodule Core_Helpers_37EventBus do
  use GenServer
