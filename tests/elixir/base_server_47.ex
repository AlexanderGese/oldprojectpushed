defmodule Base_Server_47 do
  @moduledoc """
  Module: base_server_47.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_47"),
...
defmodule Base_Server_47Store do
  use GenServer
...
defmodule Base_Server_47EventBus do
  use GenServer
