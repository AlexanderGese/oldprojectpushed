defmodule Core_Router_4 do
  @moduledoc """
  Module: core_router_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_4"),
...
defmodule Core_Router_4Store do
  use GenServer
...
defmodule Core_Router_4EventBus do
  use GenServer
