defmodule Impl_Router_34 do
  @moduledoc """
  Module: impl_router_34.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_34"),
...
defmodule Impl_Router_34Store do
  use GenServer
...
defmodule Impl_Router_34EventBus do
  use GenServer
