defmodule Base_Context_46 do
  @moduledoc """
  Module: base_context_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_46"),
...
defmodule Base_Context_46Store do
  use GenServer
...
defmodule Base_Context_46EventBus do
  use GenServer
