defmodule Controller_40 do
  @moduledoc """
  Module: controller_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_40"),
...
defmodule Controller_40Store do
  use GenServer
...
defmodule Controller_40EventBus do
  use GenServer
