defmodule New_Repo_87 do
  @moduledoc """
  Module: new_repo_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_87"),
...
defmodule New_Repo_87EventBus do
  use GenServer
