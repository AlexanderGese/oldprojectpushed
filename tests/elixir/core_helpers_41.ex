defmodule Core_Helpers_41 do
  @moduledoc """
  Module: core_helpers_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_41"),
...
defmodule Core_Helpers_41Store do
  use GenServer
...
defmodule Core_Helpers_41EventBus do
  use GenServer
