defmodule New_Schema_17 do
  @moduledoc """
  Module: new_schema_17.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_17"),
...
defmodule New_Schema_17Store do
  use GenServer
...
defmodule New_Schema_17EventBus do
  use GenServer
