defmodule Impl_Helpers_41 do
  @moduledoc """
  Module: impl_helpers_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_41"),
...
defmodule Impl_Helpers_41Store do
  use GenServer
...
defmodule Impl_Helpers_41EventBus do
  use GenServer
