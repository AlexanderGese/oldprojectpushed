defmodule Base_Schema_93 do
  @moduledoc """
  Module: base_schema_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_93"),
...
defmodule Base_Schema_93Store do
  use GenServer
...
defmodule Base_Schema_93EventBus do
  use GenServer
