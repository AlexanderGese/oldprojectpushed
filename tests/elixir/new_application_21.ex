defmodule New_Application_21 do
  @moduledoc """
  Module: new_application_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_21"),
...
defmodule New_Application_21Store do
  use GenServer
...
defmodule New_Application_21EventBus do
  use GenServer
