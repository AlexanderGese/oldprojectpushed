defmodule Core_Worker_73 do
  @moduledoc """
  Module: core_worker_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_73"),
...
defmodule Core_Worker_73Store do
  use GenServer
...
defmodule Core_Worker_73EventBus do
  use GenServer
