defmodule New_Server_71 do
  @moduledoc """
  Module: new_server_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_71"),
...
defmodule New_Server_71Store do
  use GenServer
...
defmodule New_Server_71EventBus do
  use GenServer
