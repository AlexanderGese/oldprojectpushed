defmodule Base_Helpers_25 do
  @moduledoc """
  Module: base_helpers_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_25"),
...
defmodule Base_Helpers_25Store do
  use GenServer
...
defmodule Base_Helpers_25EventBus do
  use GenServer
