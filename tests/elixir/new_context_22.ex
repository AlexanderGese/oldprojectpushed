defmodule New_Context_22 do
  @moduledoc """
  Module: new_context_22.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_22"),
...
defmodule New_Context_22Store do
  use GenServer
...
defmodule New_Context_22EventBus do
  use GenServer
