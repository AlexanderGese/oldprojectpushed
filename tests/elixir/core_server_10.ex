defmodule Core_Server_10 do
  @moduledoc """
  Module: core_server_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_10"),
...
defmodule Core_Server_10Store do
  use GenServer
...
defmodule Core_Server_10EventBus do
  use GenServer
