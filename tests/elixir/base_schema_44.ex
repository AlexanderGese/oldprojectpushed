defmodule Base_Schema_44 do
  @moduledoc """
  Module: base_schema_44.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_44"),
...
defmodule Base_Schema_44Store do
  use GenServer
...
defmodule Base_Schema_44EventBus do
  use GenServer
