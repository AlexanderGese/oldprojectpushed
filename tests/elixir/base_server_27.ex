defmodule Base_Server_27 do
  @moduledoc """
  Module: base_server_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_27"),
...
defmodule Base_Server_27Store do
  use GenServer
...
defmodule Base_Server_27EventBus do
  use GenServer
