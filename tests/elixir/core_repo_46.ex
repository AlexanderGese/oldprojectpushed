defmodule Core_Repo_46 do
  @moduledoc """
  Module: core_repo_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_46"),
...
defmodule Core_Repo_46Store do
  use GenServer
...
defmodule Core_Repo_46EventBus do
  use GenServer
