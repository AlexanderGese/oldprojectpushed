defmodule New_Router_35 do
  @moduledoc """
  Module: new_router_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_35"),
...
defmodule New_Router_35Store do
  use GenServer
...
defmodule New_Router_35EventBus do
  use GenServer
