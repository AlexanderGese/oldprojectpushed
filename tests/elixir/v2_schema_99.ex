defmodule V2_Schema_99 do
  @moduledoc """
  Module: v2_schema_99.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_99"),
...
defmodule V2_Schema_99Store do
  use GenServer
...
defmodule V2_Schema_99EventBus do
  use GenServer
