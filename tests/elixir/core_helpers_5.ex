defmodule Core_Helpers_5 do
  @moduledoc """
  Module: core_helpers_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_5"),
...
defmodule Core_Helpers_5Store do
  use GenServer
...
defmodule Core_Helpers_5EventBus do
  use GenServer
