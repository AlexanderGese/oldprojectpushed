defmodule Impl_Live_40 do
  @moduledoc """
  Module: impl_live_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_40"),
...
defmodule Impl_Live_40Store do
  use GenServer
...
defmodule Impl_Live_40EventBus do
  use GenServer
