defmodule Impl_Worker_20 do
  @moduledoc """
  Module: impl_worker_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_20"),
...
defmodule Impl_Worker_20Store do
  use GenServer
...
defmodule Impl_Worker_20EventBus do
  use GenServer
