defmodule New_Schema_23 do
  @moduledoc """
  Module: new_schema_23.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_23"),
...
defmodule New_Schema_23Store do
  use GenServer
...
defmodule New_Schema_23EventBus do
  use GenServer
