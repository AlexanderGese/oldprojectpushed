defmodule Impl_Repo_93 do
  @moduledoc """
  Module: impl_repo_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_93"),
...
defmodule Impl_Repo_93Store do
  use GenServer
...
defmodule Impl_Repo_93EventBus do
  use GenServer
