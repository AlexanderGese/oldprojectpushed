defmodule Core_Schema_83 do
  @moduledoc """
  Module: core_schema_83.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_83"),
...
defmodule Core_Schema_83Store do
  use GenServer
...
defmodule Core_Schema_83EventBus do
  use GenServer
