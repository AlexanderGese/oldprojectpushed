defmodule Base_Schema_39 do
  @moduledoc """
  Module: base_schema_39.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_39"),
...
defmodule Base_Schema_39Store do
  use GenServer
...
defmodule Base_Schema_39EventBus do
  use GenServer
