defmodule Impl_Worker do
  @moduledoc """
  Module: impl_worker.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker"),
...
defmodule Impl_WorkerEventBus do
  use GenServer
