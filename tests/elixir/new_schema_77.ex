defmodule New_Schema_77 do
  @moduledoc """
  Module: new_schema_77.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_77"),
...
defmodule New_Schema_77Store do
  use GenServer
...
defmodule New_Schema_77EventBus do
  use GenServer
