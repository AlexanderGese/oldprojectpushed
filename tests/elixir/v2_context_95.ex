defmodule V2_Context_95 do
  @moduledoc """
  Module: v2_context_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_95"),
...
defmodule V2_Context_95Store do
  use GenServer
...
defmodule V2_Context_95EventBus do
  use GenServer
