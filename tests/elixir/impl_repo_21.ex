defmodule Impl_Repo_21 do
  @moduledoc """
  Module: impl_repo_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_21"),
...
defmodule Impl_Repo_21Store do
  use GenServer
...
defmodule Impl_Repo_21EventBus do
  use GenServer
