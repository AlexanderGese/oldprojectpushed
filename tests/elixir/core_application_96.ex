defmodule Core_Application_96 do
  @moduledoc """
  Module: core_application_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_96"),
...
defmodule Core_Application_96Store do
  use GenServer
...
defmodule Core_Application_96EventBus do
  use GenServer
