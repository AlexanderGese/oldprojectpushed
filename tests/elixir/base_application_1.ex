defmodule Base_Application_1 do
  @moduledoc """
  Module: base_application_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_application_1"),
...
defmodule Base_Application_1Store do
  use GenServer
...
defmodule Base_Application_1EventBus do
  use GenServer
