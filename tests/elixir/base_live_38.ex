defmodule Base_Live_38 do
  @moduledoc """
  Module: base_live_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_38"),
...
defmodule Base_Live_38Store do
  use GenServer
...
defmodule Base_Live_38EventBus do
  use GenServer
