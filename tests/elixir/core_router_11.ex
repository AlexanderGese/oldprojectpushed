defmodule Core_Router_11 do
  @moduledoc """
  Module: core_router_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_11"),
...
defmodule Core_Router_11Store do
  use GenServer
...
defmodule Core_Router_11EventBus do
  use GenServer
