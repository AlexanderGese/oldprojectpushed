defmodule Core_Router_60 do
  @moduledoc """
  Module: core_router_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_60"),
...
defmodule Core_Router_60Store do
  use GenServer
...
defmodule Core_Router_60EventBus do
  use GenServer
