defmodule Base_Server_4 do
  @moduledoc """
  Module: base_server_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_4"),
...
defmodule Base_Server_4Store do
  use GenServer
...
defmodule Base_Server_4EventBus do
  use GenServer
