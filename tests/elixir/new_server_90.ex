defmodule New_Server_90 do
  @moduledoc """
  Module: new_server_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_90"),
...
defmodule New_Server_90Store do
  use GenServer
...
defmodule New_Server_90EventBus do
  use GenServer
