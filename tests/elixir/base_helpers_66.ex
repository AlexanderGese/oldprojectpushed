defmodule Base_Helpers_66 do
  @moduledoc """
  Module: base_helpers_66.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_66"),
...
defmodule Base_Helpers_66Store do
  use GenServer
...
defmodule Base_Helpers_66EventBus do
  use GenServer
