defmodule New_Repo_94 do
  @moduledoc """
  Module: new_repo_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_94"),
...
defmodule New_Repo_94EventBus do
  use GenServer
