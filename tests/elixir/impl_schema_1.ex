defmodule Impl_Schema_1 do
  @moduledoc """
  Module: impl_schema_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_1"),
...
defmodule Impl_Schema_1Store do
  use GenServer
...
defmodule Impl_Schema_1EventBus do
  use GenServer
