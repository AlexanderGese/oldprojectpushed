defmodule New_Context_90 do
  @moduledoc """
  Module: new_context_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_90"),
...
defmodule New_Context_90Store do
  use GenServer
...
defmodule New_Context_90EventBus do
  use GenServer
