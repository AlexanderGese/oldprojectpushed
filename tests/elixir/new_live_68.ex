defmodule New_Live_68 do
  @moduledoc """
  Module: new_live_68.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_68"),
...
defmodule New_Live_68EventBus do
  use GenServer
