defmodule Impl_Application_80 do
  @moduledoc """
  Module: impl_application_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_80"),
...
defmodule Impl_Application_80Store do
  use GenServer
...
defmodule Impl_Application_80EventBus do
  use GenServer
