defmodule New_Live_63 do
  @moduledoc """
  Module: new_live_63.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_63"),
...
defmodule New_Live_63EventBus do
  use GenServer
