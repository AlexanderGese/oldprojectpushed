defmodule Controller_94 do
  @moduledoc """
  Module: controller_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_94"),
...
defmodule Controller_94Store do
  use GenServer
...
defmodule Controller_94EventBus do
  use GenServer
