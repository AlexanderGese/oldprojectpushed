defmodule New_Live_22 do
  @moduledoc """
  Module: new_live_22.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_22"),
...
defmodule New_Live_22EventBus do
  use GenServer
