defmodule Controller_80 do
  @moduledoc """
  Module: controller_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_80"),
...
defmodule Controller_80Store do
  use GenServer
...
defmodule Controller_80EventBus do
  use GenServer
