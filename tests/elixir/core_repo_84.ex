defmodule Core_Repo_84 do
  @moduledoc """
  Module: core_repo_84.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_84"),
...
defmodule Core_Repo_84Store do
  use GenServer
...
defmodule Core_Repo_84EventBus do
  use GenServer
