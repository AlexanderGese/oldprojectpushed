defmodule Base_Helpers_80 do
  @moduledoc """
  Module: base_helpers_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_80"),
...
defmodule Base_Helpers_80Store do
  use GenServer
...
defmodule Base_Helpers_80EventBus do
  use GenServer
