defmodule Base_Schema_27 do
  @moduledoc """
  Module: base_schema_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_27"),
...
defmodule Base_Schema_27Store do
  use GenServer
...
defmodule Base_Schema_27EventBus do
  use GenServer
