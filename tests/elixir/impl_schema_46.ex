defmodule Impl_Schema_46 do
  @moduledoc """
  Module: impl_schema_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_46"),
...
defmodule Impl_Schema_46Store do
  use GenServer
...
defmodule Impl_Schema_46EventBus do
  use GenServer
