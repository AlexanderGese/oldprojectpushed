defmodule V2_Schema_60 do
  @moduledoc """
  Module: v2_schema_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_60"),
...
defmodule V2_Schema_60Store do
  use GenServer
...
defmodule V2_Schema_60EventBus do
  use GenServer
