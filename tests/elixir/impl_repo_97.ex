defmodule Impl_Repo_97 do
  @moduledoc """
  Module: impl_repo_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_97"),
...
defmodule Impl_Repo_97Store do
  use GenServer
...
defmodule Impl_Repo_97EventBus do
  use GenServer
