defmodule Base_Helpers_27 do
  @moduledoc """
  Module: base_helpers_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_27"),
...
defmodule Base_Helpers_27Store do
  use GenServer
...
defmodule Base_Helpers_27EventBus do
  use GenServer
