defmodule New_Live_82 do
  @moduledoc """
  Module: new_live_82.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_82"),
...
defmodule New_Live_82EventBus do
  use GenServer
