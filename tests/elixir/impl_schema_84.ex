defmodule Impl_Schema_84 do
  @moduledoc """
  Module: impl_schema_84.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_84"),
...
defmodule Impl_Schema_84Store do
  use GenServer
...
defmodule Impl_Schema_84EventBus do
  use GenServer
