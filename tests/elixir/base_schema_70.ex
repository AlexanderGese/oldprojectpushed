defmodule Base_Schema_70 do
  @moduledoc """
  Module: base_schema_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_70"),
...
defmodule Base_Schema_70Store do
  use GenServer
...
defmodule Base_Schema_70EventBus do
  use GenServer
