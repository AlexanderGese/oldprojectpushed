defmodule Base_Worker_14 do
  @moduledoc """
  Module: base_worker_14.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_14"),
...
defmodule Base_Worker_14Store do
  use GenServer
...
defmodule Base_Worker_14EventBus do
  use GenServer
