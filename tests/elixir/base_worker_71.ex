defmodule Base_Worker_71 do
  @moduledoc """
  Module: base_worker_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_71"),
...
defmodule Base_Worker_71Store do
  use GenServer
...
defmodule Base_Worker_71EventBus do
  use GenServer
