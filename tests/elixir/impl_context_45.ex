defmodule Impl_Context_45 do
  @moduledoc """
  Module: impl_context_45.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_45"),
...
defmodule Impl_Context_45Store do
  use GenServer
...
defmodule Impl_Context_45EventBus do
  use GenServer
