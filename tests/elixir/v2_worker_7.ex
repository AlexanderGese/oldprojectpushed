defmodule V2_Worker_7 do
  @moduledoc """
  Module: v2_worker_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_worker_7"),
...
defmodule V2_Worker_7EventBus do
  use GenServer
