defmodule Base_Router_41 do
  @moduledoc """
  Module: base_router_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_41"),
...
defmodule Base_Router_41Store do
  use GenServer
...
defmodule Base_Router_41EventBus do
  use GenServer
