defmodule New_Application_74 do
  @moduledoc """
  Module: new_application_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_74"),
...
defmodule New_Application_74Store do
  use GenServer
...
defmodule New_Application_74EventBus do
  use GenServer
