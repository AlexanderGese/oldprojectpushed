defmodule New_Schema_26 do
  @moduledoc """
  Module: new_schema_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_26"),
...
defmodule New_Schema_26Store do
  use GenServer
...
defmodule New_Schema_26EventBus do
  use GenServer
