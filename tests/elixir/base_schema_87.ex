defmodule Base_Schema_87 do
  @moduledoc """
  Module: base_schema_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_87"),
...
defmodule Base_Schema_87Store do
  use GenServer
...
defmodule Base_Schema_87EventBus do
  use GenServer
