defmodule Base_Worker_93 do
  @moduledoc """
  Module: base_worker_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_93"),
...
defmodule Base_Worker_93Store do
  use GenServer
...
defmodule Base_Worker_93EventBus do
  use GenServer
