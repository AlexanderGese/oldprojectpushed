defmodule Core_Helpers_52 do
  @moduledoc """
  Module: core_helpers_52.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_52"),
...
defmodule Core_Helpers_52Store do
  use GenServer
...
defmodule Core_Helpers_52EventBus do
  use GenServer
