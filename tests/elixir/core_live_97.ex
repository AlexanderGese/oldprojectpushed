defmodule Core_Live_97 do
  @moduledoc """
  Module: core_live_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_97"),
...
defmodule Core_Live_97Store do
  use GenServer
...
defmodule Core_Live_97EventBus do
  use GenServer
