defmodule Application_36 do
  @moduledoc """
  Module: application_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "application_36"),
...
defmodule Application_36Store do
  use GenServer
...
defmodule Application_36EventBus do
  use GenServer
