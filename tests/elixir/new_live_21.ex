defmodule New_Live_21 do
  @moduledoc """
  Module: new_live_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_21"),
...
defmodule New_Live_21EventBus do
  use GenServer
