defmodule Impl_Live_42 do
  @moduledoc """
  Module: impl_live_42.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_42"),
...
defmodule Impl_Live_42Store do
  use GenServer
...
defmodule Impl_Live_42EventBus do
  use GenServer
