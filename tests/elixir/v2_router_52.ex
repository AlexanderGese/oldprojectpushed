defmodule V2_Router_52 do
  @moduledoc """
  Module: v2_router_52.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_router_52"),
...
defmodule V2_Router_52Store do
  use GenServer
...
defmodule V2_Router_52EventBus do
  use GenServer
