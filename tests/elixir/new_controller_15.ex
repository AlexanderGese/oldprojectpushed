defmodule New_Controller_15 do
  @moduledoc """
  Module: new_controller_15.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_15"),
...
defmodule New_Controller_15Store do
  use GenServer
...
defmodule New_Controller_15EventBus do
  use GenServer
