defmodule New_Controller_87 do
  @moduledoc """
  Module: new_controller_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_87"),
...
defmodule New_Controller_87Store do
  use GenServer
...
defmodule New_Controller_87EventBus do
  use GenServer
