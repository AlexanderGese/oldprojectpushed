defmodule Impl_Application_46 do
  @moduledoc """
  Module: impl_application_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_46"),
...
defmodule Impl_Application_46Store do
  use GenServer
...
defmodule Impl_Application_46EventBus do
  use GenServer
