defmodule Core_Helpers_48 do
  @moduledoc """
  Module: core_helpers_48.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_48"),
...
defmodule Core_Helpers_48Store do
  use GenServer
...
defmodule Core_Helpers_48EventBus do
  use GenServer
