defmodule Base_Schema_29 do
  @moduledoc """
  Module: base_schema_29.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_29"),
...
defmodule Base_Schema_29Store do
  use GenServer
...
defmodule Base_Schema_29EventBus do
  use GenServer
