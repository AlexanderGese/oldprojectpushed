defmodule Core_Context_9 do
  @moduledoc """
  Module: core_context_9.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_9"),
...
defmodule Core_Context_9Store do
  use GenServer
...
defmodule Core_Context_9EventBus do
  use GenServer
