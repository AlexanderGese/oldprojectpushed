defmodule Impl_Helpers_92 do
  @moduledoc """
  Module: impl_helpers_92.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_92"),
...
defmodule Impl_Helpers_92Store do
  use GenServer
...
defmodule Impl_Helpers_92EventBus do
  use GenServer
