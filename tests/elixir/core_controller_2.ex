defmodule Core_Controller_2 do
  @moduledoc """
  Module: core_controller_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_2"),
...
defmodule Core_Controller_2Store do
  use GenServer
...
defmodule Core_Controller_2EventBus do
  use GenServer
