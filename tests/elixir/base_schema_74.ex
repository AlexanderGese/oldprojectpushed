defmodule Base_Schema_74 do
  @moduledoc """
  Module: base_schema_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_74"),
...
defmodule Base_Schema_74Store do
  use GenServer
...
defmodule Base_Schema_74EventBus do
  use GenServer
