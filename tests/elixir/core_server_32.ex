defmodule Core_Server_32 do
  @moduledoc """
  Module: core_server_32.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_32"),
...
defmodule Core_Server_32Store do
  use GenServer
...
defmodule Core_Server_32EventBus do
  use GenServer
