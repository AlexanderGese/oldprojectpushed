defmodule Core_Server_98 do
  @moduledoc """
  Module: core_server_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_98"),
...
defmodule Core_Server_98Store do
  use GenServer
...
defmodule Core_Server_98EventBus do
  use GenServer
