defmodule Base_Live_31 do
  @moduledoc """
  Module: base_live_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_31"),
...
defmodule Base_Live_31Store do
  use GenServer
...
defmodule Base_Live_31EventBus do
  use GenServer
