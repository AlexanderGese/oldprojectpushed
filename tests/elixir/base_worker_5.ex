defmodule Base_Worker_5 do
  @moduledoc """
  Module: base_worker_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_5"),
...
defmodule Base_Worker_5Store do
  use GenServer
...
defmodule Base_Worker_5EventBus do
  use GenServer
