defmodule New_Repo_71 do
  @moduledoc """
  Module: new_repo_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_71"),
...
defmodule New_Repo_71EventBus do
  use GenServer
