defmodule Impl_Live_71 do
  @moduledoc """
  Module: impl_live_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_71"),
...
defmodule Impl_Live_71Store do
  use GenServer
...
defmodule Impl_Live_71EventBus do
  use GenServer
