defmodule Enhanced_Server_4 do
  @moduledoc """
  Module: enhanced_server_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_server_4"),
...
defmodule Enhanced_Server_4Store do
  use GenServer
...
defmodule Enhanced_Server_4EventBus do
  use GenServer
