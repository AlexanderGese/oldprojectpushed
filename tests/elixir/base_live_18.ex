defmodule Base_Live_18 do
  @moduledoc """
  Module: base_live_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_18"),
...
defmodule Base_Live_18Store do
  use GenServer
...
defmodule Base_Live_18EventBus do
  use GenServer
