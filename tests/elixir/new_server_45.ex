defmodule New_Server_45 do
  @moduledoc """
  Module: new_server_45.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_45"),
...
defmodule New_Server_45Store do
  use GenServer
...
defmodule New_Server_45EventBus do
  use GenServer
