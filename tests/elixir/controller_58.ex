defmodule Controller_58 do
  @moduledoc """
  Module: controller_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_58"),
...
defmodule Controller_58Store do
  use GenServer
...
defmodule Controller_58EventBus do
  use GenServer
