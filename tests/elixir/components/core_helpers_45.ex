defmodule Core_Helpers_45 do
  @moduledoc """
  Module: core_helpers_45.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_45"),
...
defmodule Core_Helpers_45Store do
  use GenServer
...
defmodule Core_Helpers_45EventBus do
  use GenServer
