defmodule Core_Live_98 do
  @moduledoc """
  Module: core_live_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_98"),
...
defmodule Core_Live_98Store do
  use GenServer
...
defmodule Core_Live_98EventBus do
  use GenServer
