defmodule Base_Helpers_38 do
  @moduledoc """
  Module: base_helpers_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_38"),
...
defmodule Base_Helpers_38Store do
  use GenServer
...
defmodule Base_Helpers_38EventBus do
  use GenServer
