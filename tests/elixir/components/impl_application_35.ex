defmodule Impl_Application_35 do
  @moduledoc """
  Module: impl_application_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_application_35"),
...
defmodule Impl_Application_35Store do
  use GenServer
...
defmodule Impl_Application_35EventBus do
  use GenServer
