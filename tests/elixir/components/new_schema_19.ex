defmodule New_Schema_19 do
  @moduledoc """
  Module: new_schema_19.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_19"),
...
defmodule New_Schema_19Store do
  use GenServer
...
defmodule New_Schema_19EventBus do
  use GenServer
