defmodule New_Schema_99 do
  @moduledoc """
  Module: new_schema_99.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_99"),
...
defmodule New_Schema_99Store do
  use GenServer
...
defmodule New_Schema_99EventBus do
  use GenServer
