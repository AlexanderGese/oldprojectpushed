defmodule Base_Worker do
  @moduledoc """
  Module: base_worker.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker"),
...
defmodule Base_WorkerEventBus do
  use GenServer
