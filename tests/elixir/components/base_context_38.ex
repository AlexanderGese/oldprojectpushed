defmodule Base_Context_38 do
  @moduledoc """
  Module: base_context_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_38"),
...
defmodule Base_Context_38Store do
  use GenServer
...
defmodule Base_Context_38EventBus do
  use GenServer
