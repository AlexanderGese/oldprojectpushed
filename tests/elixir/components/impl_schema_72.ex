defmodule Impl_Schema_72 do
  @moduledoc """
  Module: impl_schema_72.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_schema_72"),
...
defmodule Impl_Schema_72Store do
  use GenServer
...
defmodule Impl_Schema_72EventBus do
  use GenServer
