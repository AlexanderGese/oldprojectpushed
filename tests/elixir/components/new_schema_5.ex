defmodule New_Schema_5 do
  @moduledoc """
  Module: new_schema_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_5"),
...
defmodule New_Schema_5Store do
  use GenServer
...
defmodule New_Schema_5EventBus do
  use GenServer
