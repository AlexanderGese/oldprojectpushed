defmodule New_Schema_12 do
  @moduledoc """
  Module: new_schema_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_12"),
...
defmodule New_Schema_12Store do
  use GenServer
...
defmodule New_Schema_12EventBus do
  use GenServer
