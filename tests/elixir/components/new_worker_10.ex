defmodule New_Worker_10 do
  @moduledoc """
  Module: new_worker_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_10"),
...
defmodule New_Worker_10Store do
  use GenServer
...
defmodule New_Worker_10EventBus do
  use GenServer
