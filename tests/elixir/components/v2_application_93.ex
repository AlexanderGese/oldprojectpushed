defmodule V2_Application_93 do
  @moduledoc """
  Module: v2_application_93.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_application_93"),
...
defmodule V2_Application_93Store do
  use GenServer
...
defmodule V2_Application_93EventBus do
  use GenServer
