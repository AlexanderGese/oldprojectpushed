defmodule Base_Live_8 do
  @moduledoc """
  Module: base_live_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_8"),
...
defmodule Base_Live_8EventBus do
  use GenServer
