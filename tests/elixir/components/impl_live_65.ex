defmodule Impl_Live_65 do
  @moduledoc """
  Module: impl_live_65.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_65"),
...
defmodule Impl_Live_65Store do
  use GenServer
...
defmodule Impl_Live_65EventBus do
  use GenServer
