defmodule Base_Helpers_18 do
  @moduledoc """
  Module: base_helpers_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_18"),
...
defmodule Base_Helpers_18Store do
  use GenServer
...
defmodule Base_Helpers_18EventBus do
  use GenServer
