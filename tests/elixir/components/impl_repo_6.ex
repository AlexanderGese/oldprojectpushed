defmodule Impl_Repo_6 do
  @moduledoc """
  Module: impl_repo_6.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_repo_6"),
...
defmodule Impl_Repo_6EventBus do
  use GenServer
