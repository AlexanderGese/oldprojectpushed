defmodule New_Context_12 do
  @moduledoc """
  Module: new_context_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_12"),
...
defmodule New_Context_12Store do
  use GenServer
...
defmodule New_Context_12EventBus do
  use GenServer
