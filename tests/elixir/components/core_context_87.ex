defmodule Core_Context_87 do
  @moduledoc """
  Module: core_context_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_87"),
...
defmodule Core_Context_87Store do
  use GenServer
...
defmodule Core_Context_87EventBus do
  use GenServer
