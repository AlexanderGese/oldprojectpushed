defmodule Impl_Helpers_73 do
  @moduledoc """
  Module: impl_helpers_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_73"),
...
defmodule Impl_Helpers_73Store do
  use GenServer
...
defmodule Impl_Helpers_73EventBus do
  use GenServer
