defmodule Impl_Helpers_52 do
  @moduledoc """
  Module: impl_helpers_52.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_52"),
...
defmodule Impl_Helpers_52Store do
  use GenServer
...
defmodule Impl_Helpers_52EventBus do
  use GenServer
