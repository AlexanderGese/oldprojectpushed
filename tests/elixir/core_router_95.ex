defmodule Core_Router_95 do
  @moduledoc """
  Module: core_router_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_95"),
...
defmodule Core_Router_95Store do
  use GenServer
...
defmodule Core_Router_95EventBus do
  use GenServer
