defmodule New_Context_15 do
  @moduledoc """
  Module: new_context_15.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_15"),
...
defmodule New_Context_15Store do
  use GenServer
...
defmodule New_Context_15EventBus do
  use GenServer
