defmodule Base_Server_74 do
  @moduledoc """
  Module: base_server_74.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_74"),
...
defmodule Base_Server_74Store do
  use GenServer
...
defmodule Base_Server_74EventBus do
  use GenServer
