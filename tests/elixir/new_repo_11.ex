defmodule New_Repo_11 do
  @moduledoc """
  Module: new_repo_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_11"),
...
defmodule New_Repo_11EventBus do
  use GenServer
