defmodule New_Application_10 do
  @moduledoc """
  Module: new_application_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_10"),
...
defmodule New_Application_10Store do
  use GenServer
...
defmodule New_Application_10EventBus do
  use GenServer
