defmodule Impl_Live_34 do
  @moduledoc """
  Module: impl_live_34.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_34"),
...
defmodule Impl_Live_34Store do
  use GenServer
...
defmodule Impl_Live_34EventBus do
  use GenServer
