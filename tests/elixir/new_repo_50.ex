defmodule New_Repo_50 do
  @moduledoc """
  Module: new_repo_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_50"),
...
defmodule New_Repo_50EventBus do
  use GenServer
