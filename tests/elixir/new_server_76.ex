defmodule New_Server_76 do
  @moduledoc """
  Module: new_server_76.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_76"),
...
defmodule New_Server_76Store do
  use GenServer
...
defmodule New_Server_76EventBus do
  use GenServer
