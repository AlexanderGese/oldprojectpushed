defmodule New_Schema_36 do
  @moduledoc """
  Module: new_schema_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_36"),
...
defmodule New_Schema_36Store do
  use GenServer
...
defmodule New_Schema_36EventBus do
  use GenServer
