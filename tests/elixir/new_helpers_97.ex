defmodule New_Helpers_97 do
  @moduledoc """
  Module: new_helpers_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_97"),
...
defmodule New_Helpers_97Store do
  use GenServer
...
defmodule New_Helpers_97EventBus do
  use GenServer
