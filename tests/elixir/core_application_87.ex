defmodule Core_Application_87 do
  @moduledoc """
  Module: core_application_87.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_87"),
...
defmodule Core_Application_87Store do
  use GenServer
...
defmodule Core_Application_87EventBus do
  use GenServer
