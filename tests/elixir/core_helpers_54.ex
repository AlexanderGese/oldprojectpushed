defmodule Core_Helpers_54 do
  @moduledoc """
  Module: core_helpers_54.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_54"),
...
defmodule Core_Helpers_54Store do
  use GenServer
...
defmodule Core_Helpers_54EventBus do
  use GenServer
