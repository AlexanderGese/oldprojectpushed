defmodule V2_Context_73 do
  @moduledoc """
  Module: v2_context_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_context_73"),
...
defmodule V2_Context_73Store do
  use GenServer
...
defmodule V2_Context_73EventBus do
  use GenServer
