defmodule Impl_Server_88 do
  @moduledoc """
  Module: impl_server_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_88"),
...
defmodule Impl_Server_88Store do
  use GenServer
...
defmodule Impl_Server_88EventBus do
  use GenServer
