defmodule Impl_Router_11 do
  @moduledoc """
  Module: impl_router_11.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_router_11"),
...
defmodule Impl_Router_11Store do
  use GenServer
...
defmodule Impl_Router_11EventBus do
  use GenServer
