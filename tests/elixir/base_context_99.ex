defmodule Base_Context_99 do
  @moduledoc """
  Module: base_context_99.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_99"),
...
defmodule Base_Context_99Store do
  use GenServer
...
defmodule Base_Context_99EventBus do
  use GenServer
