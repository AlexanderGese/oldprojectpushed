defmodule V2_Helpers_4 do
  @moduledoc """
  Module: v2_helpers_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_4"),
...
defmodule V2_Helpers_4Store do
  use GenServer
...
defmodule V2_Helpers_4EventBus do
  use GenServer
