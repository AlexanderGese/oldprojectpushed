defmodule V2_Worker_40 do
  @moduledoc """
  Module: v2_worker_40.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_worker_40"),
...
defmodule V2_Worker_40Store do
  use GenServer
...
defmodule V2_Worker_40EventBus do
  use GenServer
