defmodule New_Schema_89 do
  @moduledoc """
  Module: new_schema_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_89"),
...
defmodule New_Schema_89Store do
  use GenServer
...
defmodule New_Schema_89EventBus do
  use GenServer
