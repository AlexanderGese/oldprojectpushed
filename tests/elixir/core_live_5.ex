defmodule Core_Live_5 do
  @moduledoc """
  Module: core_live_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_5"),
...
defmodule Core_Live_5EventBus do
  use GenServer
