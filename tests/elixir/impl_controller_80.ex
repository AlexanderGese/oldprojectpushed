defmodule Impl_Controller_80 do
  @moduledoc """
  Module: impl_controller_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_controller_80"),
...
defmodule Impl_Controller_80Store do
  use GenServer
...
defmodule Impl_Controller_80EventBus do
  use GenServer
