defmodule Base_Controller_12 do
  @moduledoc """
  Module: base_controller_12.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_12"),
...
defmodule Base_Controller_12Store do
  use GenServer
...
defmodule Base_Controller_12EventBus do
  use GenServer
