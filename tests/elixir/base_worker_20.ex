defmodule Base_Worker_20 do
  @moduledoc """
  Module: base_worker_20.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_20"),
...
defmodule Base_Worker_20Store do
  use GenServer
...
defmodule Base_Worker_20EventBus do
  use GenServer
