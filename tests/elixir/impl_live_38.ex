defmodule Impl_Live_38 do
  @moduledoc """
  Module: impl_live_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_38"),
...
defmodule Impl_Live_38Store do
  use GenServer
...
defmodule Impl_Live_38EventBus do
  use GenServer
