defmodule Core_Context_2 do
  @moduledoc """
  Module: core_context_2.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_2"),
...
defmodule Core_Context_2Store do
  use GenServer
...
defmodule Core_Context_2EventBus do
  use GenServer
