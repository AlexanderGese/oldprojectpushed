defmodule New_Helpers_86 do
  @moduledoc """
  Module: new_helpers_86.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_86"),
...
defmodule New_Helpers_86Store do
  use GenServer
...
defmodule New_Helpers_86EventBus do
  use GenServer
