defmodule V2_Application_14 do
  @moduledoc """
  Module: v2_application_14.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_application_14"),
...
defmodule V2_Application_14Store do
  use GenServer
...
defmodule V2_Application_14EventBus do
  use GenServer
