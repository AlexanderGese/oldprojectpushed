defmodule Base_Schema_7 do
  @moduledoc """
  Module: base_schema_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_7"),
...
defmodule Base_Schema_7Store do
  use GenServer
...
defmodule Base_Schema_7EventBus do
  use GenServer
