defmodule Core_Application_32 do
  @moduledoc """
  Module: core_application_32.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_32"),
...
defmodule Core_Application_32Store do
  use GenServer
...
defmodule Core_Application_32EventBus do
  use GenServer
