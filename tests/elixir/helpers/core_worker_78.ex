defmodule Core_Worker_78 do
  @moduledoc """
  Module: core_worker_78.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_78"),
...
defmodule Core_Worker_78Store do
  use GenServer
...
defmodule Core_Worker_78EventBus do
  use GenServer
