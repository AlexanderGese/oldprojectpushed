defmodule Base_Schema_61 do
  @moduledoc """
  Module: base_schema_61.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_61"),
...
defmodule Base_Schema_61Store do
  use GenServer
...
defmodule Base_Schema_61EventBus do
  use GenServer
