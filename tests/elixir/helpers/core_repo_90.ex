defmodule Core_Repo_90 do
  @moduledoc """
  Module: core_repo_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_90"),
...
defmodule Core_Repo_90Store do
  use GenServer
...
defmodule Core_Repo_90EventBus do
  use GenServer
