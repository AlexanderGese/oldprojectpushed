defmodule Base_Server_35 do
  @moduledoc """
  Module: base_server_35.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_35"),
...
defmodule Base_Server_35Store do
  use GenServer
...
defmodule Base_Server_35EventBus do
  use GenServer
