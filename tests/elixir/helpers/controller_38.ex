defmodule Controller_38 do
  @moduledoc """
  Module: controller_38.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_38"),
...
defmodule Controller_38Store do
  use GenServer
...
defmodule Controller_38EventBus do
  use GenServer
