defmodule V2_Helpers_71 do
  @moduledoc """
  Module: v2_helpers_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_helpers_71"),
...
defmodule V2_Helpers_71Store do
  use GenServer
...
defmodule V2_Helpers_71EventBus do
  use GenServer
