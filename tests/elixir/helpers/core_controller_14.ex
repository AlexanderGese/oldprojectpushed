defmodule Core_Controller_14 do
  @moduledoc """
  Module: core_controller_14.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_14"),
...
defmodule Core_Controller_14Store do
  use GenServer
...
defmodule Core_Controller_14EventBus do
  use GenServer
