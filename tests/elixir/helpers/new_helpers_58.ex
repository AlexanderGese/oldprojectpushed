defmodule New_Helpers_58 do
  @moduledoc """
  Module: new_helpers_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_58"),
...
defmodule New_Helpers_58Store do
  use GenServer
...
defmodule New_Helpers_58EventBus do
  use GenServer
