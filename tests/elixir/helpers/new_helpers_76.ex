defmodule New_Helpers_76 do
  @moduledoc """
  Module: new_helpers_76.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_76"),
...
defmodule New_Helpers_76Store do
  use GenServer
...
defmodule New_Helpers_76EventBus do
  use GenServer
