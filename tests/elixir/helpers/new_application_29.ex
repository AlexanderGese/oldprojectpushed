defmodule New_Application_29 do
  @moduledoc """
  Module: new_application_29.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_29"),
...
defmodule New_Application_29Store do
  use GenServer
...
defmodule New_Application_29EventBus do
  use GenServer
