defmodule Base_Router_91 do
  @moduledoc """
  Module: base_router_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_91"),
...
defmodule Base_Router_91Store do
  use GenServer
...
defmodule Base_Router_91EventBus do
  use GenServer
