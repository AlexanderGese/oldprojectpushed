defmodule Enhanced_Live_8 do
  @moduledoc """
  Module: enhanced_live_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "enhanced_live_8"),
...
defmodule Enhanced_Live_8Store do
  use GenServer
...
defmodule Enhanced_Live_8EventBus do
  use GenServer
