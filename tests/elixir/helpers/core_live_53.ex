defmodule Core_Live_53 do
  @moduledoc """
  Module: core_live_53.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_53"),
...
defmodule Core_Live_53Store do
  use GenServer
...
defmodule Core_Live_53EventBus do
  use GenServer
