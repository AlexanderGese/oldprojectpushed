defmodule New_Server_31 do
  @moduledoc """
  Module: new_server_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_31"),
...
defmodule New_Server_31Store do
  use GenServer
...
defmodule New_Server_31EventBus do
  use GenServer
