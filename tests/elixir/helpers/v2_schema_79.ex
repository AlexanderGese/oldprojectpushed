defmodule V2_Schema_79 do
  @moduledoc """
  Module: v2_schema_79.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_schema_79"),
...
defmodule V2_Schema_79Store do
  use GenServer
...
defmodule V2_Schema_79EventBus do
  use GenServer
