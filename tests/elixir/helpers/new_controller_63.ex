defmodule New_Controller_63 do
  @moduledoc """
  Module: new_controller_63.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_63"),
...
defmodule New_Controller_63Store do
  use GenServer
...
defmodule New_Controller_63EventBus do
  use GenServer
