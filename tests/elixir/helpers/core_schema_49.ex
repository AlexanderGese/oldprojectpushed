defmodule Core_Schema_49 do
  @moduledoc """
  Module: core_schema_49.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_49"),
...
defmodule Core_Schema_49Store do
  use GenServer
...
defmodule Core_Schema_49EventBus do
  use GenServer
