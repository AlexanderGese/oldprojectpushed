defmodule V2_Server_30 do
  @moduledoc """
  Module: v2_server_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_server_30"),
...
defmodule V2_Server_30Store do
  use GenServer
...
defmodule V2_Server_30EventBus do
  use GenServer
