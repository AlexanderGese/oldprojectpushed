defmodule V2_Router_8 do
  @moduledoc """
  Module: v2_router_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_router_8"),
...
defmodule V2_Router_8EventBus do
  use GenServer
