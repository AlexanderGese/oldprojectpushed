defmodule Core_Application_26 do
  @moduledoc """
  Module: core_application_26.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_26"),
...
defmodule Core_Application_26Store do
  use GenServer
...
defmodule Core_Application_26EventBus do
  use GenServer
