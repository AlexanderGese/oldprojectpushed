defmodule Application_90 do
  @moduledoc """
  Module: application_90.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "application_90"),
...
defmodule Application_90Store do
  use GenServer
...
defmodule Application_90EventBus do
  use GenServer
