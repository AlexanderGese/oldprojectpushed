defmodule Base_Live_73 do
  @moduledoc """
  Module: base_live_73.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_73"),
...
defmodule Base_Live_73Store do
  use GenServer
...
defmodule Base_Live_73EventBus do
  use GenServer
