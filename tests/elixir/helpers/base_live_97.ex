defmodule Base_Live_97 do
  @moduledoc """
  Module: base_live_97.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_97"),
...
defmodule Base_Live_97Store do
  use GenServer
...
defmodule Base_Live_97EventBus do
  use GenServer
