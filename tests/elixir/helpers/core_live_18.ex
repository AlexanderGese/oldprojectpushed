defmodule Core_Live_18 do
  @moduledoc """
  Module: core_live_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_18"),
...
defmodule Core_Live_18Store do
  use GenServer
...
defmodule Core_Live_18EventBus do
  use GenServer
