defmodule Core_Live_46 do
  @moduledoc """
  Module: core_live_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_46"),
...
defmodule Core_Live_46Store do
  use GenServer
...
defmodule Core_Live_46EventBus do
  use GenServer
