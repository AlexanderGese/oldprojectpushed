defmodule New_Context_92 do
  @moduledoc """
  Module: new_context_92.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_context_92"),
...
defmodule New_Context_92Store do
  use GenServer
...
defmodule New_Context_92EventBus do
  use GenServer
