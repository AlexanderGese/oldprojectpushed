defmodule Controller_60 do
  @moduledoc """
  Module: controller_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "controller_60"),
...
defmodule Controller_60Store do
  use GenServer
...
defmodule Controller_60EventBus do
  use GenServer
