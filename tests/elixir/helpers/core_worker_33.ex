defmodule Core_Worker_33 do
  @moduledoc """
  Module: core_worker_33.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_33"),
...
defmodule Core_Worker_33Store do
  use GenServer
...
defmodule Core_Worker_33EventBus do
  use GenServer
