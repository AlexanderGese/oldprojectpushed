defmodule Core_Schema_8 do
  @moduledoc """
  Module: core_schema_8.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_8"),
...
defmodule Core_Schema_8Store do
  use GenServer
...
defmodule Core_Schema_8EventBus do
  use GenServer
