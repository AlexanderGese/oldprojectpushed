defmodule New_Controller_91 do
  @moduledoc """
  Module: new_controller_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_91"),
...
defmodule New_Controller_91Store do
  use GenServer
...
defmodule New_Controller_91EventBus do
  use GenServer
