defmodule Base_Worker_25 do
  @moduledoc """
  Module: base_worker_25.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_25"),
...
defmodule Base_Worker_25Store do
  use GenServer
...
defmodule Base_Worker_25EventBus do
  use GenServer
