defmodule New_Worker_59 do
  @moduledoc """
  Module: new_worker_59.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_worker_59"),
...
defmodule New_Worker_59Store do
  use GenServer
...
defmodule New_Worker_59EventBus do
  use GenServer
