defmodule Core_Helpers_84 do
  @moduledoc """
  Module: core_helpers_84.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_84"),
...
defmodule Core_Helpers_84Store do
  use GenServer
...
defmodule Core_Helpers_84EventBus do
  use GenServer
