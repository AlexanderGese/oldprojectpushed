defmodule Impl_Helpers_51 do
  @moduledoc """
  Module: impl_helpers_51.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_51"),
...
defmodule Impl_Helpers_51Store do
  use GenServer
...
defmodule Impl_Helpers_51EventBus do
  use GenServer
