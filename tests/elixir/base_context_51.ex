defmodule Base_Context_51 do
  @moduledoc """
  Module: base_context_51.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_51"),
...
defmodule Base_Context_51Store do
  use GenServer
...
defmodule Base_Context_51EventBus do
  use GenServer
