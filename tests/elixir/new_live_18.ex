defmodule New_Live_18 do
  @moduledoc """
  Module: new_live_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_18"),
...
defmodule New_Live_18EventBus do
  use GenServer
