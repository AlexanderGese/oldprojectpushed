defmodule Core_Schema_4 do
  @moduledoc """
  Module: core_schema_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_4"),
...
defmodule Core_Schema_4Store do
  use GenServer
...
defmodule Core_Schema_4EventBus do
  use GenServer
