defmodule New_Schema_31 do
  @moduledoc """
  Module: new_schema_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_31"),
...
defmodule New_Schema_31Store do
  use GenServer
...
defmodule New_Schema_31EventBus do
  use GenServer
