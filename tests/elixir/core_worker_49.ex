defmodule Core_Worker_49 do
  @moduledoc """
  Module: core_worker_49.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_49"),
...
defmodule Core_Worker_49Store do
  use GenServer
...
defmodule Core_Worker_49EventBus do
  use GenServer
