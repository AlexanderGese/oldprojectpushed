defmodule Core_Helpers_30 do
  @moduledoc """
  Module: core_helpers_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_30"),
...
defmodule Core_Helpers_30Store do
  use GenServer
...
defmodule Core_Helpers_30EventBus do
  use GenServer
