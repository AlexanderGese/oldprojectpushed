defmodule Base_Server_36 do
  @moduledoc """
  Module: base_server_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_36"),
...
defmodule Base_Server_36Store do
  use GenServer
...
defmodule Base_Server_36EventBus do
  use GenServer
