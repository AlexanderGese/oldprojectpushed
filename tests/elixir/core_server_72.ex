defmodule Core_Server_72 do
  @moduledoc """
  Module: core_server_72.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_server_72"),
...
defmodule Core_Server_72Store do
  use GenServer
...
defmodule Core_Server_72EventBus do
  use GenServer
