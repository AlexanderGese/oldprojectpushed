defmodule Impl_Live_50 do
  @moduledoc """
  Module: impl_live_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_50"),
...
defmodule Impl_Live_50Store do
  use GenServer
...
defmodule Impl_Live_50EventBus do
  use GenServer
