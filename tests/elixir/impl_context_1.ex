defmodule Impl_Context_1 do
  @moduledoc """
  Module: impl_context_1.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_1"),
...
defmodule Impl_Context_1Store do
  use GenServer
...
defmodule Impl_Context_1EventBus do
  use GenServer
