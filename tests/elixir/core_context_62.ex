defmodule Core_Context_62 do
  @moduledoc """
  Module: core_context_62.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_62"),
...
defmodule Core_Context_62Store do
  use GenServer
...
defmodule Core_Context_62EventBus do
  use GenServer
