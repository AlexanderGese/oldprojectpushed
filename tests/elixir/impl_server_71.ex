defmodule Impl_Server_71 do
  @moduledoc """
  Module: impl_server_71.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_server_71"),
...
defmodule Impl_Server_71Store do
  use GenServer
...
defmodule Impl_Server_71EventBus do
  use GenServer
