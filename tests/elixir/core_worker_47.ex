defmodule Core_Worker_47 do
  @moduledoc """
  Module: core_worker_47.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_47"),
...
defmodule Core_Worker_47Store do
  use GenServer
...
defmodule Core_Worker_47EventBus do
  use GenServer
