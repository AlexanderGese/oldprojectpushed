defmodule Impl_Context_27 do
  @moduledoc """
  Module: impl_context_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_27"),
...
defmodule Impl_Context_27Store do
  use GenServer
...
defmodule Impl_Context_27EventBus do
  use GenServer
