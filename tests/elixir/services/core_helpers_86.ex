defmodule Core_Helpers_86 do
  @moduledoc """
  Module: core_helpers_86.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_86"),
...
defmodule Core_Helpers_86Store do
  use GenServer
...
defmodule Core_Helpers_86EventBus do
  use GenServer
