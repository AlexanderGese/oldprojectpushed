defmodule Core_Controller_75 do
  @moduledoc """
  Module: core_controller_75.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_controller_75"),
...
defmodule Core_Controller_75Store do
  use GenServer
...
defmodule Core_Controller_75EventBus do
  use GenServer
