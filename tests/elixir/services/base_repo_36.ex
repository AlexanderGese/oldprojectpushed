defmodule Base_Repo_36 do
  @moduledoc """
  Module: base_repo_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_36"),
...
defmodule Base_Repo_36Store do
  use GenServer
...
defmodule Base_Repo_36EventBus do
  use GenServer
