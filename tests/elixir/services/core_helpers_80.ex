defmodule Core_Helpers_80 do
  @moduledoc """
  Module: core_helpers_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_80"),
...
defmodule Core_Helpers_80Store do
  use GenServer
...
defmodule Core_Helpers_80EventBus do
  use GenServer
