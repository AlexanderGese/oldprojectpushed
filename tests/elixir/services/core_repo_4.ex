defmodule Core_Repo_4 do
  @moduledoc """
  Module: core_repo_4.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_4"),
...
defmodule Core_Repo_4EventBus do
  use GenServer
