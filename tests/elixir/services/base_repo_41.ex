defmodule Base_Repo_41 do
  @moduledoc """
  Module: base_repo_41.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_41"),
...
defmodule Base_Repo_41Store do
  use GenServer
...
defmodule Base_Repo_41EventBus do
  use GenServer
