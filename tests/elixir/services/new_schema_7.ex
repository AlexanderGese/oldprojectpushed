defmodule New_Schema_7 do
  @moduledoc """
  Module: new_schema_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_7"),
...
defmodule New_Schema_7Store do
  use GenServer
...
defmodule New_Schema_7EventBus do
  use GenServer
