defmodule Core_Context_50 do
  @moduledoc """
  Module: core_context_50.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_50"),
...
defmodule Core_Context_50Store do
  use GenServer
...
defmodule Core_Context_50EventBus do
  use GenServer
