defmodule Core_Worker_13 do
  @moduledoc """
  Module: core_worker_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_13"),
...
defmodule Core_Worker_13Store do
  use GenServer
...
defmodule Core_Worker_13EventBus do
  use GenServer
