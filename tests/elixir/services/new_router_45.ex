defmodule New_Router_45 do
  @moduledoc """
  Module: new_router_45.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_45"),
...
defmodule New_Router_45Store do
  use GenServer
...
defmodule New_Router_45EventBus do
  use GenServer
