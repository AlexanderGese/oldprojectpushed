defmodule Core_Router_88 do
  @moduledoc """
  Module: core_router_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_router_88"),
...
defmodule Core_Router_88Store do
  use GenServer
...
defmodule Core_Router_88EventBus do
  use GenServer
