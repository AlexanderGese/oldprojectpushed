defmodule Core_Live_36 do
  @moduledoc """
  Module: core_live_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_36"),
...
defmodule Core_Live_36Store do
  use GenServer
...
defmodule Core_Live_36EventBus do
  use GenServer
