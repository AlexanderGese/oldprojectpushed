defmodule Base_Live_56 do
  @moduledoc """
  Module: base_live_56.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_56"),
...
defmodule Base_Live_56Store do
  use GenServer
...
defmodule Base_Live_56EventBus do
  use GenServer
