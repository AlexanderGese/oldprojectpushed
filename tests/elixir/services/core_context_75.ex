defmodule Core_Context_75 do
  @moduledoc """
  Module: core_context_75.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_75"),
...
defmodule Core_Context_75Store do
  use GenServer
...
defmodule Core_Context_75EventBus do
  use GenServer
