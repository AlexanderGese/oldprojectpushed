defmodule Base_Controller_96 do
  @moduledoc """
  Module: base_controller_96.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_96"),
...
defmodule Base_Controller_96Store do
  use GenServer
...
defmodule Base_Controller_96EventBus do
  use GenServer
