defmodule Impl_Context_52 do
  @moduledoc """
  Module: impl_context_52.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_52"),
...
defmodule Impl_Context_52Store do
  use GenServer
...
defmodule Impl_Context_52EventBus do
  use GenServer
