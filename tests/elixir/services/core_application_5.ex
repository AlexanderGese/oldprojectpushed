defmodule Core_Application_5 do
  @moduledoc """
  Module: core_application_5.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_application_5"),
...
defmodule Core_Application_5Store do
  use GenServer
...
defmodule Core_Application_5EventBus do
  use GenServer
