defmodule New_Repo_28 do
  @moduledoc """
  Module: new_repo_28.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_28"),
...
defmodule New_Repo_28EventBus do
  use GenServer
