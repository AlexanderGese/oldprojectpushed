defmodule Base_Router_88 do
  @moduledoc """
  Module: base_router_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_88"),
...
defmodule Base_Router_88Store do
  use GenServer
...
defmodule Base_Router_88EventBus do
  use GenServer
