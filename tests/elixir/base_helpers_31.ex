defmodule Base_Helpers_31 do
  @moduledoc """
  Module: base_helpers_31.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_31"),
...
defmodule Base_Helpers_31Store do
  use GenServer
...
defmodule Base_Helpers_31EventBus do
  use GenServer
