defmodule Base_Worker_76 do
  @moduledoc """
  Module: base_worker_76.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_76"),
...
defmodule Base_Worker_76Store do
  use GenServer
...
defmodule Base_Worker_76EventBus do
  use GenServer
