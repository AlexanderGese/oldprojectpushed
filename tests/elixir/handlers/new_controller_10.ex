defmodule New_Controller_10 do
  @moduledoc """
  Module: new_controller_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_10"),
...
defmodule New_Controller_10Store do
  use GenServer
...
defmodule New_Controller_10EventBus do
  use GenServer
