defmodule Impl_Context_95 do
  @moduledoc """
  Module: impl_context_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_95"),
...
defmodule Impl_Context_95Store do
  use GenServer
...
defmodule Impl_Context_95EventBus do
  use GenServer
