defmodule New_Repo_64 do
  @moduledoc """
  Module: new_repo_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_64"),
...
defmodule New_Repo_64EventBus do
  use GenServer
