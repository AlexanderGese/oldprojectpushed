defmodule Core_Helpers_82 do
  @moduledoc """
  Module: core_helpers_82.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_helpers_82"),
...
defmodule Core_Helpers_82Store do
  use GenServer
...
defmodule Core_Helpers_82EventBus do
  use GenServer
