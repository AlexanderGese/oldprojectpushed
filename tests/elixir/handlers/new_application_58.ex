defmodule New_Application_58 do
  @moduledoc """
  Module: new_application_58.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_58"),
...
defmodule New_Application_58Store do
  use GenServer
...
defmodule New_Application_58EventBus do
  use GenServer
