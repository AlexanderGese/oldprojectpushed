defmodule Base_Schema_98 do
  @moduledoc """
  Module: base_schema_98.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_schema_98"),
...
defmodule Base_Schema_98Store do
  use GenServer
...
defmodule Base_Schema_98EventBus do
  use GenServer
