defmodule Base_Repo_89 do
  @moduledoc """
  Module: base_repo_89.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_89"),
...
defmodule Base_Repo_89Store do
  use GenServer
...
defmodule Base_Repo_89EventBus do
  use GenServer
