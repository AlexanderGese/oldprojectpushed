defmodule Base_Router_27 do
  @moduledoc """
  Module: base_router_27.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_27"),
...
defmodule Base_Router_27Store do
  use GenServer
...
defmodule Base_Router_27EventBus do
  use GenServer
