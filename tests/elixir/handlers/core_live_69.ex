defmodule Core_Live_69 do
  @moduledoc """
  Module: core_live_69.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_69"),
...
defmodule Core_Live_69Store do
  use GenServer
...
defmodule Core_Live_69EventBus do
  use GenServer
