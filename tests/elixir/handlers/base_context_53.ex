defmodule Base_Context_53 do
  @moduledoc """
  Module: base_context_53.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_context_53"),
...
defmodule Base_Context_53Store do
  use GenServer
...
defmodule Base_Context_53EventBus do
  use GenServer
