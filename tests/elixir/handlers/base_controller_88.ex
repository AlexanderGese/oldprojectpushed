defmodule Base_Controller_88 do
  @moduledoc """
  Module: base_controller_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_88"),
...
defmodule Base_Controller_88Store do
  use GenServer
...
defmodule Base_Controller_88EventBus do
  use GenServer
