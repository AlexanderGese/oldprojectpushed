defmodule New_Application_44 do
  @moduledoc """
  Module: new_application_44.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_application_44"),
...
defmodule New_Application_44Store do
  use GenServer
...
defmodule New_Application_44EventBus do
  use GenServer
