defmodule Core_Live_75 do
  @moduledoc """
  Module: core_live_75.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_75"),
...
defmodule Core_Live_75Store do
  use GenServer
...
defmodule Core_Live_75EventBus do
  use GenServer
