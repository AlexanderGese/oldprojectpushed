defmodule Base_Controller_94 do
  @moduledoc """
  Module: base_controller_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_controller_94"),
...
defmodule Base_Controller_94Store do
  use GenServer
...
defmodule Base_Controller_94EventBus do
  use GenServer
