defmodule New_Schema_52 do
  @moduledoc """
  Module: new_schema_52.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_52"),
...
defmodule New_Schema_52Store do
  use GenServer
...
defmodule New_Schema_52EventBus do
  use GenServer
