defmodule New_Server_14 do
  @moduledoc """
  Module: new_server_14.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_14"),
...
defmodule New_Server_14Store do
  use GenServer
...
defmodule New_Server_14EventBus do
  use GenServer
