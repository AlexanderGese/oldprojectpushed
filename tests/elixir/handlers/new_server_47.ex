defmodule New_Server_47 do
  @moduledoc """
  Module: new_server_47.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_47"),
...
defmodule New_Server_47Store do
  use GenServer
...
defmodule New_Server_47EventBus do
  use GenServer
