defmodule Base_Live_24 do
  @moduledoc """
  Module: base_live_24.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_24"),
...
defmodule Base_Live_24Store do
  use GenServer
...
defmodule Base_Live_24EventBus do
  use GenServer
