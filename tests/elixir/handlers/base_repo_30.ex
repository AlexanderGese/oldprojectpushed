defmodule Base_Repo_30 do
  @moduledoc """
  Module: base_repo_30.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_30"),
...
defmodule Base_Repo_30Store do
  use GenServer
...
defmodule Base_Repo_30EventBus do
  use GenServer
