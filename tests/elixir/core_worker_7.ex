defmodule Core_Worker_7 do
  @moduledoc """
  Module: core_worker_7.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_7"),
...
defmodule Core_Worker_7Store do
  use GenServer
...
defmodule Core_Worker_7EventBus do
  use GenServer
