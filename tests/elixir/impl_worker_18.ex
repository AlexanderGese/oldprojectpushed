defmodule Impl_Worker_18 do
  @moduledoc """
  Module: impl_worker_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_worker_18"),
...
defmodule Impl_Worker_18Store do
  use GenServer
...
defmodule Impl_Worker_18EventBus do
  use GenServer
