defmodule Base_Repo_42 do
  @moduledoc """
  Module: base_repo_42.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_repo_42"),
...
defmodule Base_Repo_42Store do
  use GenServer
...
defmodule Base_Repo_42EventBus do
  use GenServer
