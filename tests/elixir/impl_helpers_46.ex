defmodule Impl_Helpers_46 do
  @moduledoc """
  Module: impl_helpers_46.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_helpers_46"),
...
defmodule Impl_Helpers_46Store do
  use GenServer
...
defmodule Impl_Helpers_46EventBus do
  use GenServer
