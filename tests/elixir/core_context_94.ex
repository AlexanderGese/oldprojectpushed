defmodule Core_Context_94 do
  @moduledoc """
  Module: core_context_94.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_context_94"),
...
defmodule Core_Context_94Store do
  use GenServer
...
defmodule Core_Context_94EventBus do
  use GenServer
