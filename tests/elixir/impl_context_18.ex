defmodule Impl_Context_18 do
  @moduledoc """
  Module: impl_context_18.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_18"),
...
defmodule Impl_Context_18Store do
  use GenServer
...
defmodule Impl_Context_18EventBus do
  use GenServer
