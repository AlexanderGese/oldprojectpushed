defmodule New_Router_6 do
  @moduledoc """
  Module: new_router_6.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_6"),
...
defmodule New_Router_6Store do
  use GenServer
...
defmodule New_Router_6EventBus do
  use GenServer
