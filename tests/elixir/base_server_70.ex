defmodule Base_Server_70 do
  @moduledoc """
  Module: base_server_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_70"),
...
defmodule Base_Server_70Store do
  use GenServer
...
defmodule Base_Server_70EventBus do
  use GenServer
