defmodule Core_Worker_88 do
  @moduledoc """
  Module: core_worker_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_88"),
...
defmodule Core_Worker_88Store do
  use GenServer
...
defmodule Core_Worker_88EventBus do
  use GenServer
