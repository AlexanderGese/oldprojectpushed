defmodule Core_Worker_63 do
  @moduledoc """
  Module: core_worker_63.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_worker_63"),
...
defmodule Core_Worker_63Store do
  use GenServer
...
defmodule Core_Worker_63EventBus do
  use GenServer
