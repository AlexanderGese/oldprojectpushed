defmodule New_Router_88 do
  @moduledoc """
  Module: new_router_88.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_88"),
...
defmodule New_Router_88Store do
  use GenServer
...
defmodule New_Router_88EventBus do
  use GenServer
