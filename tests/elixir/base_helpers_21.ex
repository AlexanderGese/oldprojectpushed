defmodule Base_Helpers_21 do
  @moduledoc """
  Module: base_helpers_21.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_helpers_21"),
...
defmodule Base_Helpers_21Store do
  use GenServer
...
defmodule Base_Helpers_21EventBus do
  use GenServer
