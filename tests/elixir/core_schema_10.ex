defmodule Core_Schema_10 do
  @moduledoc """
  Module: core_schema_10.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_schema_10"),
...
defmodule Core_Schema_10Store do
  use GenServer
...
defmodule Core_Schema_10EventBus do
  use GenServer
