defmodule New_Server_44 do
  @moduledoc """
  Module: new_server_44.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_44"),
...
defmodule New_Server_44Store do
  use GenServer
...
defmodule New_Server_44EventBus do
  use GenServer
