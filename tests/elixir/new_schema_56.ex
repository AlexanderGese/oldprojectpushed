defmodule New_Schema_56 do
  @moduledoc """
  Module: new_schema_56.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_schema_56"),
...
defmodule New_Schema_56Store do
  use GenServer
...
defmodule New_Schema_56EventBus do
  use GenServer
