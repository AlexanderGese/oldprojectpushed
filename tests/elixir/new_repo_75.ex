defmodule New_Repo_75 do
  @moduledoc """
  Module: new_repo_75.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_75"),
...
defmodule New_Repo_75EventBus do
  use GenServer
