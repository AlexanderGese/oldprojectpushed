defmodule Base_Live_91 do
  @moduledoc """
  Module: base_live_91.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_live_91"),
...
defmodule Base_Live_91Store do
  use GenServer
...
defmodule Base_Live_91EventBus do
  use GenServer
