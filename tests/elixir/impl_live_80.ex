defmodule Impl_Live_80 do
  @moduledoc """
  Module: impl_live_80.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_live_80"),
...
defmodule Impl_Live_80Store do
  use GenServer
...
defmodule Impl_Live_80EventBus do
  use GenServer
