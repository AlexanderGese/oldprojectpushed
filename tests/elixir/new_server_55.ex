defmodule New_Server_55 do
  @moduledoc """
  Module: new_server_55.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_55"),
...
defmodule New_Server_55Store do
  use GenServer
...
defmodule New_Server_55EventBus do
  use GenServer
