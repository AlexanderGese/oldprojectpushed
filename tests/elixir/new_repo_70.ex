defmodule New_Repo_70 do
  @moduledoc """
  Module: new_repo_70.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_repo_70"),
...
defmodule New_Repo_70EventBus do
  use GenServer
