defmodule Core_Repo_95 do
  @moduledoc """
  Module: core_repo_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_repo_95"),
...
defmodule Core_Repo_95Store do
  use GenServer
...
defmodule Core_Repo_95EventBus do
  use GenServer
