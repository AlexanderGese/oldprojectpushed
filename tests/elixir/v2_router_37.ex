defmodule V2_Router_37 do
  @moduledoc """
  Module: v2_router_37.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "v2_router_37"),
...
defmodule V2_Router_37Store do
  use GenServer
...
defmodule V2_Router_37EventBus do
  use GenServer
