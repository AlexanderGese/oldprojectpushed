defmodule New_Helpers_83 do
  @moduledoc """
  Module: new_helpers_83.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_helpers_83"),
...
defmodule New_Helpers_83Store do
  use GenServer
...
defmodule New_Helpers_83EventBus do
  use GenServer
