defmodule Impl_Context_22 do
  @moduledoc """
  Module: impl_context_22.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "impl_context_22"),
...
defmodule Impl_Context_22Store do
  use GenServer
...
defmodule Impl_Context_22EventBus do
  use GenServer
