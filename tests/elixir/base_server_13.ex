defmodule Base_Server_13 do
  @moduledoc """
  Module: base_server_13.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_server_13"),
...
defmodule Base_Server_13Store do
  use GenServer
...
defmodule Base_Server_13EventBus do
  use GenServer
