defmodule New_Live_60 do
  @moduledoc """
  Module: new_live_60.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_live_60"),
...
defmodule New_Live_60EventBus do
  use GenServer
