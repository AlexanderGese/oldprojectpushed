defmodule Base_Worker_64 do
  @moduledoc """
  Module: base_worker_64.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_worker_64"),
...
defmodule Base_Worker_64Store do
  use GenServer
...
defmodule Base_Worker_64EventBus do
  use GenServer
