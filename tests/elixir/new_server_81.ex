defmodule New_Server_81 do
  @moduledoc """
  Module: new_server_81.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_server_81"),
...
defmodule New_Server_81Store do
  use GenServer
...
defmodule New_Server_81EventBus do
  use GenServer
