defmodule Core_Live_78 do
  @moduledoc """
  Module: core_live_78.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "core_live_78"),
...
defmodule Core_Live_78Store do
  use GenServer
...
defmodule Core_Live_78EventBus do
  use GenServer
