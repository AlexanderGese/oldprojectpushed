defmodule Base_Router_95 do
  @moduledoc """
  Module: base_router_95.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "base_router_95"),
...
defmodule Base_Router_95Store do
  use GenServer
...
defmodule Base_Router_95EventBus do
  use GenServer
