defmodule New_Router_86 do
  @moduledoc """
  Module: new_router_86.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_router_86"),
...
defmodule New_Router_86Store do
  use GenServer
...
defmodule New_Router_86EventBus do
  use GenServer
