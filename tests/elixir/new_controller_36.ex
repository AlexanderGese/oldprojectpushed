defmodule New_Controller_36 do
  @moduledoc """
  Module: new_controller_36.ex
  ...
  def new(opts \\ []) do
    %__MODULE__{
      app_name: Keyword.get(opts, :app_name, "new_controller_36"),
...
defmodule New_Controller_36Store do
  use GenServer
...
defmodule New_Controller_36EventBus do
  use GenServer
